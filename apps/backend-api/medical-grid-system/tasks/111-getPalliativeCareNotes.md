# Task 111: getPalliativeCareNotes Grid Implementation

## Function Details
- **Function Name**: getPalliativeCareNotes
- **Category**: Oncology
- **Collection**: palliative_care_notes
- **Priority**: HIGH
...
- palliative_care_notesId (ObjectId) - Primary key
...
db.palliative_care_notes.createIndex({ patientId: 1, date: -1 })
db.palliative_care_notes.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/palliative_care_notes
- POST /api/medical/palliative_care_notes
- PUT /api/medical/palliative_care_notes/:id
- DELETE /api/medical/palliative_care_notes/:id
- GET /api/medical/palliative_care_notes/export
...
```javascript
{
  ...
  metadata: {
    gridType: "palliative_care_notes",
...
### Backend Tasks
- [ ] Create MongoDB schema for palliative_care_notes
...
## Related Functions
- Previous: [110-getCancerStagingReports]
- Next: [112-getCancerGeneticsReports]
