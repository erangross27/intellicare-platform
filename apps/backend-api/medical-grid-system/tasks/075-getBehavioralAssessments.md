# Task 075: getBehavioralAssessments Grid Implementation

## Function Details
- **Function Name**: getBehavioralAssessments
- **Category**: Psychiatry
...
- behavioral_assessmentsId (ObjectId) - Primary key
...
db.behavioral_assessments.createIndex({ patientId: 1, date: -1 })
db.behavioral_assessments.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/behavioral_assessments
- POST /api/medical/behavioral_assessments
- PUT /api/medical/behavioral_assessments/:id
- DELETE /api/medical/behavioral_assessments/:id
- GET /api/medical/behavioral_assessments/export
...
```javascript
{
  ...
  metadata: {
    gridType: "behavioral_assessments",
...
### Backend Tasks
- [ ] Create MongoDB schema for behavioral_assessments
...
## Related Functions
- Previous: [074-getTherapyProgressNotes]
- Next: [076-getMoodTrackingLogs]
