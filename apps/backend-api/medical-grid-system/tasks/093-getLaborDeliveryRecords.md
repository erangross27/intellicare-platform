# Task 093: getLaborDeliveryRecords Grid Implementation

## Function Details
- **Function Name**: getLaborDeliveryRecords
...
- labor_delivery_recordsId (ObjectId) - Primary key
...
### Real-Time Updates
- WebSocket event: `labor_delivery_records:update`
...
db.labor_delivery_records.createIndex({ patientId: 1, date: -1 })
db.labor_delivery_records.createIndex({ status: 1, practiceId: 1 })

db.labor_delivery_records.createIndex({ lastModifiedAt: -1 })
```
...
### API Endpoints
- GET /api/medical/labor_delivery_records
- POST /api/medical/labor_delivery_records
- PUT /api/medical/labor_delivery_records/:id
- DELETE /api/medical/labor_delivery_records/:id
- GET /api/medical/labor_delivery_records/export
...
```javascript
{
  ...
  metadata: {
    gridType: "labor_delivery_records",
...
### Backend Tasks
- [ ] Create MongoDB schema for labor_delivery_records
...
## Related Functions
- Previous: [092-getPrenatalTestingReports]
- Next: [094-getPostpartumNotes]
...
---
Generated: 2025-09-26T19:29:22.306Z
