# Task 018: getInsuranceForms Grid Implementation

## Function Details
- **Function Name**: getInsuranceForms
...
- insurance_formsId (ObjectId) - Primary key
...
db.insurance_forms.createIndex({ patientId: 1, date: -1 })
db.insurance_forms.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/insurance_forms
- POST /api/medical/insurance_forms
- PUT /api/medical/insurance_forms/:id
- DELETE /api/medical/insurance_forms/:id
- GET /api/medical/insurance_forms/export
...
### Backend Tasks
- [ ] Create MongoDB schema for insurance_forms
...
## Related Functions
- Previous: [017-getMedicalReconciliationForms]
- Next: [019-getAdvancedDirectives]
