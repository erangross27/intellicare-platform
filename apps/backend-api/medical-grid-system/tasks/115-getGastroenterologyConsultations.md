# Task 115: getGastroenterologyConsultations Grid Implementation

## Function Details
- **Function Name**: getGastroenterologyConsultations
- **Category**: Specialty
...
- gastroenterology_consultationsId (ObjectId) - Primary key
...
db.gastroenterology_consultations.createIndex({ patientId: 1, date: -1 })
db.gastroenterology_consultations.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/gastroenterology_consultations
- POST /api/medical/gastroenterology_consultations
- PUT /api/medical/gastroenterology_consultations/:id
- DELETE /api/medical/gastroenterology_consultations/:id
- GET /api/medical/gastroenterology_consultations/export
...
```javascript
{
  ...
  metadata: {
    gridType: "gastroenterology_consultations",
...
### Backend Tasks
- [ ] Create MongoDB schema for gastroenterology_consultations
...
## Related Functions
- Previous: [114-getEndocrinologyConsultations]
- Next: [116-getHematologyConsultations]
...
---
Generated: 2025-09-26T19:29:22.609Z
