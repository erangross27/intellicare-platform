# Task 136: getAutoimmunePanels Grid Implementation

## Function Details
- **Function Name**: getAutoimmunePanels
- **Category**: Diagnostic
...
- autoimmune_panelsId (ObjectId) - Primary key
...
db.autoimmune_panels.createIndex({ patientId: 1, date: -1 })
db.autoimmune_panels.createIndex({ status: 1, practiceId: 1 })
db.autoimmune_panels.createIndex({ "result.isAbnormal": 1 })
...
### API Endpoints
- GET /api/medical/autoimmune_panels
- POST /api/medical/autoimmune_panels
- PUT /api/medical/autoimmune_panels/:id
- DELETE /api/medical/autoimmune_panels/:id
- GET /api/medical/autoimmune_panels/export
...
### Backend Tasks
- [ ] Create MongoDB schema for autoimmune_panels
...
## Related Functions
- Previous: [135-getHormonePanels]
- Next: [137-getGeneticTestingReports]
