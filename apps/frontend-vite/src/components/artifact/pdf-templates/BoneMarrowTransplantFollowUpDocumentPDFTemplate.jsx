/**
 * BoneMarrowTransplantFollowUpDocumentPDFTemplate.jsx
 * June 2026 — Helvetica — LETTER size — bone marrow transplant follow-up
...
const SECTION_CONFIGS = [
  {
    title: 'Transplant & Engraftment',
    fields: [
      { key: 'transplantDay', label: 'Transplant Day', isNumber: true },
      { key: 'transplantType', label: 'Transplant Type', isSentence: true },
      { key: 'conditioningRegimen', label: 'Conditioning Regimen', isSentence: true },
      { key: 'absoluteNeutrophilCount', label: 'ANC (cells/µL)', isNumber: true },
      { key: 'neutrophilEngraftmentDay', label: 'Neutrophil Engraftment Day', isNumber: true },
      { key: 'plateletEngraftmentDay', label: 'Platelet Engraftment Day', isNumber: true },
    ],
  },
  {
    title: 'Chimerism & Disease',
    fields: [
      { key: 'donorChimerismPercentage', label: 'Donor Chimerism (%)', isNumber: true },
      { key: 'chimerismLineage', label: 'Chimerism Lineage', isSentence: true },
      { key: 'relapseStatus', label: 'Relapse Status', isSentence: true },
  ...
  },
  {
    title: 'GVHD',
    fields: [
      { key: 'acuteGvhdGrade', label: 'Acute GVHD Grade', isSentence: true },
      { key: 'acuteGvhdOrganInvolvement', label: 'Acute GVHD Organ Involvement', isArray: true },
      { key: 'chronicGvhdSeverity', label: 'Chronic GVHD Severity', isSentence: true },
      { key: 'chronicGvhdOrganScores', label: 'Chronic GVHD Organ Scores', isArray: true },
    ],
  },
  {
    title: 'Immunosuppression & Infection',
    fields: [
      { key: 'immunosuppressiveRegimen', label: 'Immunosuppressive Regimen', isArray: true },
      ...
      { key: 'bkVirusUrinePcr', label: 'BK Virus Urine PCR (copies/mL)', isNumber: true },
    ],
  },
  {
    title: 'Immune Reconstitution',
    fields: [
      { key: 'cd4CountPostTransplant', label: 'CD4 Count (cells/µL)', isNumber: true },
      { key: 'immunoglobulinLevels', label: 'Immunoglobulin Levels', isSentence: true },
      { key: 'revaccinationStatus', label: 'Revaccination Status', isArray: true },
    ],
  },
  {
    title: 'Organ Function',
    fields: [
      { key: 'pulmonaryFunctionFev1Percent', label: 'Pulmonary Function FEV1 (%)', isNumber: true },
      { key: 'dlcoPercentPredicted', label: 'DLCO (% predicted)', isNumber: true },
...
/* ======= COMPONENT ======= */
const BoneMarrowTransplantFollowUpDocumentPDFTemplate = ({ document: data }) => {
      ...
      <Document>
        <Page size="LETTER" style={styles.page}>
          <View style={styles.documentHeader}>
            <Text style={styles.documentTitle}>Bone Marrow Transplant Follow-Up</Text>
          </View>
          ...
          <View key={index} style={styles.recordContainer}>
            ...
            <View style={styles.recordHeader} wrap={false}>
              <Text style={styles.recordTitle}>
                {`Bone Marrow Transplant Follow-Up ${index + 1}`}
              </Text>
...
export default BoneMarrowTransplantFollowUpDocumentPDFTemplate;
