# Task 030: getTraumaFlowSheets Grid Implementation

## Function Details
- **Function Name**: getTraumaFlowSheets
...
| ventilatorSettings | Vent Settings | string | 300px | ❌ | ✅ | Multi-line |
| vasopressors | Vasopressors | string | 300px | ❌ | ✅ | Multi-line |
| sedation | Sedation | string | 300px | ❌ | ✅ | Multi-line |
| status | Status | enum | 120px | ✅ | ✅ | Status Badge |
| provider | Provider | string | 200px | ✅ | ✅ | Text |

### Hidden Columns (for actions/linking)
- trauma_flow_sheetsId (ObjectId) - Primary key
...
### Real-Time Updates
- WebSocket event: `trauma_flow_sheets:update`
...
db.trauma_flow_sheets.createIndex({ patientId: 1, date: -1 })
db.trauma_flow_sheets.createIndex({ status: 1, practiceId: 1 })

db.trauma_flow_sheets.createIndex({ lastModifiedAt: -1 })
```
...
### API Endpoints
- GET /api/medical/trauma_flow_sheets
- POST /api/medical/trauma_flow_sheets
- PUT /api/medical/trauma_flow_sheets/:id
- DELETE /api/medical/trauma_flow_sheets/:id
- GET /api/medical/trauma_flow_sheets/export
...
### Backend Tasks
- [ ] Create MongoDB schema for trauma_flow_sheets
...
## Related Functions
- Previous: [029-getRapidResponseSummaries]
- Next: [031-getEmsRunReports]
...
---
Generated: 2025-09-26T19:29:21.700Z
