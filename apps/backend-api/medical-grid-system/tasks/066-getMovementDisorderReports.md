# Task 066: getMovementDisorderReports Grid Implementation

## Function Details
- **Function Name**: getMovementDisorderReports
- **Category**: Neurology
- **Collection**: movement_disorder_reports
- **Priority**: MEDIUM
...
- movement_disorder_reportsId (ObjectId) - Primary key
...
db.movement_disorder_reports.createIndex({ patientId: 1, date: -1 })
db.movement_disorder_reports.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/movement_disorder_reports
- POST /api/medical/movement_disorder_reports
- PUT /api/medical/movement_disorder_reports/:id
- DELETE /api/medical/movement_disorder_reports/:id
- GET /api/medical/movement_disorder_reports/export
...
```javascript
{
  ...
  metadata: {
    gridType: "movement_disorder_reports",
...
### Backend Tasks
- [ ] Create MongoDB schema for movement_disorder_reports
...
## Related Functions
- Previous: [065-getNerveCondutionStudies]
- Next: [067-getSeizureLogs]
