# Task 173: getRecreationalTherapyNotes Grid Implementation

## Function Details
- **Function Name**: getRecreationalTherapyNotes
- **Category**: Therapy
- **Collection**: recreational_therapy_notes
- **Priority**: LOW
...
- recreational_therapy_notesId (ObjectId) - Primary key
...
db.recreational_therapy_notes.createIndex({ patientId: 1, date: -1 })
db.recreational_therapy_notes.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/recreational_therapy_notes
- POST /api/medical/recreational_therapy_notes
- PUT /api/medical/recreational_therapy_notes/:id
- DELETE /api/medical/recreational_therapy_notes/:id
- GET /api/medical/recreational_therapy_notes/export
...
```javascript
{
  ...
  metadata: {
    gridType: "recreational_therapy_notes",
...
### Backend Tasks
- [ ] Create MongoDB schema for recreational_therapy_notes
...
## Related Functions
- Previous: [172-getAquaticTherapyNotes]
- Next: [174-getMusicTherapyNotes]
