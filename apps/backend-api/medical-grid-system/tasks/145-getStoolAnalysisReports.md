# Task 145: getStoolAnalysisReports Grid Implementation

## Function Details
- **Function Name**: getStoolAnalysisReports
- **Category**: Diagnostic
- **Collection**: stool_analysis_reports
- **Priority**: MEDIUM
...
- stool_analysis_reportsId (ObjectId) - Primary key
...
db.stool_analysis_reports.createIndex({ patientId: 1, date: -1 })
db.stool_analysis_reports.createIndex({ status: 1, practiceId: 1 })
db.stool_analysis_reports.createIndex({ "result.isAbnormal": 1 })
...
### API Endpoints
- GET /api/medical/stool_analysis_reports
- POST /api/medical/stool_analysis_reports
- PUT /api/medical/stool_analysis_reports/:id
- DELETE /api/medical/stool_analysis_reports/:id
- GET /api/medical/stool_analysis_reports/export
...
```javascript
{
  ...
  metadata: {
    gridType: "stool_analysis_reports",
...
### Backend Tasks
- [ ] Create MongoDB schema for stool_analysis_reports
...
## Related Functions
- Previous: [144-getUrinalysisReports]
- Next: [146-getSpirometryReports]
