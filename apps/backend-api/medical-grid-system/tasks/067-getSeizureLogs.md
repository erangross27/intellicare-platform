# Task 067: getSeizureLogs Grid Implementation

## Function Details
- **Function Name**: getSeizureLogs
- **Category**: Neurology
- **Collection**: seizure_logs
- **Priority**: HIGH
...
- seizure_logsId (ObjectId) - Primary key
...
db.seizure_logs.createIndex({ patientId: 1, date: -1 })
db.seizure_logs.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/seizure_logs
- POST /api/medical/seizure_logs
- PUT /api/medical/seizure_logs/:id
- DELETE /api/medical/seizure_logs/:id
- GET /api/medical/seizure_logs/export
...
### Backend Tasks
- [ ] Create MongoDB schema for seizure_logs
...
## Related Functions
- Previous: [066-getMovementDisorderReports]
- Next: [068-getSleepStudyReports]
