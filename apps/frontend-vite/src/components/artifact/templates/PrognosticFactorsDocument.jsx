 ...
 *   4. survival-estimates: survivalEstimates (dynamic-key object)
 *   5. recurrence-risk: recurrenceRisk
 *   6. prognostic-scores: prognosticScores (array of objects/strings)
 *   7. molecular-subtype: molecularSubtype, molecularSubtypeMethodology
 *   8. results: results (dynamic-key object)
 *   9. clinical-findings: findings, assessment
 *  10. plan-recommendations: plan, notes
 *  11. recommendations: recommendations (array of {recommendation, date})
 */
...
const STRING_FIELDS = ['type', 'provider', 'facility', 'status', 'recurrenceRisk', 'molecularSubtype', 'molecularSubtypeMethodology', 'findings', 'assessment', 'plan', 'notes'];
...
/* flattenItem: array item (string, recommendation object, or score object) → one readable line */
...
const PrognosticFactorsDocument = ({ document: docProp }) => {
  ...
  const filteredRecords = useMemo(() => {
    ...
    return records.filter((record, idx) => {
      ...
      const rt = `Prognostic Factor ${idx + 1}`.toLowerCase();
  ...
  // Save one array item (dot-path key), reconstructing 'Label: value' for labeled string items.
    ...
    <div className="prognostic-factors-document" ref={containerRef}>
      <div className="document-header">
        ...
        <div className="header-actions">
          ...
          <PDFDownloadLink document={<PrognosticFactorsDocumentPDFTemplate document={pdfData} />} fileName="Prognostic_Factors.pdf" className="copy-btn">
        ...
        {filteredRecords.map((record, idx) => (
          <div key={idx} className="record-card">
            <div className="record-header">
              <h3 className="record-name">{highlightText(`Prognostic Factor ${idx + 1}`)}</h3>
            </div>
