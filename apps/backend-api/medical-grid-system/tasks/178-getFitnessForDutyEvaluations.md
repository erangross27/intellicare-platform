# Task 178: getFitnessForDutyEvaluations Grid Implementation

## Function Details
- **Function Name**: getFitnessForDutyEvaluations
...
- fitness_for_duty_evaluationsId (ObjectId) - Primary key
...
db.fitness_for_duty_evaluations.createIndex({ patientId: 1, date: -1 })
db.fitness_for_duty_evaluations.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/fitness_for_duty_evaluations
- POST /api/medical/fitness_for_duty_evaluations
- PUT /api/medical/fitness_for_duty_evaluations/:id
- DELETE /api/medical/fitness_for_duty_evaluations/:id
- GET /api/medical/fitness_for_duty_evaluations/export
...
```javascript
{
  ...
  metadata: {
    gridType: "fitness_for_duty_evaluations",
...
### Backend Tasks
- [ ] Create MongoDB schema for fitness_for_duty_evaluations
...
## Related Functions
- Previous: [177-getDisabilityEvaluations]
- Next: [179-getWorkersCompEvaluations]
...
---
Generated: 2025-09-26T19:29:23.214Z
