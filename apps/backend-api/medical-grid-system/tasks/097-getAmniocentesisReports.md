# Task 097: getAmniocentesisReports Grid Implementation

## Function Details
- **Function Name**: getAmniocentesisReports
...
- amniocentesis_reportsId (ObjectId) - Primary key
...
db.amniocentesis_reports.createIndex({ patientId: 1, date: -1 })
db.amniocentesis_reports.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/amniocentesis_reports
- POST /api/medical/amniocentesis_reports
- PUT /api/medical/amniocentesis_reports/:id
- DELETE /api/medical/amniocentesis_reports/:id
- GET /api/medical/amniocentesis_reports/export
...
```javascript
{
  ...
  metadata: {
    gridType: "amniocentesis_reports",
...
### Backend Tasks
- [ ] Create MongoDB schema for amniocentesis_reports
...
## Related Functions
- Previous: [096-getObstetricUltrasoundReports]
- Next: [098-getMaternalFetalReports]
