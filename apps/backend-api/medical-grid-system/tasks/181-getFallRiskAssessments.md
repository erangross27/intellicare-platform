# Task 181: getFallRiskAssessments Grid Implementation

## Function Details
- **Function Name**: getFallRiskAssessments
...
- fall_risk_assessmentsId (ObjectId) - Primary key
...
db.fall_risk_assessments.createIndex({ patientId: 1, date: -1 })
db.fall_risk_assessments.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/fall_risk_assessments
- POST /api/medical/fall_risk_assessments
- PUT /api/medical/fall_risk_assessments/:id
- DELETE /api/medical/fall_risk_assessments/:id
- GET /api/medical/fall_risk_assessments/export
...
```javascript
{
  ...
  metadata: {
    gridType: "fall_risk_assessments",
...
### Backend Tasks
- [ ] Create MongoDB schema for fall_risk_assessments
...
## Related Functions
- Previous: [180-getTravelHealthCertificates]
- Next: [182-getPainAssessmentForms]
