/**
 * SpecimensDocumentPDFTemplate.jsx
 * March 2026 — Helvetica — LETTER size — specimens
...
const SECTION_CONFIGS = [
  {
    ...
    fields: [
      ...
      { key: 'description', label: 'Description', isSentence: true },
      { key: 'handling', label: 'Handling', isSentence: true },
      { key: 'pathologyNumber', label: 'Pathology Number', isSentence: true },
    ],
  },
  {
    title: 'Results',
    fields: [
      { key: 'preliminaryResults', label: 'Preliminary Results', isSentence: true },
      { key: 'finalResults', label: 'Final Results', isSentence: true },
...
/* ======= COMPONENT ======= */
const SpecimensDocumentPDFTemplate = ({ document: data }) => {
      ...
      <Document>
        <Page size="LETTER" style={styles.page}>
          <View style={styles.documentHeader}>
            <Text style={styles.documentTitle}>Specimens</Text>
          </View>
          ...
          <View key={index} style={styles.recordContainer}>
            ...
            <View style={styles.recordHeader} wrap={false}>
              <View style={styles.recordDateRow}>
                ...
                {record.status && (
                  <Text style={styles.recordDate}>Status: {safeString(record.status)}</Text>
                )}
              </View>
              <Text style={styles.recordTitle}>
                {record.description || `Specimen ${index + 1}`}
              </Text>
            </View>
...
export default SpecimensDocumentPDFTemplate;
