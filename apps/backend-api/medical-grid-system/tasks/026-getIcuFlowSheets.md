# Task 026: getIcuFlowSheets Grid Implementation

## Function Details
- **Function Name**: getIcuFlowSheets
...
- icu_flow_sheetsId (ObjectId) - Primary key
...
### Real-Time Updates
- WebSocket event: `icu_flow_sheets:update`
...
db.icu_flow_sheets.createIndex({ patientId: 1, date: -1 })
db.icu_flow_sheets.createIndex({ status: 1, practiceId: 1 })

db.icu_flow_sheets.createIndex({ lastModifiedAt: -1 })
```
...
### API Endpoints
- GET /api/medical/icu_flow_sheets
- POST /api/medical/icu_flow_sheets
- PUT /api/medical/icu_flow_sheets/:id
- DELETE /api/medical/icu_flow_sheets/:id
- GET /api/medical/icu_flow_sheets/export
...
### Backend Tasks
- [ ] Create MongoDB schema for icu_flow_sheets
...
## Related Functions
- Previous: [025-getHospitalTransferNotes]
- Next: [027-getTransferSummaries]
