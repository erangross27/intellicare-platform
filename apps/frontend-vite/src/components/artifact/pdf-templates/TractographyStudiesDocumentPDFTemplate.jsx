/**
 * TractographyStudiesDocumentPDFTemplate.jsx
 * March 2026 — Helvetica — LETTER size — tractography studies
      ...
      <Document>
        <Page size="LETTER" style={styles.page}>
          <View style={styles.documentHeader}>
            <Text style={styles.documentTitle}>Tractography Studies</Text>
          </View>
          ...
          <View key={index} style={styles.recordContainer}>
            ...
            <View style={styles.recordHeader} wrap={false}>
              ...
              <Text style={styles.recordTitle}>
                {record.reportType || `Tractography Study ${index + 1}`}
              </Text>
            </View>
