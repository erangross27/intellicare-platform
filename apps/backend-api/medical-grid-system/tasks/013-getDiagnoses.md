# Task 013: getDiagnoses Grid Implementation

## Function Details
- **Function Name**: getDiagnoses
...
- diagnosesId (ObjectId) - Primary key
...
db.diagnoses.createIndex({ patientId: 1, date: -1 })
db.diagnoses.createIndex({ status: 1, practiceId: 1 })
...
- PUT /api/medical/diagnoses/:id
- DELETE /api/medical/diagnoses/:id
- GET /api/medical/diagnoses/export
...
### Backend Tasks
- [ ] Create MongoDB schema for diagnoses
...
## Related Functions
- Previous: [012-getReferrals]
- Next: [014-getMedicalCertificates]
