# Task 124: getInfectiousDiseaseConsults Grid Implementation

## Function Details
- **Function Name**: getInfectiousDiseaseConsults
- **Category**: Specialty
- **Collection**: infectious_disease_consults
- **Priority**: HIGH
...
- infectious_disease_consultsId (ObjectId) - Primary key
...
db.infectious_disease_consults.createIndex({ patientId: 1, date: -1 })
db.infectious_disease_consults.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/infectious_disease_consults
- POST /api/medical/infectious_disease_consults
- PUT /api/medical/infectious_disease_consults/:id
- DELETE /api/medical/infectious_disease_consults/:id
- GET /api/medical/infectious_disease_consults/export
...
```javascript
{
  ...
  metadata: {
    gridType: "infectious_disease_consults",
...
### Backend Tasks
- [ ] Create MongoDB schema for infectious_disease_consults
...
## Related Functions
- Previous: [123-getUrologyConsultations]
- Next: [125-getGeriatricAssessments]
