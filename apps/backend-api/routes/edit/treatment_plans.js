/**
 * TreatmentPlans Edit Route
 * Isolated per-collection edit/approve endpoints for HIPAA compliance
 *
 * PUT /api/edit/treatment_plans/:id/edit    — Edit a single field
 * PUT /api/edit/treatment_plans/:id/approve — Approve all pending edits
 */
...
function buildContext(req, operation = 'read') {
  return {
    serviceId: 'treatment-plans-edit-service',
    userId: req.user?.id,
    operation,
...
router.put('/:id/edit', async (req, res) => {
  try {
    ...
    console.error('[TreatmentPlans] PUT /:id/edit error:', err.message);
