# Task 116: getHematologyConsultations Grid Implementation

## Function Details
- **Function Name**: getHematologyConsultations
- **Category**: Specialty
...
- hematology_consultationsId (ObjectId) - Primary key
...
db.hematology_consultations.createIndex({ patientId: 1, date: -1 })
db.hematology_consultations.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/hematology_consultations
- POST /api/medical/hematology_consultations
- PUT /api/medical/hematology_consultations/:id
- DELETE /api/medical/hematology_consultations/:id
- GET /api/medical/hematology_consultations/export
...
```javascript
{
  ...
  metadata: {
    gridType: "hematology_consultations",
...
### Backend Tasks
- [ ] Create MongoDB schema for hematology_consultations
...
## Related Functions
- Previous: [115-getGastroenterologyConsultations]
- Next: [117-getNephrologyConsultations]
