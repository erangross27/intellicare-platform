  ...
  const buildSectionCopyText = useCallback((record, idx, sid) => {
    ...
    fields.forEach(f => {
      ...
      if (OBJECT_FIELDS.includes(f)) {
        ...
        text += `${label}\n${items.map((item, i) => `${i + 1}. ${typeof item === 'string' ? item : item?.recommendation || ''}`).join('\n')}\n\n`;
    ...
    <div className="prenatal-screening-document" ref={containerRef}>
      <div className="document-header">
        ...
        <div className="header-actions">
          ...
          <PDFDownloadLink document={<PrenatalScreeningDocumentPDFTemplate document={pdfData} />} fileName={`prenatal-screening-${new Date().toISOString().split('T')[0]}.pdf`} className="copy-btn">
