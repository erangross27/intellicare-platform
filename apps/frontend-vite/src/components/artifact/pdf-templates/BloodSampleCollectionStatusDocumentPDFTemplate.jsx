/**
 * BloodSampleCollectionStatusDocumentPDFTemplate.jsx
 * March 2026 — Helvetica — LETTER size — blood sample collection status
...
const SECTION_CONFIGS = [
  {
    ...
    fields: [
      { key: 'phlebotomistIdentifier', label: 'Phlebotomist Identifier', isSentence: true },
      { key: 'collectionOrderPriority', label: 'Collection Order Priority', isSentence: true },
      { key: 'punctureSiteLocation', label: 'Puncture Site Location', isSentence: true },
      { key: 'venipunctureAttempts', label: 'Venipuncture Attempts' },
      { key: 'patientCooperationLevel', label: 'Patient Cooperation Level', isSentence: true },
    ],
  },
  {
    title: 'Sample Details',
    fields: [
      { key: 'tubeTypesUsed', label: 'Tube Types Used', isArray: true },
      { key: 'sampleVolumeCollected', label: 'Sample Volume Collected' },
      { key: 'preCollectionFastingHours', label: 'Pre-Collection Fasting Hours' },
      { key: 'tourniquetApplicationTime', label: 'Tourniquet Application Time' },
      { key: 'anticoagulantUsed', label: 'Anticoagulant Used', isSentence: true },
    ],
  },
  {
    title: 'Sample Quality',
    fields: [
      { key: 'hemolysisPresent', label: 'Hemolysis Present' },
      { key: 'lipemiaObserved', label: 'Lipemia Observed' },
      { key: 'ictericAppearance', label: 'Icteric Appearance' },
      { key: 'centrifugationCompleted', label: 'Centrifugation Completed' },
      { key: 'temperatureAtCollection', label: 'Temperature at Collection' },
      { key: 'refrigerationTime', label: 'Refrigeration Time', isDate: true },
    ],
  },
  {
    title: 'Tracking',
    fields: [
      { key: 'chainOfCustodyMaintained', label: 'Chain of Custody Maintained' },
      { key: 'barcodeLabels', label: 'Barcode Labels', isArray: true },
      { key: 'transportationMethod', label: 'Transportation Method', isSentence: true },
    ],
  },
  {
    title: 'Issues',
    fields: [
      { key: 'collectionDifficulties', label: 'Collection Difficulties', isArray: true },
      { key: 'adverseReactions', label: 'Adverse Reactions', isArray: true },
      { key: 'sampleRejectionReason', label: 'Sample Rejection Reason', isSentence: true },
    ],
  },
];

/* ======= COMPONENT ======= */
const BloodSampleCollectionStatusDocumentPDFTemplate = ({ document: data }) => {
      ...
      <Document>
        <Page size="LETTER" style={styles.page}>
          <View style={styles.documentHeader}>
            <Text style={styles.documentTitle}>Blood Sample Collection Status</Text>
          </View>
          ...
          <View key={index} style={styles.recordContainer}>
            ...
            <View style={styles.recordHeader} wrap={false}>
              ...
              <Text style={styles.recordTitle}>
                {`Blood Sample Collection ${index + 1}`}
              </Text>
            </View>
...
export default BloodSampleCollectionStatusDocumentPDFTemplate;
