# Task 109: getTumorMarkerPanels Grid Implementation

## Function Details
- **Function Name**: getTumorMarkerPanels
- **Category**: Oncology
...
- tumor_marker_panelsId (ObjectId) - Primary key
...
db.tumor_marker_panels.createIndex({ patientId: 1, date: -1 })
db.tumor_marker_panels.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/tumor_marker_panels
- POST /api/medical/tumor_marker_panels
- PUT /api/medical/tumor_marker_panels/:id
- DELETE /api/medical/tumor_marker_panels/:id
- GET /api/medical/tumor_marker_panels/export
...
### Backend Tasks
- [ ] Create MongoDB schema for tumor_marker_panels
...
## Related Functions
- Previous: [108-getTumorBoardNotes]
- Next: [110-getCancerStagingReports]
