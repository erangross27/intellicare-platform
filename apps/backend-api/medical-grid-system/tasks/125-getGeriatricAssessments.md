# Task 125: getGeriatricAssessments Grid Implementation

## Function Details
- **Function Name**: getGeriatricAssessments
- **Category**: Specialty
...
- geriatric_assessmentsId (ObjectId) - Primary key
...
db.geriatric_assessments.createIndex({ patientId: 1, date: -1 })
db.geriatric_assessments.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/geriatric_assessments
- POST /api/medical/geriatric_assessments
- PUT /api/medical/geriatric_assessments/:id
- DELETE /api/medical/geriatric_assessments/:id
- GET /api/medical/geriatric_assessments/export
...
```javascript
{
  ...
  metadata: {
    gridType: "geriatric_assessments",
...
### Backend Tasks
- [ ] Create MongoDB schema for geriatric_assessments
...
## Related Functions
- Previous: [124-getInfectiousDiseaseConsults]
- Next: [126-getPainManagementNotes]
