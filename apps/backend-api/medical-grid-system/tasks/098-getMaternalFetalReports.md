# Task 098: getMaternalFetalReports Grid Implementation

## Function Details
- **Function Name**: getMaternalFetalReports
...
- maternal_fetal_reportsId (ObjectId) - Primary key
...
db.maternal_fetal_reports.createIndex({ patientId: 1, date: -1 })
db.maternal_fetal_reports.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/maternal_fetal_reports
- POST /api/medical/maternal_fetal_reports
- PUT /api/medical/maternal_fetal_reports/:id
- DELETE /api/medical/maternal_fetal_reports/:id
- GET /api/medical/maternal_fetal_reports/export
...
```javascript
{
  ...
  metadata: {
    gridType: "maternal_fetal_reports",
...
### Backend Tasks
- [ ] Create MongoDB schema for maternal_fetal_reports
...
## Related Functions
- Previous: [097-getAmniocentesisReports]
- Next: [099-getUltrasoundObReports]
