...
const SECTIONS = [
  { title: 'Discussion Overview', fields: [['discussionDate', 'Discussion Date', 'date'], ['participants', 'Participants', 'arrayKeep'], ['provider', 'Provider'], ['facility', 'Facility']] },
  { title: 'Topics Covered', fields: [['topicsCovered', 'Topics Covered', 'arrayKeep']] },
  { title: 'Preferences & Proxy', fields: [['patientPreferences', 'Patient Preferences', 'sentence'], ['codeStatus', 'Code Status'], ['healthcareProxyIdentified', 'Healthcare Proxy Identified']] },
  { title: 'Documentation & Understanding', fields: [['documentationCompleted', 'Documentation Completed', 'sentence'], ['patientUnderstanding', 'Patient Understanding', 'sentence'], ['familyAgreement', 'Family Agreement', 'sentence']] },
  { title: 'Follow-up & Notes', fields: [['followUp', 'Follow-up'], ['notes', 'Notes', 'sentence']] },
];
...
const AdvanceDirectiveDiscussionDocumentPDFTemplate = ({ document: documentProp, data: dataProp, templateData }) => {
