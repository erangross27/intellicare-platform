# Task 064: getCognitiveRehabilitationReports Grid Implementation

## Function Details
- **Function Name**: getCognitiveRehabilitationReports
- **Category**: Neurology
...
- cognitive_rehabilitation_reportsId (ObjectId) - Primary key
...
db.cognitive_rehabilitation_reports.createIndex({ patientId: 1, date: -1 })
db.cognitive_rehabilitation_reports.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/cognitive_rehabilitation_reports
- POST /api/medical/cognitive_rehabilitation_reports
- PUT /api/medical/cognitive_rehabilitation_reports/:id
- DELETE /api/medical/cognitive_rehabilitation_reports/:id
- GET /api/medical/cognitive_rehabilitation_reports/export
...
```javascript
{
  ...
  metadata: {
    gridType: "cognitive_rehabilitation_reports",
...
### Backend Tasks
- [ ] Create MongoDB schema for cognitive_rehabilitation_reports
...
## Related Functions
- Previous: [063-getCognitiveEvaluations]
- Next: [065-getNerveCondutionStudies]
