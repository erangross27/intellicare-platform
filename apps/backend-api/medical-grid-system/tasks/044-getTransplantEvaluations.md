# Task 044: getTransplantEvaluations Grid Implementation

## Function Details
- **Function Name**: getTransplantEvaluations
...
- transplant_evaluationsId (ObjectId) - Primary key
...
### Real-Time Updates
- WebSocket event: `transplant_evaluations:update`
...
db.transplant_evaluations.createIndex({ patientId: 1, date: -1 })
db.transplant_evaluations.createIndex({ status: 1, practiceId: 1 })

db.transplant_evaluations.createIndex({ lastModifiedAt: -1 })
```
...
### API Endpoints
- GET /api/medical/transplant_evaluations
- POST /api/medical/transplant_evaluations
- PUT /api/medical/transplant_evaluations/:id
- DELETE /api/medical/transplant_evaluations/:id
- GET /api/medical/transplant_evaluations/export
...
```javascript
{
  ...
  metadata: {
    gridType: "transplant_evaluations",
...
### Backend Tasks
- [ ] Create MongoDB schema for transplant_evaluations
...
## Related Functions
- Previous: [043-getInterventionalRadiologyNotes]
- Next: [045-getDnrOrders]
