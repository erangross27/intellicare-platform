# Task 042: getOralSurgeryReports Grid Implementation

## Function Details
- **Function Name**: getOralSurgeryReports
...
- oral_surgery_reportsId (ObjectId) - Primary key
...
db.oral_surgery_reports.createIndex({ patientId: 1, date: -1 })
db.oral_surgery_reports.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/oral_surgery_reports
- POST /api/medical/oral_surgery_reports
- PUT /api/medical/oral_surgery_reports/:id
- DELETE /api/medical/oral_surgery_reports/:id
- GET /api/medical/oral_surgery_reports/export
...
### Backend Tasks
- [ ] Create MongoDB schema for oral_surgery_reports
...
## Related Functions
- Previous: [041-getOrthopedicOperativeReports]
- Next: [043-getInterventionalRadiologyNotes]
