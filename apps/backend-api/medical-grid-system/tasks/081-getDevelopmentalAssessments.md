# Task 081: getDevelopmentalAssessments Grid Implementation

## Function Details
- **Function Name**: getDevelopmentalAssessments
- **Category**: Pediatrics
...
- developmental_assessmentsId (ObjectId) - Primary key
...
db.developmental_assessments.createIndex({ patientId: 1, date: -1 })
db.developmental_assessments.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/developmental_assessments
- POST /api/medical/developmental_assessments
- PUT /api/medical/developmental_assessments/:id
- DELETE /api/medical/developmental_assessments/:id
- GET /api/medical/developmental_assessments/export
...
```javascript
{
  ...
  metadata: {
    gridType: "developmental_assessments",
...
### Backend Tasks
- [ ] Create MongoDB schema for developmental_assessments
...
## Related Functions
- Previous: [080-getPediatricGrowthCharts]
- Next: [082-getWellChildExaminations]
