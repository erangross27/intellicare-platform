# Task 032: getShiftHandoffNotes Grid Implementation

## Function Details
- **Function Name**: getShiftHandoffNotes
...
- shift_handoff_notesId (ObjectId) - Primary key
...
### Real-Time Updates
- WebSocket event: `shift_handoff_notes:update`
...
db.shift_handoff_notes.createIndex({ patientId: 1, date: -1 })
db.shift_handoff_notes.createIndex({ status: 1, practiceId: 1 })

db.shift_handoff_notes.createIndex({ lastModifiedAt: -1 })
```
...
### API Endpoints
- GET /api/medical/shift_handoff_notes
- POST /api/medical/shift_handoff_notes
- PUT /api/medical/shift_handoff_notes/:id
- DELETE /api/medical/shift_handoff_notes/:id
- GET /api/medical/shift_handoff_notes/export
...
### Backend Tasks
- [ ] Create MongoDB schema for shift_handoff_notes
...
## Related Functions
- Previous: [031-getEmsRunReports]
- Next: [033-getAdmissionAssessments]
