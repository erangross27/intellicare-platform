# Task 094: getPostpartumNotes Grid Implementation

## Function Details
- **Function Name**: getPostpartumNotes
...
- postpartum_notesId (ObjectId) - Primary key
...
db.postpartum_notes.createIndex({ patientId: 1, date: -1 })
db.postpartum_notes.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/postpartum_notes
- POST /api/medical/postpartum_notes
- PUT /api/medical/postpartum_notes/:id
- DELETE /api/medical/postpartum_notes/:id
- GET /api/medical/postpartum_notes/export
...
### Backend Tasks
- [ ] Create MongoDB schema for postpartum_notes
...
## Related Functions
- Previous: [093-getLaborDeliveryRecords]
- Next: [095-getGynecologyConsultations]
