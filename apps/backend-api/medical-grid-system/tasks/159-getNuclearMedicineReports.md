# Task 159: getNuclearMedicineReports Grid Implementation

## Function Details
- **Function Name**: getNuclearMedicineReports
- **Category**: Imaging
- **Collection**: nuclear_medicine_reports
- **Priority**: MEDIUM
...
- nuclear_medicine_reportsId (ObjectId) - Primary key
...
db.nuclear_medicine_reports.createIndex({ patientId: 1, date: -1 })
db.nuclear_medicine_reports.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/nuclear_medicine_reports
- POST /api/medical/nuclear_medicine_reports
- PUT /api/medical/nuclear_medicine_reports/:id
- DELETE /api/medical/nuclear_medicine_reports/:id
- GET /api/medical/nuclear_medicine_reports/export
...
```javascript
{
  ...
  metadata: {
    gridType: "nuclear_medicine_reports",
...
### Backend Tasks
- [ ] Create MongoDB schema for nuclear_medicine_reports
...
## Related Functions
- Previous: [158-getFluoroscopyReports]
- Next: [160-getInterventionalReports]
