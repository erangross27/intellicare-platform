/**
 * SmokingCessationProgramPDFTemplate.jsx
 * March 2026 — Helvetica — LETTER size — smoking cessation program
  ...
  return (
    <View style={styles.fieldBox} wrap={safeItems.length > 8 ? undefined : false}>
      ...
      {safeItems.map((item, i) => (
        <Text key={i} style={styles.listItem}>{i + 1}. {safeString(typeof item === 'string' ? item : (item.recommendation || JSON.stringify(item)))}</Text>
      ))}
    </View>
  );
};
...
const SECTION_CONFIGS = [
  {
    ...
    fields: [
      ...
      { key: 'type', label: 'Program Type', isSentence: true },
  ...
  },
  {
    ...
    fields: [
      { key: 'results', label: 'Results', isSentence: true },
...
/* ======= COMPONENT ======= */
const SmokingCessationProgramPDFTemplate = ({ document: data }) => {
      ...
      <Document>
        <Page size="LETTER" style={styles.page}>
          <View style={styles.documentHeader}>
            <Text style={styles.documentTitle}>Smoking Cessation Program</Text>
          </View>
          ...
          <View key={index} style={styles.recordContainer} break={index > 0}>
            ...
            <View style={styles.recordHeader} wrap={false}>
              ...
              <Text style={styles.recordTitle}>
                {record.type || `Smoking Cessation Program ${index + 1}`}
              </Text>
            </View>
...
export default SmokingCessationProgramPDFTemplate;
