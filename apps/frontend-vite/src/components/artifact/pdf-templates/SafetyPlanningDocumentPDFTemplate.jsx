...
const SECTIONS = [
  { id: 'riskAssessment', title: 'Risk Assessment', fields: ['suicidalIdeationSeverity', 'columbiaSuicideSeverityScore', 'phq9Score', 'gad7Score', 'suicideAttemptHistory', 'substanceUseScreening', 'riskLevelDesignation'] },
  { id: 'riskFactors', title: 'Risk Factors Identified', fields: ['riskFactorsIdentified'] },
  { id: 'warningSigns', title: 'Warning Signs Identified', fields: ['warningSignsIdentified'] },
  { id: 'protectiveFactors', title: 'Protective Factors Present', fields: ['protectiveFactorsPresent'] },
  { id: 'copingStrategies', title: 'Coping Strategies Documented', fields: ['copingStrategiesDocumented'] },
  { id: 'safetyMeasures', title: 'Safety Measures', fields: ['meansRestrictionImplemented', 'emergencyContactsVerified', 'crisisHotlineProvided', 'familyMembersNotified', 'environmentalHazardsAssessed', 'involuntaryCommitmentCriteria', 'medicationComplianceAssessed'] },
  { id: 'medicationChanges', title: 'Psychiatric Medication Changes', fields: ['psychiatricMedicationChanges'] },
  { id: 'followUp', title: 'Follow-Up', fields: ['followUpAppointmentScheduled', 'safetyPlanCompletionDate'] },
];
const FIELD_LABELS = {
...
export default function SafetyPlanningDocumentPDFTemplate({ document: data }) {
  const records = React.useMemo(() => unwrap(data), [data]);
  return <Document><Page size="LETTER" style={styles.page}>
    <View style={styles.documentHeader} wrap={false}><Text style={styles.documentTitle}>Safety Planning</Text></View>
    {!records.length && <Text style={styles.noDataText}>No safety planning data available</Text>}
    {records.map((record, recordIndex) => <View key={recordIndex} style={styles.recordContainer} break={recordIndex > 0}>
      <View wrap={false}><Text style={styles.recordTitle}>Safety Planning {recordIndex + 1}</Text></View>
