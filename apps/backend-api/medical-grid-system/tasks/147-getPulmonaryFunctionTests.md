# Task 147: getPulmonaryFunctionTests Grid Implementation

## Function Details
- **Function Name**: getPulmonaryFunctionTests
- **Category**: Diagnostic
...
- pulmonary_function_testsId (ObjectId) - Primary key
...
db.pulmonary_function_tests.createIndex({ patientId: 1, date: -1 })
db.pulmonary_function_tests.createIndex({ status: 1, practiceId: 1 })
db.pulmonary_function_tests.createIndex({ "result.isAbnormal": 1 })
...
### API Endpoints
- GET /api/medical/pulmonary_function_tests
- POST /api/medical/pulmonary_function_tests
- PUT /api/medical/pulmonary_function_tests/:id
- DELETE /api/medical/pulmonary_function_tests/:id
- GET /api/medical/pulmonary_function_tests/export
...
```javascript
{
  ...
  metadata: {
    gridType: "pulmonary_function_tests",
...
### Backend Tasks
- [ ] Create MongoDB schema for pulmonary_function_tests
...
## Related Functions
- Previous: [146-getSpirometryReports]
- Next: [148-getRadiologyReports]
