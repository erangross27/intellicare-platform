# Task 165: getOccupationalTherapyReports Grid Implementation

## Function Details
- **Function Name**: getOccupationalTherapyReports
- **Category**: Therapy
...
- occupational_therapy_reportsId (ObjectId) - Primary key
...
db.occupational_therapy_reports.createIndex({ patientId: 1, date: -1 })
db.occupational_therapy_reports.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/occupational_therapy_reports
- POST /api/medical/occupational_therapy_reports
- PUT /api/medical/occupational_therapy_reports/:id
- DELETE /api/medical/occupational_therapy_reports/:id
- GET /api/medical/occupational_therapy_reports/export
...
```javascript
{
  ...
  metadata: {
    gridType: "occupational_therapy_reports",
...
### Backend Tasks
- [ ] Create MongoDB schema for occupational_therapy_reports
...
## Related Functions
- Previous: [164-getPhysicalTherapyNotes]
- Next: [166-getSpeechTherapyAssessments]
