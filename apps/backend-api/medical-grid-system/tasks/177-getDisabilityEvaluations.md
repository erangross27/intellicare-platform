# Task 177: getDisabilityEvaluations Grid Implementation

## Function Details
- **Function Name**: getDisabilityEvaluations
...
- disability_evaluationsId (ObjectId) - Primary key
...
db.disability_evaluations.createIndex({ patientId: 1, date: -1 })
db.disability_evaluations.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/disability_evaluations
- POST /api/medical/disability_evaluations
- PUT /api/medical/disability_evaluations/:id
- DELETE /api/medical/disability_evaluations/:id
- GET /api/medical/disability_evaluations/export
...
```javascript
{
  ...
  metadata: {
    gridType: "disability_evaluations",
...
### Backend Tasks
- [ ] Create MongoDB schema for disability_evaluations
...
## Related Functions
- Previous: [176-getSocialWorkNotes]
- Next: [178-getFitnessForDutyEvaluations]
