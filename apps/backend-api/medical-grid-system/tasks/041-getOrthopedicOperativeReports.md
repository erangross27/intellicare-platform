# Task 041: getOrthopedicOperativeReports Grid Implementation

## Function Details
- **Function Name**: getOrthopedicOperativeReports
...
- orthopedic_operative_reportsId (ObjectId) - Primary key
...
db.orthopedic_operative_reports.createIndex({ patientId: 1, date: -1 })
db.orthopedic_operative_reports.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/orthopedic_operative_reports
- POST /api/medical/orthopedic_operative_reports
- PUT /api/medical/orthopedic_operative_reports/:id
- DELETE /api/medical/orthopedic_operative_reports/:id
- GET /api/medical/orthopedic_operative_reports/export
...
```javascript
{
  ...
  metadata: {
    gridType: "orthopedic_operative_reports",
...
### Backend Tasks
- [ ] Create MongoDB schema for orthopedic_operative_reports
...
## Related Functions
- Previous: [040-getSurgicalConsentForms]
- Next: [042-getOralSurgeryReports]
