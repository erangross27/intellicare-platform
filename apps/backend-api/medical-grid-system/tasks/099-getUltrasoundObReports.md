# Task 099: getUltrasoundObReports Grid Implementation

## Function Details
- **Function Name**: getUltrasoundObReports
...
- ultrasound_ob_reportsId (ObjectId) - Primary key
...
db.ultrasound_ob_reports.createIndex({ patientId: 1, date: -1 })
db.ultrasound_ob_reports.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/ultrasound_ob_reports
- POST /api/medical/ultrasound_ob_reports
- PUT /api/medical/ultrasound_ob_reports/:id
- DELETE /api/medical/ultrasound_ob_reports/:id
- GET /api/medical/ultrasound_ob_reports/export
...
```javascript
{
  ...
  metadata: {
    gridType: "ultrasound_ob_reports",
...
### Backend Tasks
- [ ] Create MongoDB schema for ultrasound_ob_reports
...
## Related Functions
- Previous: [098-getMaternalFetalReports]
- Next: [100-getPregnancyTestResults]
