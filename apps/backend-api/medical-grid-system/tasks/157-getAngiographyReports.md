# Task 157: getAngiographyReports Grid Implementation

## Function Details
- **Function Name**: getAngiographyReports
- **Category**: Imaging
- **Collection**: angiography_reports
- **Priority**: HIGH
...
- angiography_reportsId (ObjectId) - Primary key
...
db.angiography_reports.createIndex({ patientId: 1, date: -1 })
db.angiography_reports.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/angiography_reports
- POST /api/medical/angiography_reports
- PUT /api/medical/angiography_reports/:id
- DELETE /api/medical/angiography_reports/:id
- GET /api/medical/angiography_reports/export
...
### Backend Tasks
- [ ] Create MongoDB schema for angiography_reports
...
## Related Functions
- Previous: [156-getDexaScanReports]
- Next: [158-getFluoroscopyReports]
...
---
Generated: 2025-09-26T19:29:23.012Z
