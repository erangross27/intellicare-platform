# Task 164: getPhysicalTherapyNotes Grid Implementation

## Function Details
- **Function Name**: getPhysicalTherapyNotes
- **Category**: Therapy
...
- physical_therapy_notesId (ObjectId) - Primary key
...
db.physical_therapy_notes.createIndex({ patientId: 1, date: -1 })
db.physical_therapy_notes.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/physical_therapy_notes
- POST /api/medical/physical_therapy_notes
- PUT /api/medical/physical_therapy_notes/:id
- DELETE /api/medical/physical_therapy_notes/:id
- GET /api/medical/physical_therapy_notes/export
...
```javascript
{
  ...
  metadata: {
    gridType: "physical_therapy_notes",
...
### Backend Tasks
- [ ] Create MongoDB schema for physical_therapy_notes
...
## Related Functions
- Previous: [163-getPhysicalTherapyEvaluations]
- Next: [165-getOccupationalTherapyReports]
