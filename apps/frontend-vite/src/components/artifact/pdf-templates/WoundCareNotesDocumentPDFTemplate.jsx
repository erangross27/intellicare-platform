...
const SECTIONS = [
  { title: 'Wound Information', fields: [['date', 'Assessment Date', 'date'], ['provider', 'Provider'], ['facility', 'Facility']] },
  { title: 'Wound Identification', fields: [['woundLocation', 'Wound Location'], ['woundType', 'Wound Type'], ['woundStage', 'Wound Stage']] },
  { title: 'Dimensions & Structure', fields: [['woundDimensions', 'Wound Dimensions', 'object'], ['undermining', 'Undermining', 'object'], ['tunneling', 'Tunneling', 'object']] },
  { title: 'Wound Assessment', fields: [['woundBed', 'Wound Bed', 'comma'], ['exudateAmount', 'Exudate Amount'], ['exudateType', 'Exudate Type'], ['woundEdges', 'Wound Edges'], ['periwoundSkin', 'Periwound Skin'], ['odorPresent', 'Odor Present'], ['painLevel', 'Pain Level', 'number'], ['signsOfInfection', 'Signs Of Infection', 'arrayComma']] },
  { title: 'Treatment & Follow-up', fields: [['cleansingAgent', 'Cleansing Agent'], ['debridementMethod', 'Debridement Method', 'sentence'], ['primaryDressing', 'Primary Dressing'], ['secondaryDressing', 'Secondary Dressing'], ['topicalAgents', 'Topical Agents', 'arrayKeep'], ['dressingChangeFrequency', 'Dressing Change Frequency', 'comma'], ['offloadingDevice', 'Off-loading Device', 'sentence'], ['photographicDocumentation', 'Photographic Documentation']] },
];
