# Task 184: getTelemedicineEncounters Grid Implementation

## Function Details
- **Function Name**: getTelemedicineEncounters
...
- telemedicine_encountersId (ObjectId) - Primary key
...
db.telemedicine_encounters.createIndex({ patientId: 1, date: -1 })
db.telemedicine_encounters.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/telemedicine_encounters
- POST /api/medical/telemedicine_encounters
- PUT /api/medical/telemedicine_encounters/:id
- DELETE /api/medical/telemedicine_encounters/:id
- GET /api/medical/telemedicine_encounters/export
...
```javascript
{
  ...
  metadata: {
    gridType: "telemedicine_encounters",
...
### Backend Tasks
- [ ] Create MongoDB schema for telemedicine_encounters
...
## Related Functions
- Previous: [183-getWoundCareDocumentation]
...
---
Generated: 2025-09-26T19:29:23.315Z
