# Task 121: getPulmonologyConsultations Grid Implementation

## Function Details
- **Function Name**: getPulmonologyConsultations
- **Category**: Specialty
...
- pulmonology_consultationsId (ObjectId) - Primary key
...
db.pulmonology_consultations.createIndex({ patientId: 1, date: -1 })
db.pulmonology_consultations.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/pulmonology_consultations
- POST /api/medical/pulmonology_consultations
- PUT /api/medical/pulmonology_consultations/:id
- DELETE /api/medical/pulmonology_consultations/:id
- GET /api/medical/pulmonology_consultations/export
...
```javascript
{
  ...
  metadata: {
    gridType: "pulmonology_consultations",
...
### Backend Tasks
- [ ] Create MongoDB schema for pulmonology_consultations
...
## Related Functions
- Previous: [120-getEntConsultations]
- Next: [122-getRheumatologyConsultations]
