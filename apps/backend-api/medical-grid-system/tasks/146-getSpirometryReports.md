# Task 146: getSpirometryReports Grid Implementation

## Function Details
- **Function Name**: getSpirometryReports
- **Category**: Diagnostic
- **Collection**: spirometry_reports
- **Priority**: MEDIUM
...
- spirometry_reportsId (ObjectId) - Primary key
...
db.spirometry_reports.createIndex({ patientId: 1, date: -1 })
db.spirometry_reports.createIndex({ status: 1, practiceId: 1 })
db.spirometry_reports.createIndex({ "result.isAbnormal": 1 })
...
### API Endpoints
- GET /api/medical/spirometry_reports
- POST /api/medical/spirometry_reports
- PUT /api/medical/spirometry_reports/:id
- DELETE /api/medical/spirometry_reports/:id
- GET /api/medical/spirometry_reports/export
...
### Backend Tasks
- [ ] Create MongoDB schema for spirometry_reports
...
## Related Functions
- Previous: [145-getStoolAnalysisReports]
- Next: [147-getPulmonaryFunctionTests]
