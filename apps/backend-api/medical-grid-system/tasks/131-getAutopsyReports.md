# Task 131: getAutopsyReports Grid Implementation

## Function Details
- **Function Name**: getAutopsyReports
- **Category**: Diagnostic
...
- autopsy_reportsId (ObjectId) - Primary key
...
db.autopsy_reports.createIndex({ patientId: 1, date: -1 })
db.autopsy_reports.createIndex({ status: 1, practiceId: 1 })
db.autopsy_reports.createIndex({ "result.isAbnormal": 1 })
...
### API Endpoints
- GET /api/medical/autopsy_reports
- POST /api/medical/autopsy_reports
- PUT /api/medical/autopsy_reports/:id
- DELETE /api/medical/autopsy_reports/:id
- GET /api/medical/autopsy_reports/export
...
### Backend Tasks
- [ ] Create MongoDB schema for autopsy_reports
...
## Related Functions
- Previous: [130-getCytologyReports]
- Next: [132-getMicrobiologyCultureReports]
