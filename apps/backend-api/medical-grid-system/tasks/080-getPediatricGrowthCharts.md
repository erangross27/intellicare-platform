# Task 080: getPediatricGrowthCharts Grid Implementation

## Function Details
- **Function Name**: getPediatricGrowthCharts
- **Category**: Pediatrics
...
| percentileWeight | Weight %ile | number | 100px | ✅ | ❌ | Percentage |
| percentileHeight | Height %ile | number | 100px | ✅ | ❌ | Percentage |
| bmi | BMI | number | 100px | ✅ | ❌ | Number |
| percentileBMI | BMI %ile | number | 100px | ✅ | ❌ | Percentage |
...
- pediatric_growth_chartsId (ObjectId) - Primary key
...
db.pediatric_growth_charts.createIndex({ patientId: 1, date: -1 })
db.pediatric_growth_charts.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/pediatric_growth_charts
- POST /api/medical/pediatric_growth_charts
- PUT /api/medical/pediatric_growth_charts/:id
- DELETE /api/medical/pediatric_growth_charts/:id
- GET /api/medical/pediatric_growth_charts/export
...
```javascript
{
  ...
  metadata: {
    gridType: "pediatric_growth_charts",
...
### Backend Tasks
- [ ] Create MongoDB schema for pediatric_growth_charts
...
## Related Functions
- Previous: [079-getPediatricVaccinationRecords]
- Next: [081-getDevelopmentalAssessments]
