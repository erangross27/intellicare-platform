# Task 009: getDischargeSummaries Grid Implementation

## Function Details
- **Function Name**: getDischargeSummaries
...
- discharge_summariesId (ObjectId) - Primary key
...
db.discharge_summaries.createIndex({ patientId: 1, date: -1 })
db.discharge_summaries.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/discharge_summaries
- POST /api/medical/discharge_summaries
- PUT /api/medical/discharge_summaries/:id
- DELETE /api/medical/discharge_summaries/:id
- GET /api/medical/discharge_summaries/export
...
### Backend Tasks
- [ ] Create MongoDB schema for discharge_summaries
...
## Related Functions
- Previous: [008-getVaccinationRecords]
- Next: [010-getConsultationNotes]
...
---
Generated: 2025-09-26T19:29:21.497Z
