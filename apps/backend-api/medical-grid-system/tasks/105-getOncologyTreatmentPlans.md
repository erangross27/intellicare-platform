# Task 105: getOncologyTreatmentPlans Grid Implementation

## Function Details
- **Function Name**: getOncologyTreatmentPlans
- **Category**: Oncology
...
- oncology_treatment_plansId (ObjectId) - Primary key
...
### Real-Time Updates
- WebSocket event: `oncology_treatment_plans:update`
...
db.oncology_treatment_plans.createIndex({ patientId: 1, date: -1 })
db.oncology_treatment_plans.createIndex({ status: 1, practiceId: 1 })

db.oncology_treatment_plans.createIndex({ lastModifiedAt: -1 })
```
...
### API Endpoints
- GET /api/medical/oncology_treatment_plans
- POST /api/medical/oncology_treatment_plans
- PUT /api/medical/oncology_treatment_plans/:id
- DELETE /api/medical/oncology_treatment_plans/:id
- GET /api/medical/oncology_treatment_plans/export
...
```javascript
{
  ...
  metadata: {
    gridType: "oncology_treatment_plans",
...
### Backend Tasks
- [ ] Create MongoDB schema for oncology_treatment_plans
...
## Related Functions
- Previous: [104-getOncologyFollowupReports]
- Next: [106-getChemotherapyRecords]
