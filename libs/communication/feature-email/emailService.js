/**
 * Email Service - Modular Version
 * HIPAA-compliant email service with SendGrid integration
 */
...
function getServiceProxy() {
  if (!serviceProxyManager) {
    // For libs/communication/feature-email/:
...
class EmailService {
  constructor() {
    this.serviceId = 'email-service';
    this.serviceToken = null;
    this.initialized = false;
    
    // API key will be loaded from KMS during initialization
    this.fromEmail = 'IntelliCare <eran@gross.support>'; // Will be overridden during initialization
  ...
  getStatus() {
    return {
      ...
      apiKeyLoaded: this.apiKeyLoaded,
...
if (typeof module !== 'undefined' && module.exports) {
  const proxy = getServiceProxy();
  proxy.registerService('emailService', () => emailService);
}
