/**
 * ReferralsPlacedDocumentPDFTemplate.jsx
 * March 2026 — Helvetica — LETTER size — referrals placed
...
const styles = StyleSheet.create({
  ...
  statusBadge: { fontSize: 10, color: '#000000', backgroundColor: '#e0e0e0', borderWidth: 1, borderColor: '#000000', padding: 4, paddingLeft: 8, paddingRight: 8 },
...
const SECTION_CONFIGS = [
  ...
  },
  {
    ...
    fields: [
      { key: 'referringProvider', label: 'Referring Provider', isSentence: true },
      { key: 'provider', label: 'Referred To', isSentence: true },
    ],
  },
  {
    title: 'Notes',
