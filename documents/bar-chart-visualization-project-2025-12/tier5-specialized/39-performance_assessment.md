# Task: Add Bar Chart Visualization to performance_assessment
...
- **Score Fields:** agilityTestScore, asymmetryPercentage, balanceStabilityScore, functionalMovementScore
