...
const ALLOWED_FIELDS = ['date', 'provider', 'facility', 'assessment', 'hydration', 'nephrotoxinAvoidance', 'monitoring', 'plan', 'consultations', 'findings', 'recommendations', 'results', 'notes', 'status'];
