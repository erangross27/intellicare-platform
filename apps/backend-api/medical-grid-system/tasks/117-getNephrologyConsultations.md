# Task 117: getNephrologyConsultations Grid Implementation

## Function Details
- **Function Name**: getNephrologyConsultations
- **Category**: Specialty
...
- nephrology_consultationsId (ObjectId) - Primary key
...
db.nephrology_consultations.createIndex({ patientId: 1, date: -1 })
db.nephrology_consultations.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/nephrology_consultations
- POST /api/medical/nephrology_consultations
- PUT /api/medical/nephrology_consultations/:id
- DELETE /api/medical/nephrology_consultations/:id
- GET /api/medical/nephrology_consultations/export
...
```javascript
{
  ...
  metadata: {
    gridType: "nephrology_consultations",
...
### Backend Tasks
- [ ] Create MongoDB schema for nephrology_consultations
...
## Related Functions
- Previous: [116-getHematologyConsultations]
- Next: [118-getOphthalmologyExaminations]
