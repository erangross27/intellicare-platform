...
const COLLECTION = 'birth_history';
const COMMA_SPLIT_FIELDS = ['findings', 'notes'];
const ARRAY_FIELDS = new Set(['complications', 'recommendations']);
const OBJECT_FIELDS = new Set(['apgarScores', 'results', 'additionalData']);
...
const LABELS = {
  ...
  gestationalAge: 'Gestational Age', deliveryType: 'Delivery Type', birthWeight: 'Birth Weight',
  birthLength: 'Birth Length', headCircumference: 'Head Circumference', apgarScores: 'Apgar Scores',
  complications: 'Complications', nicuStay: 'NICU Stay', nicuDuration: 'NICU Duration',
...
const SECTIONS = [
  ...
  { title: 'Birth Details', fields: ['gestationalAge', 'deliveryType', 'birthWeight', 'birthLength', 'headCircumference'] },
  { title: 'Apgar Scores', fields: ['apgarScores'] },
  { title: 'Complications', fields: ['complications'] },
  { title: 'NICU', fields: ['nicuStay', 'nicuDuration'] },
