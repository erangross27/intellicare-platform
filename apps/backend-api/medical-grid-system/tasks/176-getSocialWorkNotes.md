# Task 176: getSocialWorkNotes Grid Implementation

## Function Details
- **Function Name**: getSocialWorkNotes
...
- social_work_notesId (ObjectId) - Primary key
...
db.social_work_notes.createIndex({ patientId: 1, date: -1 })
db.social_work_notes.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/social_work_notes
- POST /api/medical/social_work_notes
- PUT /api/medical/social_work_notes/:id
- DELETE /api/medical/social_work_notes/:id
- GET /api/medical/social_work_notes/export
...
### Backend Tasks
- [ ] Create MongoDB schema for social_work_notes
...
## Related Functions
- Previous: [175-getNutritionAssessments]
- Next: [177-getDisabilityEvaluations]
