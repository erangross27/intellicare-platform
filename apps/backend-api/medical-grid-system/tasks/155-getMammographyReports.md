# Task 155: getMammographyReports Grid Implementation

## Function Details
- **Function Name**: getMammographyReports
- **Category**: Imaging
...
- mammography_reportsId (ObjectId) - Primary key
...
db.mammography_reports.createIndex({ patientId: 1, date: -1 })
db.mammography_reports.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/mammography_reports
- POST /api/medical/mammography_reports
- PUT /api/medical/mammography_reports/:id
- DELETE /api/medical/mammography_reports/:id
- GET /api/medical/mammography_reports/export
...
### Backend Tasks
- [ ] Create MongoDB schema for mammography_reports
...
## Related Functions
- Previous: [154-getBoneScanReports]
- Next: [156-getDexaScanReports]
