# Task 006: getImagingReports Grid Implementation

## Function Details
- **Function Name**: getImagingReports
...
- imaging_reportsId (ObjectId) - Primary key
...
db.imaging_reports.createIndex({ patientId: 1, date: -1 })
db.imaging_reports.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/imaging_reports
- POST /api/medical/imaging_reports
- PUT /api/medical/imaging_reports/:id
- DELETE /api/medical/imaging_reports/:id
- GET /api/medical/imaging_reports/export
...
### Backend Tasks
- [ ] Create MongoDB schema for imaging_reports
...
## Related Functions
- Previous: [005-getLabResults]
- Next: [007-getPrescriptions]
