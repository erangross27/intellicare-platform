/**
 * BoneMarrowReportsDocumentPDFTemplate.jsx
 * June 2026 — Helvetica — LETTER size — bone marrow report
...
const SECTION_CONFIGS = [
  {
    title: 'Cellularity & Morphology',
    fields: [
      { key: 'cellularity', label: 'Cellularity', isSentence: true },
      { key: 'myeloidToErythroidRatio', label: 'Myeloid-to-Erythroid Ratio', isSentence: true },
      { key: 'megakaryocyteCount', label: 'Megakaryocyte Count', isSentence: true },
      { key: 'blastPercentage', label: 'Blast %', isNumber: true },
      { key: 'blastLineage', label: 'Blast Lineage', isSentence: true },
      { key: 'aspirateQuality', label: 'Aspirate Quality', isSentence: true },
    ],
  },
  {
    title: 'Dysplasia & Fibrosis',
    fields: [
      { key: 'dysplasticChanges', label: 'Dysplastic Changes', isArray: true },
      { key: 'reticulinFibrosis', label: 'Reticulin Fibrosis', isSentence: true },
      { key: 'collagenFibrosis', label: 'Collagen Fibrosis', isSentence: true },
      { key: 'ringSideroblasts', label: 'Ring Sideroblasts (%)', isNumber: true },
    ],
  },
  {
    title: 'Cell Populations',
    fields: [
      { key: 'plasmaCellPercentage', label: 'Plasma Cell %', isNumber: true },
      { key: 'lymphocytePercentage', label: 'Lymphocyte %', isNumber: true },
      { key: 'cd34PositiveCells', label: 'CD34+ Cells (%)', isNumber: true },
    ],
  },
  {
    title: 'Ancillary Studies',
    fields: [
      { key: 'flowCytometryResults', label: 'Flow Cytometry Results', isArray: true },
      { key: 'fishResults', label: 'FISH Results', isArray: true },
      { key: 'molecularMutations', label: 'Molecular Mutations', isArray: true },
      { key: 'cytogeneticsKaryotype', label: 'Cytogenetics / Karyotype', isSentence: true },
    ],
  },
  {
    title: 'Iron & Staining',
    fields: [
      { key: 'ironStoresAssessment', label: 'Iron Stores Assessment', isSentence: true },
      { key: 'tnfAlphaStaining', label: 'TNF-Alpha Staining', isSentence: true },
    ],
  },
  {
    title: 'Classification & Risk',
    fields: [
      { key: 'mdsClassification', label: 'MDS Classification', isSentence: true },
      { key: 'ipssRiskScore', label: 'IPSS Risk Score', isSentence: true },
      { key: 'biopsyLength', label: 'Biopsy Length (mm)', isNumber: true },
    ],
  },
];
...
/* ======= COMPONENT ======= */
const BoneMarrowReportsDocumentPDFTemplate = ({ document: data }) => {
      ...
      <Document>
        <Page size="LETTER" style={styles.page}>
          <View style={styles.documentHeader}>
            <Text style={styles.documentTitle}>Bone Marrow Report</Text>
          </View>
