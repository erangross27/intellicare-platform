# Task 103: getOncologyConsultations Grid Implementation

## Function Details
- **Function Name**: getOncologyConsultations
- **Category**: Oncology
...
- oncology_consultationsId (ObjectId) - Primary key
...
db.oncology_consultations.createIndex({ patientId: 1, date: -1 })
db.oncology_consultations.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/oncology_consultations
- POST /api/medical/oncology_consultations
- PUT /api/medical/oncology_consultations/:id
- DELETE /api/medical/oncology_consultations/:id
- GET /api/medical/oncology_consultations/export
...
```javascript
{
  ...
  metadata: {
    gridType: "oncology_consultations",
...
### Backend Tasks
- [ ] Create MongoDB schema for oncology_consultations
...
## Related Functions
- Previous: [102-getContraceptionRecords]
- Next: [104-getOncologyFollowupReports]
