# Task 049: getEcgReports Grid Implementation

## Function Details
- **Function Name**: getEcgReports
- **Category**: Cardiology
...
- ecg_reportsId (ObjectId) - Primary key
...
db.ecg_reports.createIndex({ patientId: 1, date: -1 })
db.ecg_reports.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/ecg_reports
- POST /api/medical/ecg_reports
- PUT /api/medical/ecg_reports/:id
- DELETE /api/medical/ecg_reports/:id
- GET /api/medical/ecg_reports/export
...
### Backend Tasks
- [ ] Create MongoDB schema for ecg_reports
...
## Related Functions
- Previous: [048-getCardiologyFollowupReports]
- Next: [050-getEchoReports]
