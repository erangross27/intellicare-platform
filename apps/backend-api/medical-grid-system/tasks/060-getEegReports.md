# Task 060: getEegReports Grid Implementation

## Function Details
- **Function Name**: getEegReports
- **Category**: Neurology
...
- eeg_reportsId (ObjectId) - Primary key
...
db.eeg_reports.createIndex({ patientId: 1, date: -1 })
db.eeg_reports.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/eeg_reports
- POST /api/medical/eeg_reports
- PUT /api/medical/eeg_reports/:id
- DELETE /api/medical/eeg_reports/:id
- GET /api/medical/eeg_reports/export
...
### Backend Tasks
- [ ] Create MongoDB schema for eeg_reports
...
## Related Functions
- Previous: [059-getNeurologyProgressNotes]
- Next: [061-getEmgReports]
