# Task 092: getPrenatalTestingReports Grid Implementation

## Function Details
- **Function Name**: getPrenatalTestingReports
...
- prenatal_testing_reportsId (ObjectId) - Primary key
...
db.prenatal_testing_reports.createIndex({ patientId: 1, date: -1 })
db.prenatal_testing_reports.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/prenatal_testing_reports
- POST /api/medical/prenatal_testing_reports
- PUT /api/medical/prenatal_testing_reports/:id
- DELETE /api/medical/prenatal_testing_reports/:id
- GET /api/medical/prenatal_testing_reports/export
...
```javascript
{
  ...
  metadata: {
    gridType: "prenatal_testing_reports",
...
### Backend Tasks
- [ ] Create MongoDB schema for prenatal_testing_reports
...
## Related Functions
- Previous: [091-getPrenatalVisits]
- Next: [093-getLaborDeliveryRecords]
