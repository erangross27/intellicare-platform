# Task 069: getPsychiatricEvaluations Grid Implementation

## Function Details
- **Function Name**: getPsychiatricEvaluations
- **Category**: Psychiatry
...
- psychiatric_evaluationsId (ObjectId) - Primary key
...
db.psychiatric_evaluations.createIndex({ patientId: 1, date: -1 })
db.psychiatric_evaluations.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/psychiatric_evaluations
- POST /api/medical/psychiatric_evaluations
- PUT /api/medical/psychiatric_evaluations/:id
- DELETE /api/medical/psychiatric_evaluations/:id
- GET /api/medical/psychiatric_evaluations/export
...
```javascript
{
  ...
  metadata: {
    gridType: "psychiatric_evaluations",
...
### Backend Tasks
- [ ] Create MongoDB schema for psychiatric_evaluations
...
## Related Functions
- Previous: [068-getSleepStudyReports]
- Next: [070-getPsychiatricProgressNotes]
