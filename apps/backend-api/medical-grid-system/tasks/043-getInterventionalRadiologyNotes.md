# Task 043: getInterventionalRadiologyNotes Grid Implementation

## Function Details
- **Function Name**: getInterventionalRadiologyNotes
...
- interventional_radiology_notesId (ObjectId) - Primary key
...
db.interventional_radiology_notes.createIndex({ patientId: 1, date: -1 })
db.interventional_radiology_notes.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/interventional_radiology_notes
- POST /api/medical/interventional_radiology_notes
- PUT /api/medical/interventional_radiology_notes/:id
- DELETE /api/medical/interventional_radiology_notes/:id
- GET /api/medical/interventional_radiology_notes/export
...
```javascript
{
  ...
  metadata: {
    gridType: "interventional_radiology_notes",
...
### Backend Tasks
- [ ] Create MongoDB schema for interventional_radiology_notes
...
## Related Functions
- Previous: [042-getOralSurgeryReports]
- Next: [044-getTransplantEvaluations]
