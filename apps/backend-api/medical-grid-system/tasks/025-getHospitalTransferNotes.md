# Task 025: getHospitalTransferNotes Grid Implementation

## Function Details
- **Function Name**: getHospitalTransferNotes
...
- hospital_transfer_notesId (ObjectId) - Primary key
...
### Real-Time Updates
- WebSocket event: `hospital_transfer_notes:update`
...
db.hospital_transfer_notes.createIndex({ patientId: 1, date: -1 })
db.hospital_transfer_notes.createIndex({ status: 1, practiceId: 1 })

db.hospital_transfer_notes.createIndex({ lastModifiedAt: -1 })
```
...
### API Endpoints
- GET /api/medical/hospital_transfer_notes
- POST /api/medical/hospital_transfer_notes
- PUT /api/medical/hospital_transfer_notes/:id
- DELETE /api/medical/hospital_transfer_notes/:id
- GET /api/medical/hospital_transfer_notes/export
...
```javascript
{
  ...
  metadata: {
    gridType: "hospital_transfer_notes",
...
### Backend Tasks
- [ ] Create MongoDB schema for hospital_transfer_notes
...
## Related Functions
- Previous: [024-getHospitalDischargeSummaries]
- Next: [026-getIcuFlowSheets]
