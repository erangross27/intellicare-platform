/**
 * TravelVaccinationRecordsDocumentPDFTemplate.jsx
 * June 2026 — Helvetica — LETTER size — travel vaccination records
...
const SECTION_CONFIGS = [
  {
    ...
    fields: [
      ...
      { key: 'destinationRegions', label: 'Destination Regions', isArray: true },
      { key: 'departureDate', label: 'Departure Date', isDate: true },
      { key: 'returnDate', label: 'Return Date', isDate: true },
      { key: 'travelDuration', label: 'Travel Duration (days)', hideZero: true },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'vaccineManufacturer', label: 'Vaccine Manufacturer' },
      { key: 'vaccineLotNumber', label: 'Vaccine Lot Number' },
  ...
  },
  {
    ...
    fields: [
      { key: 'administrationDate', label: 'Administration Date', isDate: true },
      { key: 'administrationRoute', label: 'Administration Route' },
      { key: 'administrationSite', label: 'Administration Site' },
      { key: 'dosageAmount', label: 'Dosage Amount' },
      { key: 'doseNumber', label: 'Dose Number', hideZero: true },
      { key: 'totalDosesRequired', label: 'Total Doses Required', hideZero: true },
    ],
  },
  {
    title: 'Immunity & Boosters',
    fields: [
      { key: 'immunityOnsetDate', label: 'Immunity Onset Date', isDate: true },
      { key: 'protectionDuration', label: 'Protection Duration' },
      { key: 'nextDoseDue', label: 'Next Dose Due', isDate: true },
      { key: 'boosterDueDate', label: 'Booster Due Date', isDate: true },
    ],
  },
  {
    title: 'Provider & Clinic',
    fields: [
      { key: 'vaccinatingProvider', label: 'Vaccinating Provider' },
      { key: 'clinicLocation', label: 'Clinic Location' },
    ],
  },
  {
    title: 'Yellow Card Certification',
    fields: [
      { key: 'yellowCardIssued', label: 'Yellow Card Issued' },
      { key: 'yellowCardNumber', label: 'Yellow Card Number' },
    ],
  },
  {
    title: 'Disease & Risk',
    fields: [
      { key: 'diseaseRiskLevel', label: 'Disease Risk Level', isSentence: true },
      { key: 'mandatoryVaccination', label: 'Mandatory Vaccination' },
    ],
  },
  {
    title: 'Safety & Prophylaxis',
    fields: [
      ...
      { key: 'malariaChemoprophylaxis', label: 'Malaria Chemoprophylaxis', isSentence: true },
    ],
  },
];
