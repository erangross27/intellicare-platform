# Task 132: getMicrobiologyCultureReports Grid Implementation

## Function Details
- **Function Name**: getMicrobiologyCultureReports
- **Category**: Diagnostic
...
- microbiology_culture_reportsId (ObjectId) - Primary key
...
db.microbiology_culture_reports.createIndex({ patientId: 1, date: -1 })
db.microbiology_culture_reports.createIndex({ status: 1, practiceId: 1 })
db.microbiology_culture_reports.createIndex({ "result.isAbnormal": 1 })
...
### API Endpoints
- GET /api/medical/microbiology_culture_reports
- POST /api/medical/microbiology_culture_reports
- PUT /api/medical/microbiology_culture_reports/:id
- DELETE /api/medical/microbiology_culture_reports/:id
- GET /api/medical/microbiology_culture_reports/export
...
```javascript
{
  ...
  metadata: {
    gridType: "microbiology_culture_reports",
...
### Backend Tasks
- [ ] Create MongoDB schema for microbiology_culture_reports
...
## Related Functions
- Previous: [131-getAutopsyReports]
- Next: [133-getAntibiogramReports]
...
---
Generated: 2025-09-26T19:29:22.710Z
