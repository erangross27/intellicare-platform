# Task 167: getRehabilitationProgressNotes Grid Implementation

## Function Details
- **Function Name**: getRehabilitationProgressNotes
- **Category**: Therapy
...
- rehabilitation_progress_notesId (ObjectId) - Primary key
...
db.rehabilitation_progress_notes.createIndex({ patientId: 1, date: -1 })
db.rehabilitation_progress_notes.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/rehabilitation_progress_notes
- POST /api/medical/rehabilitation_progress_notes
- PUT /api/medical/rehabilitation_progress_notes/:id
- DELETE /api/medical/rehabilitation_progress_notes/:id
- GET /api/medical/rehabilitation_progress_notes/export
...
```javascript
{
  ...
  metadata: {
    gridType: "rehabilitation_progress_notes",
...
### Backend Tasks
- [ ] Create MongoDB schema for rehabilitation_progress_notes
...
## Related Functions
- Previous: [166-getSpeechTherapyAssessments]
- Next: [168-getPulmonaryRehabilitationNotes]
