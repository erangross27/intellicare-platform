# Task 012: getReferrals Grid Implementation

## Function Details
- **Function Name**: getReferrals
...
- referralsId (ObjectId) - Primary key
...
db.referrals.createIndex({ patientId: 1, date: -1 })
db.referrals.createIndex({ status: 1, practiceId: 1 })
...
- GET /api/medical/referrals/export
...
### Backend Tasks
- [ ] Create MongoDB schema for referrals
...
## Related Functions
- Previous: [011-getMedicalProcedures]
- Next: [013-getDiagnoses]
