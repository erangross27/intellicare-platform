# Task 031: getEmsRunReports Grid Implementation

## Function Details
- **Function Name**: getEmsRunReports
...
- ems_run_reportsId (ObjectId) - Primary key
...
### Real-Time Updates
- WebSocket event: `ems_run_reports:update`
...
db.ems_run_reports.createIndex({ patientId: 1, date: -1 })
db.ems_run_reports.createIndex({ status: 1, practiceId: 1 })

db.ems_run_reports.createIndex({ lastModifiedAt: -1 })
```
...
### API Endpoints
- GET /api/medical/ems_run_reports
- POST /api/medical/ems_run_reports
- PUT /api/medical/ems_run_reports/:id
- DELETE /api/medical/ems_run_reports/:id
- GET /api/medical/ems_run_reports/export
...
### Backend Tasks
- [ ] Create MongoDB schema for ems_run_reports
...
## Related Functions
- Previous: [030-getTraumaFlowSheets]
- Next: [032-getShiftHandoffNotes]
