# Task 150: getCtScanReports Grid Implementation

## Function Details
- **Function Name**: getCtScanReports
- **Category**: Imaging
- **Collection**: ct_scan_reports
- **Priority**: HIGH
...
- ct_scan_reportsId (ObjectId) - Primary key
...
db.ct_scan_reports.createIndex({ patientId: 1, date: -1 })
db.ct_scan_reports.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/ct_scan_reports
- POST /api/medical/ct_scan_reports
- PUT /api/medical/ct_scan_reports/:id
- DELETE /api/medical/ct_scan_reports/:id
- GET /api/medical/ct_scan_reports/export
...
### Backend Tasks
- [ ] Create MongoDB schema for ct_scan_reports
...
## Related Functions
- Previous: [149-getMriReports]
- Next: [151-getXrayReports]
