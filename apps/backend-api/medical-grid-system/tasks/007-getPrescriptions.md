# Task 007: getPrescriptions Grid Implementation
...
- prescriptionsId (ObjectId) - Primary key
...
db.prescriptions.createIndex({ status: 1, practiceId: 1 })
...
- GET /api/medical/prescriptions/export
...
### Backend Tasks
- [ ] Create MongoDB schema for prescriptions
...
## Related Functions
- Previous: [006-getImagingReports]
- Next: [008-getVaccinationRecords]
