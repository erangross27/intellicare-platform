# Task 104: getOncologyFollowupReports Grid Implementation

## Function Details
- **Function Name**: getOncologyFollowupReports
- **Category**: Oncology
...
- oncology_followup_reportsId (ObjectId) - Primary key
...
db.oncology_followup_reports.createIndex({ patientId: 1, date: -1 })
db.oncology_followup_reports.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/oncology_followup_reports
- POST /api/medical/oncology_followup_reports
- PUT /api/medical/oncology_followup_reports/:id
- DELETE /api/medical/oncology_followup_reports/:id
- GET /api/medical/oncology_followup_reports/export
...
```javascript
{
  ...
  metadata: {
    gridType: "oncology_followup_reports",
...
### Backend Tasks
- [ ] Create MongoDB schema for oncology_followup_reports
...
## Related Functions
- Previous: [103-getOncologyConsultations]
- Next: [105-getOncologyTreatmentPlans]
