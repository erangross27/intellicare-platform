# Task 055: getCardiacMriReports Grid Implementation

## Function Details
- **Function Name**: getCardiacMriReports
- **Category**: Cardiology
- **Collection**: cardiac_mri_reports
- **Priority**: HIGH
...
- cardiac_mri_reportsId (ObjectId) - Primary key
...
db.cardiac_mri_reports.createIndex({ patientId: 1, date: -1 })
db.cardiac_mri_reports.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/cardiac_mri_reports
- POST /api/medical/cardiac_mri_reports
- PUT /api/medical/cardiac_mri_reports/:id
- DELETE /api/medical/cardiac_mri_reports/:id
- GET /api/medical/cardiac_mri_reports/export
...
### Backend Tasks
- [ ] Create MongoDB schema for cardiac_mri_reports
...
## Related Functions
- Previous: [054-getHolterMonitorReports]
- Next: [056-getCoronaryAngiographyReports]
