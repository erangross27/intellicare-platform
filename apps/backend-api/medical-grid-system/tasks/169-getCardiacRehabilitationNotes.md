# Task 169: getCardiacRehabilitationNotes Grid Implementation

## Function Details
- **Function Name**: getCardiacRehabilitationNotes
- **Category**: Therapy
- **Collection**: cardiac_rehabilitation_notes
- **Priority**: HIGH
...
- cardiac_rehabilitation_notesId (ObjectId) - Primary key
...
db.cardiac_rehabilitation_notes.createIndex({ patientId: 1, date: -1 })
db.cardiac_rehabilitation_notes.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/cardiac_rehabilitation_notes
- POST /api/medical/cardiac_rehabilitation_notes
- PUT /api/medical/cardiac_rehabilitation_notes/:id
- DELETE /api/medical/cardiac_rehabilitation_notes/:id
- GET /api/medical/cardiac_rehabilitation_notes/export
...
```javascript
{
  ...
  metadata: {
    gridType: "cardiac_rehabilitation_notes",
...
### Backend Tasks
- [ ] Create MongoDB schema for cardiac_rehabilitation_notes
...
## Related Functions
- Previous: [168-getPulmonaryRehabilitationNotes]
- Next: [170-getVocationalRehabilitationReports]
