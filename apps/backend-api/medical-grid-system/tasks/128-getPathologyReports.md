# Task 128: getPathologyReports Grid Implementation

## Function Details
- **Function Name**: getPathologyReports
- **Category**: Diagnostic
...
- pathology_reportsId (ObjectId) - Primary key
...
db.pathology_reports.createIndex({ patientId: 1, date: -1 })
db.pathology_reports.createIndex({ status: 1, practiceId: 1 })
db.pathology_reports.createIndex({ "result.isAbnormal": 1 })
...
### API Endpoints
- GET /api/medical/pathology_reports
- POST /api/medical/pathology_reports
- PUT /api/medical/pathology_reports/:id
- DELETE /api/medical/pathology_reports/:id
- GET /api/medical/pathology_reports/export
...
### Backend Tasks
- [ ] Create MongoDB schema for pathology_reports
...
## Related Functions
- Previous: [127-getSportsMedicineConsults]
- Next: [129-getBiopsyReports]
