# Task 153: getPetScanReports Grid Implementation

## Function Details
- **Function Name**: getPetScanReports
- **Category**: Imaging
...
- pet_scan_reportsId (ObjectId) - Primary key
...
db.pet_scan_reports.createIndex({ patientId: 1, date: -1 })
db.pet_scan_reports.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/pet_scan_reports
- POST /api/medical/pet_scan_reports
- PUT /api/medical/pet_scan_reports/:id
- DELETE /api/medical/pet_scan_reports/:id
- GET /api/medical/pet_scan_reports/export
...
### Backend Tasks
- [ ] Create MongoDB schema for pet_scan_reports
...
## Related Functions
- Previous: [152-getUltrasoundReports]
- Next: [154-getBoneScanReports]
