# Task 130: getCytologyReports Grid Implementation

## Function Details
- **Function Name**: getCytologyReports
- **Category**: Diagnostic
...
- cytology_reportsId (ObjectId) - Primary key
...
db.cytology_reports.createIndex({ patientId: 1, date: -1 })
db.cytology_reports.createIndex({ status: 1, practiceId: 1 })
db.cytology_reports.createIndex({ "result.isAbnormal": 1 })
...
### API Endpoints
- GET /api/medical/cytology_reports
- POST /api/medical/cytology_reports
- PUT /api/medical/cytology_reports/:id
- DELETE /api/medical/cytology_reports/:id
- GET /api/medical/cytology_reports/export
...
### Backend Tasks
- [ ] Create MongoDB schema for cytology_reports
...
## Related Functions
- Previous: [129-getBiopsyReports]
- Next: [131-getAutopsyReports]
