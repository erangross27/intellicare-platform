# Task 078: getPediatricVisits Grid Implementation

## Function Details
- **Function Name**: getPediatricVisits
- **Category**: Pediatrics
...
- pediatric_visitsId (ObjectId) - Primary key
...
db.pediatric_visits.createIndex({ patientId: 1, date: -1 })
db.pediatric_visits.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/pediatric_visits
- POST /api/medical/pediatric_visits
- PUT /api/medical/pediatric_visits/:id
- DELETE /api/medical/pediatric_visits/:id
- GET /api/medical/pediatric_visits/export
...
### Backend Tasks
- [ ] Create MongoDB schema for pediatric_visits
...
## Related Functions
- Previous: [077-getSubstanceAbuseAssessments]
- Next: [079-getPediatricVaccinationRecords]
