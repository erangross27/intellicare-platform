# Task 035: getMonitoringReports Grid Implementation

## Function Details
- **Function Name**: getMonitoringReports
...
- monitoring_reportsId (ObjectId) - Primary key
...
### Real-Time Updates
- WebSocket event: `monitoring_reports:update`
...
db.monitoring_reports.createIndex({ patientId: 1, date: -1 })
db.monitoring_reports.createIndex({ status: 1, practiceId: 1 })

db.monitoring_reports.createIndex({ lastModifiedAt: -1 })
```
...
### API Endpoints
- GET /api/medical/monitoring_reports
- POST /api/medical/monitoring_reports
- PUT /api/medical/monitoring_reports/:id
- DELETE /api/medical/monitoring_reports/:id
- GET /api/medical/monitoring_reports/export
...
### Backend Tasks
- [ ] Create MongoDB schema for monitoring_reports
...
## Related Functions
- Previous: [034-getCaseSummaries]
- Next: [036-getOperativeReports]
