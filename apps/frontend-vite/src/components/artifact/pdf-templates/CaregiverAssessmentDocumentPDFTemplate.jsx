...
const COLLECTION = 'caregiver_assessment';
const COMMA_SPLIT_FIELDS = ['primaryCaregiver', 'caregiverBurden', 'caregiverHealth', 'findings', 'assessment'];
const ARRAY_FIELDS = new Set(['supportServices', 'educationProvided']);
const OBJECT_FIELDS = new Set(['recommendations', 'results', 'additionalData']);
const NARRATIVE_FIELDS = new Set(['primaryCaregiver', 'caregiverBurden', 'caregiverHealth', 'financialStrain', 'findings', 'assessment', 'plan', 'notes']);
...
const LABELS = {
  ...
  primaryCaregiver: 'Primary Caregiver', caregiverBurden: 'Caregiver Burden', caregiverHealth: 'Caregiver Health', respiteNeeds: 'Respite Needs',
  supportServices: 'Support Services', educationProvided: 'Education Provided', financialStrain: 'Financial Strain',
...
const SECTIONS = [
  { title: 'Assessment Information', fields: ['date', 'type', 'provider', 'facility', 'status'] },
  { title: 'Primary Caregiver', fields: ['primaryCaregiver'] },
  { title: 'Caregiver Burden', fields: ['caregiverBurden'] },
  { title: 'Caregiver Health', fields: ['caregiverHealth', 'respiteNeeds'] },
  { title: 'Support Services', fields: ['supportServices'] },
  { title: 'Education Provided', fields: ['educationProvided'] },
  { title: 'Financial Strain', fields: ['financialStrain'] },
