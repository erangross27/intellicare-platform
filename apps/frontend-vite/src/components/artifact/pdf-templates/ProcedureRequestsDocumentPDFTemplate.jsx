/**
 * ProcedureRequestsDocumentPDFTemplate.jsx
 * June 2026 — Helvetica — LETTER size — procedure requests
...
/* renderDateRow: date field formatted */
...
const SECTION_CONFIGS = [
  {
    title: 'Request',
    fields: [
      { key: 'requestIdentifier', label: 'Request Identifier', isSentence: true },
      { key: 'procedureCode', label: 'Procedure Code', isSentence: true },
      { key: 'procedureName', label: 'Procedure Name', isSentence: true },
      { key: 'requestIntent', label: 'Request Intent', isSentence: true },
      { key: 'requestPriority', label: 'Request Priority', isSentence: true },
      { key: 'clinicalIndication', label: 'Clinical Indication', isSentence: true },
      { key: 'laterality', label: 'Laterality', isSentence: true },
    ],
  },
  {
    title: 'Requester & Performer',
    fields: [
      { key: 'requesterId', label: 'Requester ID', isSentence: true },
      { key: 'requesterName', label: 'Requester Name', isSentence: true },
      { key: 'requesterSpecialty', label: 'Requester Specialty', isSentence: true },
      { key: 'performerType', label: 'Performer Type', isSentence: true },
      { key: 'performerId', label: 'Performer ID', isSentence: true },
      { key: 'performerName', label: 'Performer Name', isSentence: true },
    ],
  },
  {
    title: 'Scheduling & Location',
    fields: [
      { key: 'requestedDateTime', label: 'Requested Date/Time', isDate: true },
      { key: 'authoredOn', label: 'Authored On', isDate: true },
      { key: 'scheduledDateTime', label: 'Scheduled Date/Time', isDate: true },
      { key: 'expectedDuration', label: 'Expected Duration (min)', isNumber: true },
      { key: 'locationId', label: 'Location ID', isSentence: true },
      { key: 'locationName', label: 'Location Name', isSentence: true },
    ],
  },
  {
    title: 'Clinical',
    fields: [
      { key: 'bodySite', label: 'Body Site', isArray: true },
      { key: 'reasonCode', label: 'Reason Code', isArray: true },
      { key: 'reasonReference', label: 'Reason Reference', isArray: true },
    ],
  },
  {
    title: 'Logistics',
    fields: [
      { key: 'consentObtained', label: 'Consent Obtained', isBoolean: true },
      { key: 'insuranceAuthorization', label: 'Insurance Authorization', isSentence: true },
      { key: 'preparationInstructions', label: 'Preparation Instructions', isSentence: true },
    ],
  },
];
...
/* ======= COMPONENT ======= */
const ProcedureRequestsDocumentPDFTemplate = ({ document: data }) => {
      ...
      <Document>
        <Page size="LETTER" style={styles.page}>
          <View style={styles.documentHeader}>
            <Text style={styles.documentTitle}>Procedure Requests</Text>
          </View>
...
export default ProcedureRequestsDocumentPDFTemplate;
