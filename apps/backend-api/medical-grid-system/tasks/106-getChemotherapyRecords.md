# Task 106: getChemotherapyRecords Grid Implementation

## Function Details
- **Function Name**: getChemotherapyRecords
- **Category**: Oncology
...
- chemotherapy_recordsId (ObjectId) - Primary key
...
### Real-Time Updates
- WebSocket event: `chemotherapy_records:update`
...
db.chemotherapy_records.createIndex({ patientId: 1, date: -1 })
db.chemotherapy_records.createIndex({ status: 1, practiceId: 1 })

db.chemotherapy_records.createIndex({ lastModifiedAt: -1 })
```
...
### API Endpoints
- GET /api/medical/chemotherapy_records
- POST /api/medical/chemotherapy_records
- PUT /api/medical/chemotherapy_records/:id
- DELETE /api/medical/chemotherapy_records/:id
- GET /api/medical/chemotherapy_records/export
...
### Backend Tasks
- [ ] Create MongoDB schema for chemotherapy_records
...
## Related Functions
- Previous: [105-getOncologyTreatmentPlans]
- Next: [107-getRadiationTherapyRecords]
