# Task 100: getPregnancyTestResults Grid Implementation

## Function Details
- **Function Name**: getPregnancyTestResults
- **Category**: Obstetrics & Gynecology
- **Collection**: pregnancy_test_results
- **Priority**: MEDIUM
...
- pregnancy_test_resultsId (ObjectId) - Primary key
...
db.pregnancy_test_results.createIndex({ patientId: 1, date: -1 })
db.pregnancy_test_results.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/pregnancy_test_results
- POST /api/medical/pregnancy_test_results
- PUT /api/medical/pregnancy_test_results/:id
- DELETE /api/medical/pregnancy_test_results/:id
- GET /api/medical/pregnancy_test_results/export
...
```javascript
{
  ...
  metadata: {
    gridType: "pregnancy_test_results",
...
### Backend Tasks
- [ ] Create MongoDB schema for pregnancy_test_results
...
## Related Functions
- Previous: [099-getUltrasoundObReports]
- Next: [101-getFertilityTreatmentRecords]
