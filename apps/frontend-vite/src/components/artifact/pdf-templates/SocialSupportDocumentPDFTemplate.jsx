...
const SECTIONS = [
  { id: 'caregiver', title: 'Caregiver Information', fields: ['primaryCaregiverType', 'caregiverAvailabilityHours', 'caregiverBurdenScale', 'homeHealthAideHours'] },
  { id: 'living', title: 'Living Situation and Family Support', fields: ['livingArrangementStatus', 'socialIsolationRiskScore', 'familySupportSystemStrength', 'emergencyContactAvailability'] },
  { id: 'practical', title: 'Practical Support', fields: ['medicationManagementSupport', 'transportationAccessibility', 'financialSupportAdequacy', 'communityResourceUtilization'] },
  { id: 'coordination', title: 'Care Coordination', fields: ['socialWorkerAssignment', 'careCoordinationComplexity', 'palliativeCareReferralStatus', 'advanceDirectiveDiscussion'] },
  { id: 'readiness', title: 'Readiness and Psychosocial Support', fields: ['dischargeReadinessScore', 'psychosocialRiskFactors', 'supportGroupParticipation'] },
  { id: 'provider', title: 'Provider Information', fields: ['provider', 'facility'] },
  { id: 'additional', title: 'Additional Data', fields: ['additionalData'] },
];
const FIELD_LABELS = {
  primaryCaregiverType: 'Primary Caregiver Type', caregiverAvailabilityHours: 'Caregiver Availability Hours', caregiverBurdenScale: 'Caregiver Burden Scale', homeHealthAideHours: 'Home Health Aide Hours', livingArrangementStatus: 'Living Arrangement Status', socialIsolationRiskScore: 'Social Isolation Risk Score', familySupportSystemStrength: 'Family Support System Strength', emergencyContactAvailability: 'Emergency Contact Availability', medicationManagementSupport: 'Medication Management Support', transportationAccessibility: 'Transportation Accessibility', financialSupportAdequacy: 'Financial Support Adequacy', communityResourceUtilization: 'Community Resource Utilization', socialWorkerAssignment: 'Social Worker Assignment', careCoordinationComplexity: 'Care Coordination Complexity', palliativeCareReferralStatus: 'Palliative Care Referral Status', advanceDirectiveDiscussion: 'Advance Directive Discussion', dischargeReadinessScore: 'Discharge Readiness Score', psychosocialRiskFactors: 'Psychosocial Risk Factors', supportGroupParticipation: 'Support Group Participation', provider: 'Provider', facility: 'Facility', additionalData: 'Additional Data',
};
const DATE_FIELDS = [];
...
export default function SocialSupportDocumentPDFTemplate({ document: data }) {
  const records = React.useMemo(() => unwrap(data), [data]);
  return <Document><Page size="LETTER" style={styles.page}>
    <View style={styles.documentHeader} wrap={false}><Text style={styles.documentTitle}>Social Support</Text></View>
    {!records.length && <Text style={styles.noDataText}>No social support data available</Text>}
    {records.map((record, recordIndex) => <View key={recordIndex} style={styles.recordContainer} break={recordIndex > 0}>
      <View wrap={false}><Text style={styles.recordTitle}>Social Support Record {recordIndex + 1}</Text></View>
