# Task 183: getWoundCareDocumentation Grid Implementation

## Function Details
- **Function Name**: getWoundCareDocumentation
...
- wound_care_documentationId (ObjectId) - Primary key
...
db.wound_care_documentation.createIndex({ patientId: 1, date: -1 })
db.wound_care_documentation.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/wound_care_documentation
- POST /api/medical/wound_care_documentation
- PUT /api/medical/wound_care_documentation/:id
- DELETE /api/medical/wound_care_documentation/:id
- GET /api/medical/wound_care_documentation/export
...
```javascript
{
  ...
  metadata: {
    gridType: "wound_care_documentation",
...
### Backend Tasks
- [ ] Create MongoDB schema for wound_care_documentation
...
## Related Functions
- Previous: [182-getPainAssessmentForms]
- Next: [184-getTelemedicineEncounters]
