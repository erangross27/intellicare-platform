# Task 107: getRadiationTherapyRecords Grid Implementation

## Function Details
- **Function Name**: getRadiationTherapyRecords
- **Category**: Oncology
...
- radiation_therapy_recordsId (ObjectId) - Primary key
...
### Real-Time Updates
- WebSocket event: `radiation_therapy_records:update`
...
db.radiation_therapy_records.createIndex({ patientId: 1, date: -1 })
db.radiation_therapy_records.createIndex({ status: 1, practiceId: 1 })

db.radiation_therapy_records.createIndex({ lastModifiedAt: -1 })
```
...
### API Endpoints
- GET /api/medical/radiation_therapy_records
- POST /api/medical/radiation_therapy_records
- PUT /api/medical/radiation_therapy_records/:id
- DELETE /api/medical/radiation_therapy_records/:id
- GET /api/medical/radiation_therapy_records/export
...
```javascript
{
  ...
  metadata: {
    gridType: "radiation_therapy_records",
...
### Backend Tasks
- [ ] Create MongoDB schema for radiation_therapy_records
...
## Related Functions
- Previous: [106-getChemotherapyRecords]
- Next: [108-getTumorBoardNotes]
...
---
Generated: 2025-09-26T19:29:22.508Z
