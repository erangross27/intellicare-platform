/**
 * StemCellTransplantAssessmentDocumentPDFTemplate.jsx
 * June 2026 — Helvetica — LETTER size — stem cell transplant assessment
...
const SECTION_CONFIGS = [
  ...
  },
  {
    title: 'HLA & Matching',
    fields: [
      { key: 'hlaTypingResults', label: 'HLA Typing Results', isSentence: true },
  ...
  },
  {
    title: 'Risk Scores',
    fields: [
      { key: 'hctCiScore', label: 'HCT-CI Score', isNumber: true },
      { key: 'kpsScore', label: 'Karnofsky Performance Status', isNumber: true },
      { key: 'pretransplantMrdStatus', label: 'Pre-Transplant MRD Status', isSentence: true },
    ],
  },
  {
    title: 'Cell Dose',
    fields: [
      { key: 'cd34PositiveCellDose', label: 'CD34+ Cell Dose (x10^6/kg)', isNumber: true },
      { key: 'totalNucleatedCellDose', label: 'Total Nucleated Cell Dose (x10^8/kg)', isNumber: true },
    ],
  },
  {
    title: 'Engraftment',
    fields: [
      ...
      { key: 'chimerismAnalysis', label: 'Chimerism Analysis', isSentence: true },
    ],
  },
  {
  ...
  {
    title: 'Serostatus & Organ Function',
    fields: [
      { key: 'cmvSerostatus', label: 'CMV Serostatus', isSentence: true },
      { key: 'ebvSerostatus', label: 'EBV Serostatus', isSentence: true },
      { key: 'pulmonaryFunctionDlco', label: 'Pulmonary Function DLCO (%)', isNumber: true },
      { key: 'cardiacEjectionFraction', label: 'Cardiac Ejection Fraction (%)', isNumber: true },
      { key: 'ferritinLevel', label: 'Ferritin Level (ng/mL)', isNumber: true },
    ],
  },
  {
    title: 'Complications',
    fields: [
      { key: 'venoOcclusiveDiseaseSeverity', label: 'Veno-Occlusive Disease Severity', isSentence: true },
      { key: 'transplantAssociatedTmaStatus', label: 'Transplant-Associated TMA', isBoolean: true },
    ],
  },
];
...
/* ======= COMPONENT ======= */
const StemCellTransplantAssessmentDocumentPDFTemplate = ({ document: data }) => {
      ...
      <Document>
        <Page size="LETTER" style={styles.page}>
          <View style={styles.documentHeader}>
            <Text style={styles.documentTitle}>Stem Cell Transplant Assessment</Text>
          </View>
          ...
          <View key={index} style={styles.recordContainer}>
            ...
            <View style={styles.recordHeader} wrap={false}>
              <Text style={styles.recordTitle}>
                {`Stem Cell Transplant Assessment ${index + 1}`}
              </Text>
            </View>
...
export default StemCellTransplantAssessmentDocumentPDFTemplate;
