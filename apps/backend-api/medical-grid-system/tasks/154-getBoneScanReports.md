# Task 154: getBoneScanReports Grid Implementation

## Function Details
- **Function Name**: getBoneScanReports
- **Category**: Imaging
...
- bone_scan_reportsId (ObjectId) - Primary key
...
db.bone_scan_reports.createIndex({ patientId: 1, date: -1 })
db.bone_scan_reports.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/bone_scan_reports
- POST /api/medical/bone_scan_reports
- PUT /api/medical/bone_scan_reports/:id
- DELETE /api/medical/bone_scan_reports/:id
- GET /api/medical/bone_scan_reports/export
...
### Backend Tasks
- [ ] Create MongoDB schema for bone_scan_reports
...
## Related Functions
- Previous: [153-getPetScanReports]
- Next: [155-getMammographyReports]
