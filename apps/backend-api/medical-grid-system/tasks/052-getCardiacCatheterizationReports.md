# Task 052: getCardiacCatheterizationReports Grid Implementation

## Function Details
- **Function Name**: getCardiacCatheterizationReports
- **Category**: Cardiology
...
| testDate | Test Date | date | 120px | ✅ | ✅ | MM/DD/YYYY |
| cardiologist | Cardiologist | string | 200px | ✅ | ✅ | Text |
| findings | Findings | string | 300px | ❌ | ✅ | Multi-line |
| recommendations | Recommendations | string | 300px | ❌ | ✅ | Multi-line |
| status | Status | enum | 120px | ✅ | ✅ | Status Badge |
| provider | Provider | string | 200px | ✅ | ✅ | Text |

### Hidden Columns (for actions/linking)
- cardiac_catheterization_reportsId (ObjectId) - Primary key
...
### Real-Time Updates
- WebSocket event: `cardiac_catheterization_reports:update`
...
db.cardiac_catheterization_reports.createIndex({ patientId: 1, date: -1 })
db.cardiac_catheterization_reports.createIndex({ status: 1, practiceId: 1 })

db.cardiac_catheterization_reports.createIndex({ lastModifiedAt: -1 })
```
...
### API Endpoints
- GET /api/medical/cardiac_catheterization_reports
- POST /api/medical/cardiac_catheterization_reports
- PUT /api/medical/cardiac_catheterization_reports/:id
- DELETE /api/medical/cardiac_catheterization_reports/:id
- GET /api/medical/cardiac_catheterization_reports/export
...
```javascript
{
  ...
  metadata: {
    gridType: "cardiac_catheterization_reports",
...
### Backend Tasks
- [ ] Create MongoDB schema for cardiac_catheterization_reports
...
## Related Functions
- Previous: [051-getStressTestReports]
- Next: [053-getCardiacRehabilitationReports]
...
---
Generated: 2025-09-26T19:29:21.902Z
