# Task 024: getHospitalDischargeSummaries Grid Implementation

## Function Details
- **Function Name**: getHospitalDischargeSummaries
...
- hospital_discharge_summariesId (ObjectId) - Primary key
...
### Real-Time Updates
- WebSocket event: `hospital_discharge_summaries:update`
...
db.hospital_discharge_summaries.createIndex({ patientId: 1, date: -1 })
db.hospital_discharge_summaries.createIndex({ status: 1, practiceId: 1 })

db.hospital_discharge_summaries.createIndex({ lastModifiedAt: -1 })
```
...
### API Endpoints
- GET /api/medical/hospital_discharge_summaries
- POST /api/medical/hospital_discharge_summaries
- PUT /api/medical/hospital_discharge_summaries/:id
- DELETE /api/medical/hospital_discharge_summaries/:id
- GET /api/medical/hospital_discharge_summaries/export
...
```javascript
{
  ...
  metadata: {
    gridType: "hospital_discharge_summaries",
...
### Backend Tasks
- [ ] Create MongoDB schema for hospital_discharge_summaries
...
## Related Functions
- Previous: [023-getHospitalAdmissionNotes]
- Next: [025-getHospitalTransferNotes]
