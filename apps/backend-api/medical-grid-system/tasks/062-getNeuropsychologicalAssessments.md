# Task 062: getNeuropsychologicalAssessments Grid Implementation

## Function Details
- **Function Name**: getNeuropsychologicalAssessments
- **Category**: Neurology
...
- neuropsychological_assessmentsId (ObjectId) - Primary key
...
db.neuropsychological_assessments.createIndex({ patientId: 1, date: -1 })
db.neuropsychological_assessments.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/neuropsychological_assessments
- POST /api/medical/neuropsychological_assessments
- PUT /api/medical/neuropsychological_assessments/:id
- DELETE /api/medical/neuropsychological_assessments/:id
- GET /api/medical/neuropsychological_assessments/export
...
```javascript
{
  ...
  metadata: {
    gridType: "neuropsychological_assessments",
...
### Backend Tasks
- [ ] Create MongoDB schema for neuropsychological_assessments
...
## Related Functions
- Previous: [061-getEmgReports]
- Next: [063-getCognitiveEvaluations]
