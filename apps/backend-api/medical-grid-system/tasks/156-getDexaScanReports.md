# Task 156: getDexaScanReports Grid Implementation

## Function Details
- **Function Name**: getDexaScanReports
- **Category**: Imaging
...
- dexa_scan_reportsId (ObjectId) - Primary key
...
db.dexa_scan_reports.createIndex({ patientId: 1, date: -1 })
db.dexa_scan_reports.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/dexa_scan_reports
- POST /api/medical/dexa_scan_reports
- PUT /api/medical/dexa_scan_reports/:id
- DELETE /api/medical/dexa_scan_reports/:id
- GET /api/medical/dexa_scan_reports/export
...
### Backend Tasks
- [ ] Create MongoDB schema for dexa_scan_reports
...
## Related Functions
- Previous: [155-getMammographyReports]
- Next: [157-getAngiographyReports]
