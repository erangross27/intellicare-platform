# Task 152: getUltrasoundReports Grid Implementation

## Function Details
- **Function Name**: getUltrasoundReports
- **Category**: Imaging
...
- ultrasound_reportsId (ObjectId) - Primary key
...
db.ultrasound_reports.createIndex({ patientId: 1, date: -1 })
db.ultrasound_reports.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/ultrasound_reports
- POST /api/medical/ultrasound_reports
- PUT /api/medical/ultrasound_reports/:id
- DELETE /api/medical/ultrasound_reports/:id
- GET /api/medical/ultrasound_reports/export
...
### Backend Tasks
- [ ] Create MongoDB schema for ultrasound_reports
...
## Related Functions
- Previous: [151-getXrayReports]
- Next: [153-getPetScanReports]
