# Task 046: getCardiologyConsultations Grid Implementation

## Function Details
- **Function Name**: getCardiologyConsultations
- **Category**: Cardiology
...
- cardiology_consultationsId (ObjectId) - Primary key
...
db.cardiology_consultations.createIndex({ patientId: 1, date: -1 })
db.cardiology_consultations.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/cardiology_consultations
- POST /api/medical/cardiology_consultations
- PUT /api/medical/cardiology_consultations/:id
- DELETE /api/medical/cardiology_consultations/:id
- GET /api/medical/cardiology_consultations/export
...
```javascript
{
  ...
  metadata: {
    gridType: "cardiology_consultations",
...
### Backend Tasks
- [ ] Create MongoDB schema for cardiology_consultations
...
## Related Functions
- Previous: [045-getDnrOrders]
- Next: [047-getCardiologyAdmissionNotes]
