# Task 077: getSubstanceAbuseAssessments Grid Implementation

## Function Details
- **Function Name**: getSubstanceAbuseAssessments
- **Category**: Psychiatry
- **Collection**: substance_abuse_assessments
- **Priority**: HIGH
...
- substance_abuse_assessmentsId (ObjectId) - Primary key
...
db.substance_abuse_assessments.createIndex({ patientId: 1, date: -1 })
db.substance_abuse_assessments.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/substance_abuse_assessments
- POST /api/medical/substance_abuse_assessments
- PUT /api/medical/substance_abuse_assessments/:id
- DELETE /api/medical/substance_abuse_assessments/:id
- GET /api/medical/substance_abuse_assessments/export
...
```javascript
{
  ...
  metadata: {
    gridType: "substance_abuse_assessments",
...
### Backend Tasks
- [ ] Create MongoDB schema for substance_abuse_assessments
...
## Related Functions
- Previous: [076-getMoodTrackingLogs]
- Next: [078-getPediatricVisits]
