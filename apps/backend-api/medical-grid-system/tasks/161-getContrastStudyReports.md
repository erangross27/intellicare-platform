# Task 161: getContrastStudyReports Grid Implementation

## Function Details
- **Function Name**: getContrastStudyReports
- **Category**: Imaging
- **Collection**: contrast_study_reports
- **Priority**: MEDIUM
...
- contrast_study_reportsId (ObjectId) - Primary key
...
db.contrast_study_reports.createIndex({ patientId: 1, date: -1 })
db.contrast_study_reports.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/contrast_study_reports
- POST /api/medical/contrast_study_reports
- PUT /api/medical/contrast_study_reports/:id
- DELETE /api/medical/contrast_study_reports/:id
- GET /api/medical/contrast_study_reports/export
...
```javascript
{
  ...
  metadata: {
    gridType: "contrast_study_reports",
...
### Backend Tasks
- [ ] Create MongoDB schema for contrast_study_reports
...
## Related Functions
- Previous: [160-getInterventionalReports]
- Next: [162-getMyelographyReports]
