# Task 070: getPsychiatricProgressNotes Grid Implementation

## Function Details
- **Function Name**: getPsychiatricProgressNotes
- **Category**: Psychiatry
...
- psychiatric_progress_notesId (ObjectId) - Primary key
...
db.psychiatric_progress_notes.createIndex({ patientId: 1, date: -1 })
db.psychiatric_progress_notes.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/psychiatric_progress_notes
- POST /api/medical/psychiatric_progress_notes
- PUT /api/medical/psychiatric_progress_notes/:id
- DELETE /api/medical/psychiatric_progress_notes/:id
- GET /api/medical/psychiatric_progress_notes/export
...
```javascript
{
  ...
  metadata: {
    gridType: "psychiatric_progress_notes",
...
### Backend Tasks
- [ ] Create MongoDB schema for psychiatric_progress_notes
...
## Related Functions
- Previous: [069-getPsychiatricEvaluations]
- Next: [071-getPsychiatricDischargeSummaries]
