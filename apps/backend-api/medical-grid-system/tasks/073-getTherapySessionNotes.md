# Task 073: getTherapySessionNotes Grid Implementation

## Function Details
- **Function Name**: getTherapySessionNotes
- **Category**: Psychiatry
...
- therapy_session_notesId (ObjectId) - Primary key
...
db.therapy_session_notes.createIndex({ patientId: 1, date: -1 })
db.therapy_session_notes.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/therapy_session_notes
- POST /api/medical/therapy_session_notes
- PUT /api/medical/therapy_session_notes/:id
- DELETE /api/medical/therapy_session_notes/:id
- GET /api/medical/therapy_session_notes/export
...
```javascript
{
  ...
  metadata: {
    gridType: "therapy_session_notes",
...
### Backend Tasks
- [ ] Create MongoDB schema for therapy_session_notes
...
## Related Functions
- Previous: [072-getMentalHealthAssessments]
- Next: [074-getTherapyProgressNotes]
