# Task 149: getMriReports Grid Implementation

## Function Details
- **Function Name**: getMriReports
- **Category**: Imaging
...
- mri_reportsId (ObjectId) - Primary key
...
db.mri_reports.createIndex({ patientId: 1, date: -1 })
db.mri_reports.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/mri_reports
- POST /api/medical/mri_reports
- PUT /api/medical/mri_reports/:id
- DELETE /api/medical/mri_reports/:id
- GET /api/medical/mri_reports/export
...
### Backend Tasks
- [ ] Create MongoDB schema for mri_reports
...
## Related Functions
- Previous: [148-getRadiologyReports]
- Next: [150-getCtScanReports]
