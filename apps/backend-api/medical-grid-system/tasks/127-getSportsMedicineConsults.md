# Task 127: getSportsMedicineConsults Grid Implementation

## Function Details
- **Function Name**: getSportsMedicineConsults
- **Category**: Specialty
- **Collection**: sports_medicine_consults
- **Priority**: LOW
...
- sports_medicine_consultsId (ObjectId) - Primary key
...
db.sports_medicine_consults.createIndex({ patientId: 1, date: -1 })
db.sports_medicine_consults.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/sports_medicine_consults
- POST /api/medical/sports_medicine_consults
- PUT /api/medical/sports_medicine_consults/:id
- DELETE /api/medical/sports_medicine_consults/:id
- GET /api/medical/sports_medicine_consults/export
...
```javascript
{
  ...
  metadata: {
    gridType: "sports_medicine_consults",
...
### Backend Tasks
- [ ] Create MongoDB schema for sports_medicine_consults
...
## Related Functions
- Previous: [126-getPainManagementNotes]
- Next: [128-getPathologyReports]
