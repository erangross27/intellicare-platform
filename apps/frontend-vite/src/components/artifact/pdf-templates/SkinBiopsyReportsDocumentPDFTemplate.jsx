...
const SECTIONS = [
  { id: 'recordInfo', title: 'General Information', fields: ['date', 'provider', 'facility', 'pathologistName'] },
  { id: 'specimenDetails', title: 'Specimen Details', fields: ['specimenSite', 'biopsyTechnique', 'specimenSize'] },
  { id: 'clinicalIndication', title: 'Clinical Indication', fields: ['clinicalIndication'] },
  { id: 'diagnosis', title: 'Histopathologic Diagnosis', fields: ['histopathologicDiagnosis'] },
  { id: 'microscopy', title: 'Microscopy', fields: ['epidermisDescription', 'dermisDescription', 'subcutaneousTissueDescription'] },
  { id: 'staging', title: 'Staging', fields: ['breslowThickness', 'clarkLevel', 'mitoticRate'] },
  { id: 'melanocytic', title: 'Melanocytic Lesion Characteristics', fields: ['melanocyticLesionCharacteristics'] },
  { id: 'marginsInvasion', title: 'Margins and Invasion', fields: ['marginStatus', 'ulcerationPresent', 'lymphovascularInvasion', 'perineuralInvasion', 'inflammatoryInfiltrate'] },
  { id: 'additional', title: 'Additional Microscopic Features', fields: ['additionalMicroscopicFeatures'] },
  { id: 'specialStains', title: 'Special Stains', fields: ['specialStainsPerformed'] },
  { id: 'immunohistochemistry', title: 'Immunohistochemistry', fields: ['immunohistochemistryResults'] },
  { id: 'molecularTesting', title: 'Molecular Testing', fields: ['molecularTestingPerformed'] },
];
const FIELD_LABELS = {
...
export default function SkinBiopsyReportsDocumentPDFTemplate({ document: data }) {
  const records = React.useMemo(() => unwrap(data), [data]);
  return <Document><Page size="LETTER" style={styles.page}>
    <View style={styles.documentHeader} wrap={false}><Text style={styles.documentTitle}>Skin Biopsy Reports</Text></View>
    {!records.length && <Text style={styles.noDataText}>No skin biopsy reports data available</Text>}
    {records.map((record, recordIndex) => <View key={recordIndex} style={styles.recordContainer} break={recordIndex > 0}>
      <View wrap={false}><Text style={styles.recordTitle}>Skin Biopsy Reports Record {recordIndex + 1}</Text></View>
