# Task 074: getTherapyProgressNotes Grid Implementation

## Function Details
- **Function Name**: getTherapyProgressNotes
- **Category**: Psychiatry
...
- therapy_progress_notesId (ObjectId) - Primary key
...
db.therapy_progress_notes.createIndex({ patientId: 1, date: -1 })
db.therapy_progress_notes.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/therapy_progress_notes
- POST /api/medical/therapy_progress_notes
- PUT /api/medical/therapy_progress_notes/:id
- DELETE /api/medical/therapy_progress_notes/:id
- GET /api/medical/therapy_progress_notes/export
...
```javascript
{
  ...
  metadata: {
    gridType: "therapy_progress_notes",
...
### Backend Tasks
- [ ] Create MongoDB schema for therapy_progress_notes
...
## Related Functions
- Previous: [073-getTherapySessionNotes]
- Next: [075-getBehavioralAssessments]
