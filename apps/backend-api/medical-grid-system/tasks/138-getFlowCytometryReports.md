# Task 138: getFlowCytometryReports Grid Implementation

## Function Details
- **Function Name**: getFlowCytometryReports
- **Category**: Diagnostic
...
- flow_cytometry_reportsId (ObjectId) - Primary key
...
db.flow_cytometry_reports.createIndex({ patientId: 1, date: -1 })
db.flow_cytometry_reports.createIndex({ status: 1, practiceId: 1 })
db.flow_cytometry_reports.createIndex({ "result.isAbnormal": 1 })
...
### API Endpoints
- GET /api/medical/flow_cytometry_reports
- POST /api/medical/flow_cytometry_reports
- PUT /api/medical/flow_cytometry_reports/:id
- DELETE /api/medical/flow_cytometry_reports/:id
- GET /api/medical/flow_cytometry_reports/export
...
```javascript
{
  ...
  metadata: {
    gridType: "flow_cytometry_reports",
...
### Backend Tasks
- [ ] Create MongoDB schema for flow_cytometry_reports
...
## Related Functions
- Previous: [137-getGeneticTestingReports]
- Next: [139-getBoneMarrowReports]
