# Task 033: getAdmissionAssessments Grid Implementation

## Function Details
- **Function Name**: getAdmissionAssessments
...
- admission_assessmentsId (ObjectId) - Primary key
...
### Real-Time Updates
- WebSocket event: `admission_assessments:update`
...
db.admission_assessments.createIndex({ patientId: 1, date: -1 })
db.admission_assessments.createIndex({ status: 1, practiceId: 1 })

db.admission_assessments.createIndex({ lastModifiedAt: -1 })
```
...
### API Endpoints
- GET /api/medical/admission_assessments
- POST /api/medical/admission_assessments
- PUT /api/medical/admission_assessments/:id
- DELETE /api/medical/admission_assessments/:id
- GET /api/medical/admission_assessments/export
...
```javascript
{
  ...
  metadata: {
    gridType: "admission_assessments",
...
### Backend Tasks
- [ ] Create MongoDB schema for admission_assessments
...
## Related Functions
- Previous: [032-getShiftHandoffNotes]
- Next: [034-getCaseSummaries]
