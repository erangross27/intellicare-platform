# Task 158: getFluoroscopyReports Grid Implementation

## Function Details
- **Function Name**: getFluoroscopyReports
- **Category**: Imaging
- **Collection**: fluoroscopy_reports
- **Priority**: MEDIUM
...
- fluoroscopy_reportsId (ObjectId) - Primary key
...
db.fluoroscopy_reports.createIndex({ patientId: 1, date: -1 })
db.fluoroscopy_reports.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/fluoroscopy_reports
- POST /api/medical/fluoroscopy_reports
- PUT /api/medical/fluoroscopy_reports/:id
- DELETE /api/medical/fluoroscopy_reports/:id
- GET /api/medical/fluoroscopy_reports/export
...
### Backend Tasks
- [ ] Create MongoDB schema for fluoroscopy_reports
...
## Related Functions
- Previous: [157-getAngiographyReports]
- Next: [159-getNuclearMedicineReports]
