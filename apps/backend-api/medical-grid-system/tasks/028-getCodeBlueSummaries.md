# Task 028: getCodeBlueSummaries Grid Implementation

## Function Details
- **Function Name**: getCodeBlueSummaries
...
- code_blue_summariesId (ObjectId) - Primary key
...
### Real-Time Updates
- WebSocket event: `code_blue_summaries:update`
...
db.code_blue_summaries.createIndex({ patientId: 1, date: -1 })
db.code_blue_summaries.createIndex({ status: 1, practiceId: 1 })

db.code_blue_summaries.createIndex({ lastModifiedAt: -1 })
```
...
### API Endpoints
- GET /api/medical/code_blue_summaries
- POST /api/medical/code_blue_summaries
- PUT /api/medical/code_blue_summaries/:id
- DELETE /api/medical/code_blue_summaries/:id
- GET /api/medical/code_blue_summaries/export
...
### Backend Tasks
- [ ] Create MongoDB schema for code_blue_summaries
...
## Related Functions
- Previous: [027-getTransferSummaries]
- Next: [029-getRapidResponseSummaries]
