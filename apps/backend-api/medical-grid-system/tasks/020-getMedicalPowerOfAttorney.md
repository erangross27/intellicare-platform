# Task 020: getMedicalPowerOfAttorney Grid Implementation

## Function Details
- **Function Name**: getMedicalPowerOfAttorney
...
- medical_power_of_attorneyId (ObjectId) - Primary key
...
db.medical_power_of_attorney.createIndex({ patientId: 1, date: -1 })
db.medical_power_of_attorney.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/medical_power_of_attorney
- POST /api/medical/medical_power_of_attorney
- PUT /api/medical/medical_power_of_attorney/:id
- DELETE /api/medical/medical_power_of_attorney/:id
- GET /api/medical/medical_power_of_attorney/export
...
```javascript
{
  ...
  metadata: {
    gridType: "medical_power_of_attorney",
...
### Backend Tasks
- [ ] Create MongoDB schema for medical_power_of_attorney
...
## Related Functions
- Previous: [019-getAdvancedDirectives]
- Next: [021-getEmergencyReports]
...
---
Generated: 2025-09-26T19:29:21.598Z
