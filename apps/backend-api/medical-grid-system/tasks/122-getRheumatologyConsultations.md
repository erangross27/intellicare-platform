# Task 122: getRheumatologyConsultations Grid Implementation

## Function Details
- **Function Name**: getRheumatologyConsultations
- **Category**: Specialty
...
- rheumatology_consultationsId (ObjectId) - Primary key
...
db.rheumatology_consultations.createIndex({ patientId: 1, date: -1 })
db.rheumatology_consultations.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/rheumatology_consultations
- POST /api/medical/rheumatology_consultations
- PUT /api/medical/rheumatology_consultations/:id
- DELETE /api/medical/rheumatology_consultations/:id
- GET /api/medical/rheumatology_consultations/export
...
```javascript
{
  ...
  metadata: {
    gridType: "rheumatology_consultations",
...
### Backend Tasks
- [ ] Create MongoDB schema for rheumatology_consultations
...
## Related Functions
- Previous: [121-getPulmonologyConsultations]
- Next: [123-getUrologyConsultations]
