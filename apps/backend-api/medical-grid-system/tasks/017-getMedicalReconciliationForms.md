# Task 017: getMedicalReconciliationForms Grid Implementation

## Function Details
- **Function Name**: getMedicalReconciliationForms
...
- medical_reconciliation_formsId (ObjectId) - Primary key
...
db.medical_reconciliation_forms.createIndex({ patientId: 1, date: -1 })
db.medical_reconciliation_forms.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/medical_reconciliation_forms
- POST /api/medical/medical_reconciliation_forms
- PUT /api/medical/medical_reconciliation_forms/:id
- DELETE /api/medical/medical_reconciliation_forms/:id
- GET /api/medical/medical_reconciliation_forms/export
...
```javascript
{
  ...
  metadata: {
    gridType: "medical_reconciliation_forms",
...
### Backend Tasks
- [ ] Create MongoDB schema for medical_reconciliation_forms
...
## Related Functions
- Previous: [016-getPatientEducationRecords]
- Next: [018-getInsuranceForms]
