# Task 086: getPediatricConsultations Grid Implementation

## Function Details
- **Function Name**: getPediatricConsultations
- **Category**: Pediatrics
- **Collection**: pediatric_consultations
- **Priority**: HIGH
...
- pediatric_consultationsId (ObjectId) - Primary key
...
db.pediatric_consultations.createIndex({ patientId: 1, date: -1 })
db.pediatric_consultations.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/pediatric_consultations
- POST /api/medical/pediatric_consultations
- PUT /api/medical/pediatric_consultations/:id
- DELETE /api/medical/pediatric_consultations/:id
- GET /api/medical/pediatric_consultations/export
...
```javascript
{
  ...
  metadata: {
    gridType: "pediatric_consultations",
...
### Backend Tasks
- [ ] Create MongoDB schema for pediatric_consultations
...
## Related Functions
- Previous: [085-getNicuProgressNotes]
- Next: [087-getChildhoodIllnessRecords]
