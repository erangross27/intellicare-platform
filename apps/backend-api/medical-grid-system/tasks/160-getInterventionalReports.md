# Task 160: getInterventionalReports Grid Implementation

## Function Details
- **Function Name**: getInterventionalReports
- **Category**: Imaging
- **Collection**: interventional_reports
- **Priority**: HIGH
- **Estimated Patients Affected**: 80%
...
| studyType | Study Type | string | 200px | ✅ | ✅ | Text |
| bodyPart | Body Part | string | 200px | ✅ | ✅ | Text |
| technique | Technique | string | 200px | ✅ | ✅ | Text |
| contrast | Contrast | boolean | 80px | ✅ | ✅ | Yes/No |
| findings | Findings | string | 300px | ❌ | ✅ | Multi-line |
| impression | Impression | string | 300px | ❌ | ✅ | Multi-line |
| radiologist | Radiologist | string | 200px | ✅ | ✅ | Text |
| studyDate | Study Date | datetime | 180px | ✅ | ✅ | MM/DD/YYYY HH:MM |
| status | Status | enum | 120px | ✅ | ✅ | Status Badge |
| provider | Provider | string | 200px | ✅ | ✅ | Text |

### Hidden Columns (for actions/linking)
- interventional_reportsId (ObjectId) - Primary key
...
db.interventional_reports.createIndex({ patientId: 1, date: -1 })
db.interventional_reports.createIndex({ status: 1, practiceId: 1 })
...
- **PACS**: Image viewing integration

- **Document Management**: Attachment storage
- **Notification System**: Alert on critical values

### API Endpoints
- GET /api/medical/interventional_reports
- POST /api/medical/interventional_reports
- PUT /api/medical/interventional_reports/:id
- DELETE /api/medical/interventional_reports/:id
- GET /api/medical/interventional_reports/export
...
```javascript
{
  ...
  metadata: {
    gridType: "interventional_reports",
...
### Backend Tasks
- [ ] Create MongoDB schema for interventional_reports
...
## Related Functions
- Previous: [159-getNuclearMedicineReports]
- Next: [161-getContrastStudyReports]
- Related: [List other related functions in same category]

## Notes & Considerations
- 
- 📊 High usage function - Optimize for performance
- 
- 
...
---
Generated: 2025-09-26T19:29:23.013Z
