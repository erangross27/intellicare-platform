# Task 053: getCardiacRehabilitationReports Grid Implementation

## Function Details
- **Function Name**: getCardiacRehabilitationReports
- **Category**: Cardiology
...
- cardiac_rehabilitation_reportsId (ObjectId) - Primary key
...
db.cardiac_rehabilitation_reports.createIndex({ patientId: 1, date: -1 })
db.cardiac_rehabilitation_reports.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/cardiac_rehabilitation_reports
- POST /api/medical/cardiac_rehabilitation_reports
- PUT /api/medical/cardiac_rehabilitation_reports/:id
- DELETE /api/medical/cardiac_rehabilitation_reports/:id
- GET /api/medical/cardiac_rehabilitation_reports/export
...
```javascript
{
  ...
  metadata: {
    gridType: "cardiac_rehabilitation_reports",
...
### Backend Tasks
- [ ] Create MongoDB schema for cardiac_rehabilitation_reports
...
## Related Functions
- Previous: [052-getCardiacCatheterizationReports]
- Next: [054-getHolterMonitorReports]
