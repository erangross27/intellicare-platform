# Task 113: getDermatologyConsultations Grid Implementation

## Function Details
- **Function Name**: getDermatologyConsultations
- **Category**: Specialty
...
- dermatology_consultationsId (ObjectId) - Primary key
...
db.dermatology_consultations.createIndex({ patientId: 1, date: -1 })
db.dermatology_consultations.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/dermatology_consultations
- POST /api/medical/dermatology_consultations
- PUT /api/medical/dermatology_consultations/:id
- DELETE /api/medical/dermatology_consultations/:id
- GET /api/medical/dermatology_consultations/export
...
```javascript
{
  ...
  metadata: {
    gridType: "dermatology_consultations",
...
### Backend Tasks
- [ ] Create MongoDB schema for dermatology_consultations
...
## Related Functions
- Previous: [112-getCancerGeneticsReports]
- Next: [114-getEndocrinologyConsultations]
