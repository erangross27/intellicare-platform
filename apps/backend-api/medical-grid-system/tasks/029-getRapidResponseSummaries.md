# Task 029: getRapidResponseSummaries Grid Implementation

## Function Details
- **Function Name**: getRapidResponseSummaries
...
- rapid_response_summariesId (ObjectId) - Primary key
...
### Real-Time Updates
- WebSocket event: `rapid_response_summaries:update`
...
db.rapid_response_summaries.createIndex({ patientId: 1, date: -1 })
db.rapid_response_summaries.createIndex({ status: 1, practiceId: 1 })

db.rapid_response_summaries.createIndex({ lastModifiedAt: -1 })
```
...
### API Endpoints
- GET /api/medical/rapid_response_summaries
- POST /api/medical/rapid_response_summaries
- PUT /api/medical/rapid_response_summaries/:id
- DELETE /api/medical/rapid_response_summaries/:id
- GET /api/medical/rapid_response_summaries/export
...
```javascript
{
  ...
  metadata: {
    gridType: "rapid_response_summaries",
...
### Backend Tasks
- [ ] Create MongoDB schema for rapid_response_summaries
...
## Related Functions
- Previous: [028-getCodeBlueSummaries]
- Next: [030-getTraumaFlowSheets]
