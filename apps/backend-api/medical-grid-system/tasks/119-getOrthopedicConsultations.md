# Task 119: getOrthopedicConsultations Grid Implementation

## Function Details
- **Function Name**: getOrthopedicConsultations
- **Category**: Specialty
...
- orthopedic_consultationsId (ObjectId) - Primary key
...
db.orthopedic_consultations.createIndex({ patientId: 1, date: -1 })
db.orthopedic_consultations.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/orthopedic_consultations
- POST /api/medical/orthopedic_consultations
- PUT /api/medical/orthopedic_consultations/:id
- DELETE /api/medical/orthopedic_consultations/:id
- GET /api/medical/orthopedic_consultations/export
...
```javascript
{
  ...
  metadata: {
    gridType: "orthopedic_consultations",
...
### Backend Tasks
- [ ] Create MongoDB schema for orthopedic_consultations
...
## Related Functions
- Previous: [118-getOphthalmologyExaminations]
- Next: [120-getEntConsultations]
