# Task 051: getStressTestReports Grid Implementation

## Function Details
- **Function Name**: getStressTestReports
- **Category**: Cardiology
...
- stress_test_reportsId (ObjectId) - Primary key
...
db.stress_test_reports.createIndex({ patientId: 1, date: -1 })
db.stress_test_reports.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/stress_test_reports
- POST /api/medical/stress_test_reports
- PUT /api/medical/stress_test_reports/:id
- DELETE /api/medical/stress_test_reports/:id
- GET /api/medical/stress_test_reports/export
...
### Backend Tasks
- [ ] Create MongoDB schema for stress_test_reports
...
## Related Functions
- Previous: [050-getEchoReports]
- Next: [052-getCardiacCatheterizationReports]
