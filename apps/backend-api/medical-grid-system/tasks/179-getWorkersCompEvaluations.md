# Task 179: getWorkersCompEvaluations Grid Implementation

## Function Details
- **Function Name**: getWorkersCompEvaluations
...
- workers_comp_evaluationsId (ObjectId) - Primary key
...
db.workers_comp_evaluations.createIndex({ patientId: 1, date: -1 })
db.workers_comp_evaluations.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/workers_comp_evaluations
- POST /api/medical/workers_comp_evaluations
- PUT /api/medical/workers_comp_evaluations/:id
- DELETE /api/medical/workers_comp_evaluations/:id
- GET /api/medical/workers_comp_evaluations/export
...
```javascript
{
  ...
  metadata: {
    gridType: "workers_comp_evaluations",
...
### Backend Tasks
- [ ] Create MongoDB schema for workers_comp_evaluations
...
## Related Functions
- Previous: [178-getFitnessForDutyEvaluations]
- Next: [180-getTravelHealthCertificates]
