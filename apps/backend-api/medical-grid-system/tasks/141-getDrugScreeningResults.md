# Task 141: getDrugScreeningResults Grid Implementation

## Function Details
- **Function Name**: getDrugScreeningResults
- **Category**: Diagnostic
- **Collection**: drug_screening_results
- **Priority**: HIGH
...
- drug_screening_resultsId (ObjectId) - Primary key
...
db.drug_screening_results.createIndex({ patientId: 1, date: -1 })
db.drug_screening_results.createIndex({ status: 1, practiceId: 1 })
db.drug_screening_results.createIndex({ "result.isAbnormal": 1 })
...
### API Endpoints
- GET /api/medical/drug_screening_results
- POST /api/medical/drug_screening_results
- PUT /api/medical/drug_screening_results/:id
- DELETE /api/medical/drug_screening_results/:id
- GET /api/medical/drug_screening_results/export
...
```javascript
{
  ...
  metadata: {
    gridType: "drug_screening_results",
...
### Backend Tasks
- [ ] Create MongoDB schema for drug_screening_results
...
## Related Functions
- Previous: [140-getToxicologyReports]
- Next: [142-getBloodBankRecords]
