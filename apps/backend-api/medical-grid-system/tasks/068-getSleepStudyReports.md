# Task 068: getSleepStudyReports Grid Implementation

## Function Details
- **Function Name**: getSleepStudyReports
- **Category**: Neurology
...
- sleep_study_reportsId (ObjectId) - Primary key
...
db.sleep_study_reports.createIndex({ patientId: 1, date: -1 })
db.sleep_study_reports.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/sleep_study_reports
- POST /api/medical/sleep_study_reports
- PUT /api/medical/sleep_study_reports/:id
- DELETE /api/medical/sleep_study_reports/:id
- GET /api/medical/sleep_study_reports/export
...
### Backend Tasks
- [ ] Create MongoDB schema for sleep_study_reports
...
## Related Functions
- Previous: [067-getSeizureLogs]
- Next: [069-getPsychiatricEvaluations]
