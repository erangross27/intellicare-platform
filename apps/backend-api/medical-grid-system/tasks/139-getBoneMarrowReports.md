# Task 139: getBoneMarrowReports Grid Implementation

## Function Details
- **Function Name**: getBoneMarrowReports
- **Category**: Diagnostic
...
- bone_marrow_reportsId (ObjectId) - Primary key
...
db.bone_marrow_reports.createIndex({ patientId: 1, date: -1 })
db.bone_marrow_reports.createIndex({ status: 1, practiceId: 1 })
db.bone_marrow_reports.createIndex({ "result.isAbnormal": 1 })
...
### API Endpoints
- GET /api/medical/bone_marrow_reports
- POST /api/medical/bone_marrow_reports
- PUT /api/medical/bone_marrow_reports/:id
- DELETE /api/medical/bone_marrow_reports/:id
- GET /api/medical/bone_marrow_reports/export
...
### Backend Tasks
- [ ] Create MongoDB schema for bone_marrow_reports
...
## Related Functions
- Previous: [138-getFlowCytometryReports]
- Next: [140-getToxicologyReports]
