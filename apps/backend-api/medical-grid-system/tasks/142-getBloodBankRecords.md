# Task 142: getBloodBankRecords Grid Implementation

## Function Details
- **Function Name**: getBloodBankRecords
- **Category**: Diagnostic
- **Collection**: blood_bank_records
- **Priority**: CRITICAL
...
- blood_bank_recordsId (ObjectId) - Primary key
...
### Real-Time Updates
- WebSocket event: `blood_bank_records:update`
...
db.blood_bank_records.createIndex({ patientId: 1, date: -1 })
db.blood_bank_records.createIndex({ status: 1, practiceId: 1 })
db.blood_bank_records.createIndex({ "result.isAbnormal": 1 })
db.blood_bank_records.createIndex({ lastModifiedAt: -1 })
```
...
### API Endpoints
- GET /api/medical/blood_bank_records
- POST /api/medical/blood_bank_records
- PUT /api/medical/blood_bank_records/:id
- DELETE /api/medical/blood_bank_records/:id
- GET /api/medical/blood_bank_records/export
...
### Backend Tasks
- [ ] Create MongoDB schema for blood_bank_records
...
## Related Functions
- Previous: [141-getDrugScreeningResults]
- Next: [143-getTransfusionRecords]
