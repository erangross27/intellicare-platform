/**
 * HeightMeasurementsDocumentPDFTemplate.jsx
 * June 2026 — Helvetica — LETTER size — height measurements
...
const SECTION_CONFIGS = [
  {
    ...
    fields: [
      { key: 'heightCentimeters', label: 'Height (cm)', isNumber: true },
      { key: 'heightFeetInches', label: 'Height (ft-in)', isSentence: true },
      { key: 'measurementMethod', label: 'Measurement Method', isSentence: true },
      { key: 'patientPosition', label: 'Patient Position', isSentence: true },
    ],
  },
  {
    title: 'Surrogate Measures',
    fields: [
      { key: 'armSpanMeasurement', label: 'Arm Span (cm)', isNumber: true },
      { key: 'kneeHeightMeasurement', label: 'Knee Height (cm)', isNumber: true },
      { key: 'crownHeelLength', label: 'Crown-Heel Length (cm)', isNumber: true },
    ],
  },
  {
    title: 'Pediatric Growth',
    fields: [
      { key: 'heightPercentile', label: 'Height Percentile', isNumber: true },
      { key: 'heightVelocity', label: 'Height Velocity (cm/yr)', isNumber: true },
      { key: 'heightZScore', label: 'Height Z-Score', isNumber: true },
      { key: 'midParentalHeight', label: 'Mid-Parental Height (cm)', isNumber: true },
      { key: 'growthChartReference', label: 'Growth Chart Reference', isSentence: true },
      { key: 'bodyMassIndexPercentile', label: 'BMI Percentile', isNumber: true },
    ],
  },
  {
  ...
  },
  {
    ...
    fields: [
      { key: 'measuredBy', label: 'Measured By', isSentence: true },
      { key: 'shoesRemoved', label: 'Shoes Removed', isBoolean: true },
      { key: 'estimatedHeight', label: 'Estimated Height', isBoolean: true },
      { key: 'kyphoscoliosis', label: 'Kyphoscoliosis', isBoolean: true },
      { key: 'instrumentCalibrated', label: 'Instrument Calibrated', isBoolean: true },
      { key: 'patientCooperative', label: 'Patient Cooperative', isBoolean: true },
      { key: 'spinalDeformity', label: 'Spinal Deformity', isSentence: true },
      { key: 'measurementAccuracy', label: 'Measurement Accuracy', isSentence: true },
      { key: 'heightLossFromBaseline', label: 'Height Loss from Baseline (cm)', isNumber: true },
    ],
  },
];
...
/* ======= COMPONENT ======= */
const HeightMeasurementsDocumentPDFTemplate = ({ document: data }) => {
      ...
      <Document>
        <Page size="LETTER" style={styles.page}>
          <View style={styles.documentHeader}>
            <Text style={styles.documentTitle}>Height Measurements</Text>
          </View>
...
export default HeightMeasurementsDocumentPDFTemplate;
