# Task 180: getTravelHealthCertificates Grid Implementation

## Function Details
- **Function Name**: getTravelHealthCertificates
...
- travel_health_certificatesId (ObjectId) - Primary key
...
db.travel_health_certificates.createIndex({ patientId: 1, date: -1 })
db.travel_health_certificates.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/travel_health_certificates
- POST /api/medical/travel_health_certificates
- PUT /api/medical/travel_health_certificates/:id
- DELETE /api/medical/travel_health_certificates/:id
- GET /api/medical/travel_health_certificates/export
...
```javascript
{
  ...
  metadata: {
    gridType: "travel_health_certificates",
...
### Backend Tasks
- [ ] Create MongoDB schema for travel_health_certificates
...
## Related Functions
- Previous: [179-getWorkersCompEvaluations]
- Next: [181-getFallRiskAssessments]
