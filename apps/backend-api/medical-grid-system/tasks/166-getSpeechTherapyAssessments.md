# Task 166: getSpeechTherapyAssessments Grid Implementation

## Function Details
- **Function Name**: getSpeechTherapyAssessments
- **Category**: Therapy
...
- speech_therapy_assessmentsId (ObjectId) - Primary key
...
db.speech_therapy_assessments.createIndex({ patientId: 1, date: -1 })
db.speech_therapy_assessments.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/speech_therapy_assessments
- POST /api/medical/speech_therapy_assessments
- PUT /api/medical/speech_therapy_assessments/:id
- DELETE /api/medical/speech_therapy_assessments/:id
- GET /api/medical/speech_therapy_assessments/export
...
```javascript
{
  ...
  metadata: {
    gridType: "speech_therapy_assessments",
...
### Backend Tasks
- [ ] Create MongoDB schema for speech_therapy_assessments
...
## Related Functions
- Previous: [165-getOccupationalTherapyReports]
- Next: [167-getRehabilitationProgressNotes]
