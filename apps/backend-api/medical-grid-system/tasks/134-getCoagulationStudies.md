# Task 134: getCoagulationStudies Grid Implementation

## Function Details
- **Function Name**: getCoagulationStudies
- **Category**: Diagnostic
...
- coagulation_studiesId (ObjectId) - Primary key
...
db.coagulation_studies.createIndex({ patientId: 1, date: -1 })
db.coagulation_studies.createIndex({ status: 1, practiceId: 1 })
db.coagulation_studies.createIndex({ "result.isAbnormal": 1 })
...
### API Endpoints
- GET /api/medical/coagulation_studies
- POST /api/medical/coagulation_studies
- PUT /api/medical/coagulation_studies/:id
- DELETE /api/medical/coagulation_studies/:id
- GET /api/medical/coagulation_studies/export
...
### Backend Tasks
- [ ] Create MongoDB schema for coagulation_studies
...
## Related Functions
- Previous: [133-getAntibiogramReports]
- Next: [135-getHormonePanels]
