...
class TracingService {
  constructor() {
    ...
    // Configuration
    this.config = {
      serviceName: process.env.SERVICE_NAME || 'intellicare-backend',
  ...
  async initialize() {
    ...
    try {
      ...
      this.serviceToken = await serviceAccountManager.authenticate('tracing-service');
...
if (typeof module !== 'undefined' && module.exports) {
    const proxy = getServiceProxy();
    proxy.registerService('tracingService', () => tracingService);
}
