# Task 182: getPainAssessmentForms Grid Implementation

## Function Details
- **Function Name**: getPainAssessmentForms
...
- pain_assessment_formsId (ObjectId) - Primary key
...
db.pain_assessment_forms.createIndex({ patientId: 1, date: -1 })
db.pain_assessment_forms.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/pain_assessment_forms
- POST /api/medical/pain_assessment_forms
- PUT /api/medical/pain_assessment_forms/:id
- DELETE /api/medical/pain_assessment_forms/:id
- GET /api/medical/pain_assessment_forms/export
...
```javascript
{
  ...
  metadata: {
    gridType: "pain_assessment_forms",
...
### Backend Tasks
- [ ] Create MongoDB schema for pain_assessment_forms
...
## Related Functions
- Previous: [181-getFallRiskAssessments]
- Next: [183-getWoundCareDocumentation]
