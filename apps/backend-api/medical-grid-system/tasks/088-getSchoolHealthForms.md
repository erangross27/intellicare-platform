# Task 088: getSchoolHealthForms Grid Implementation

## Function Details
- **Function Name**: getSchoolHealthForms
- **Category**: Pediatrics
...
- school_health_formsId (ObjectId) - Primary key
...
db.school_health_forms.createIndex({ patientId: 1, date: -1 })
db.school_health_forms.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/school_health_forms
- POST /api/medical/school_health_forms
- PUT /api/medical/school_health_forms/:id
- DELETE /api/medical/school_health_forms/:id
- GET /api/medical/school_health_forms/export
...
### Backend Tasks
- [ ] Create MongoDB schema for school_health_forms
...
## Related Functions
- Previous: [087-getChildhoodIllnessRecords]
- Next: [089-getImmunizationSchedules]
