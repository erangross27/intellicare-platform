# Task 036: getOperativeReports Grid Implementation

## Function Details
- **Function Name**: getOperativeReports
...
- operative_reportsId (ObjectId) - Primary key
...
db.operative_reports.createIndex({ patientId: 1, date: -1 })
db.operative_reports.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/operative_reports
- POST /api/medical/operative_reports
- PUT /api/medical/operative_reports/:id
- DELETE /api/medical/operative_reports/:id
- GET /api/medical/operative_reports/export
...
### Backend Tasks
- [ ] Create MongoDB schema for operative_reports
...
## Related Functions
- Previous: [035-getMonitoringReports]
- Next: [037-getAnesthesiaRecords]
