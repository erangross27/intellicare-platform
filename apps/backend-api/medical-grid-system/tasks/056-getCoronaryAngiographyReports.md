# Task 056: getCoronaryAngiographyReports Grid Implementation

## Function Details
- **Function Name**: getCoronaryAngiographyReports
- **Category**: Cardiology
- **Collection**: coronary_angiography_reports
- **Priority**: HIGH
...
- coronary_angiography_reportsId (ObjectId) - Primary key
...
db.coronary_angiography_reports.createIndex({ patientId: 1, date: -1 })
db.coronary_angiography_reports.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/coronary_angiography_reports
- POST /api/medical/coronary_angiography_reports
- PUT /api/medical/coronary_angiography_reports/:id
- DELETE /api/medical/coronary_angiography_reports/:id
- GET /api/medical/coronary_angiography_reports/export
...
```javascript
{
  ...
  metadata: {
    gridType: "coronary_angiography_reports",
...
### Backend Tasks
- [ ] Create MongoDB schema for coronary_angiography_reports
...
## Related Functions
- Previous: [055-getCardiacMriReports]
- Next: [057-getElectrophysiologyReports]
...
---
Generated: 2025-09-26T19:29:22.003Z
