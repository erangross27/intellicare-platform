...
const secureConfigServiceInstance = new SecureConfigService();

// Register with service proxy
if (typeof module !== 'undefined' && module.exports) {
    const proxy = getServiceProxy();
    proxy.registerService('secureConfigService', () => secureConfigServiceInstance);
}

module.exports = secureConfigServiceInstance;
