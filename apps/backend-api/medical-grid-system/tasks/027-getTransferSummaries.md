# Task 027: getTransferSummaries Grid Implementation

## Function Details
- **Function Name**: getTransferSummaries
...
- transfer_summariesId (ObjectId) - Primary key
...
### Real-Time Updates
- WebSocket event: `transfer_summaries:update`
...
db.transfer_summaries.createIndex({ patientId: 1, date: -1 })
db.transfer_summaries.createIndex({ status: 1, practiceId: 1 })

db.transfer_summaries.createIndex({ lastModifiedAt: -1 })
```
...
### API Endpoints
- GET /api/medical/transfer_summaries
- POST /api/medical/transfer_summaries
- PUT /api/medical/transfer_summaries/:id
- DELETE /api/medical/transfer_summaries/:id
- GET /api/medical/transfer_summaries/export
...
### Backend Tasks
- [ ] Create MongoDB schema for transfer_summaries
...
## Related Functions
- Previous: [026-getIcuFlowSheets]
- Next: [028-getCodeBlueSummaries]
