# Task 084: getApgarScores Grid Implementation

## Function Details
- **Function Name**: getApgarScores
- **Category**: Pediatrics
...
- apgar_scoresId (ObjectId) - Primary key
...
db.apgar_scores.createIndex({ patientId: 1, date: -1 })
db.apgar_scores.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/apgar_scores
- POST /api/medical/apgar_scores
- PUT /api/medical/apgar_scores/:id
- DELETE /api/medical/apgar_scores/:id
- GET /api/medical/apgar_scores/export
...
### Backend Tasks
- [ ] Create MongoDB schema for apgar_scores
...
## Related Functions
- Previous: [083-getNewbornScreeningResults]
- Next: [085-getNicuProgressNotes]
