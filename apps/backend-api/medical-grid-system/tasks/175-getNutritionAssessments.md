# Task 175: getNutritionAssessments Grid Implementation

## Function Details
- **Function Name**: getNutritionAssessments
...
- nutrition_assessmentsId (ObjectId) - Primary key
...
db.nutrition_assessments.createIndex({ patientId: 1, date: -1 })
db.nutrition_assessments.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/nutrition_assessments
- POST /api/medical/nutrition_assessments
- PUT /api/medical/nutrition_assessments/:id
- DELETE /api/medical/nutrition_assessments/:id
- GET /api/medical/nutrition_assessments/export
...
```javascript
{
  ...
  metadata: {
    gridType: "nutrition_assessments",
...
### Backend Tasks
- [ ] Create MongoDB schema for nutrition_assessments
...
## Related Functions
- Previous: [174-getMusicTherapyNotes]
- Next: [176-getSocialWorkNotes]
