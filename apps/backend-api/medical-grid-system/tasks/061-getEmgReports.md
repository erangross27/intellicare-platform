# Task 061: getEmgReports Grid Implementation

## Function Details
- **Function Name**: getEmgReports
- **Category**: Neurology
...
- emg_reportsId (ObjectId) - Primary key
...
db.emg_reports.createIndex({ patientId: 1, date: -1 })
db.emg_reports.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/emg_reports
- POST /api/medical/emg_reports
- PUT /api/medical/emg_reports/:id
- DELETE /api/medical/emg_reports/:id
- GET /api/medical/emg_reports/export
...
### Backend Tasks
- [ ] Create MongoDB schema for emg_reports
...
## Related Functions
- Previous: [060-getEegReports]
- Next: [062-getNeuropsychologicalAssessments]
