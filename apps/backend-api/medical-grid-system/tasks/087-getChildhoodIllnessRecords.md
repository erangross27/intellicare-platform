# Task 087: getChildhoodIllnessRecords Grid Implementation

## Function Details
- **Function Name**: getChildhoodIllnessRecords
- **Category**: Pediatrics
- **Collection**: childhood_illness_records
- **Priority**: MEDIUM
...
- childhood_illness_recordsId (ObjectId) - Primary key
...
db.childhood_illness_records.createIndex({ patientId: 1, date: -1 })
db.childhood_illness_records.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/childhood_illness_records
- POST /api/medical/childhood_illness_records
- PUT /api/medical/childhood_illness_records/:id
- DELETE /api/medical/childhood_illness_records/:id
- GET /api/medical/childhood_illness_records/export
...
```javascript
{
  ...
  metadata: {
    gridType: "childhood_illness_records",
...
### Backend Tasks
- [ ] Create MongoDB schema for childhood_illness_records
...
## Related Functions
- Previous: [086-getPediatricConsultations]
- Next: [088-getSchoolHealthForms]
