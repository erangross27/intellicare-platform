# Task 048: getCardiologyFollowupReports Grid Implementation

## Function Details
- **Function Name**: getCardiologyFollowupReports
- **Category**: Cardiology
...
- cardiology_followup_reportsId (ObjectId) - Primary key
...
db.cardiology_followup_reports.createIndex({ patientId: 1, date: -1 })
db.cardiology_followup_reports.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/cardiology_followup_reports
- POST /api/medical/cardiology_followup_reports
- PUT /api/medical/cardiology_followup_reports/:id
- DELETE /api/medical/cardiology_followup_reports/:id
- GET /api/medical/cardiology_followup_reports/export
...
```javascript
{
  ...
  metadata: {
    gridType: "cardiology_followup_reports",
...
### Backend Tasks
- [ ] Create MongoDB schema for cardiology_followup_reports
...
## Related Functions
- Previous: [047-getCardiologyAdmissionNotes]
- Next: [049-getEcgReports]
