# Task: Add Bar Chart Visualization to daytime_sleepiness_assessment
...
- **Score Fields:** epworthSleepinessScore, functionalOutcomesOfSleepScore, maintenanceOfWakefulnessScore, sleepHygieneScore, stopBangScore
