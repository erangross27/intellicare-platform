# Task 114: getEndocrinologyConsultations Grid Implementation

## Function Details
- **Function Name**: getEndocrinologyConsultations
- **Category**: Specialty
...
- endocrinology_consultationsId (ObjectId) - Primary key
...
db.endocrinology_consultations.createIndex({ patientId: 1, date: -1 })
db.endocrinology_consultations.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/endocrinology_consultations
- POST /api/medical/endocrinology_consultations
- PUT /api/medical/endocrinology_consultations/:id
- DELETE /api/medical/endocrinology_consultations/:id
- GET /api/medical/endocrinology_consultations/export
...
```javascript
{
  ...
  metadata: {
    gridType: "endocrinology_consultations",
...
### Backend Tasks
- [ ] Create MongoDB schema for endocrinology_consultations
...
## Related Functions
- Previous: [113-getDermatologyConsultations]
- Next: [115-getGastroenterologyConsultations]
