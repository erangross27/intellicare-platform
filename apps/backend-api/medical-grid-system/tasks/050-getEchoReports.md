# Task 050: getEchoReports Grid Implementation

## Function Details
- **Function Name**: getEchoReports
- **Category**: Cardiology
...
| ejectionFraction | EF % | number | 100px | ✅ | ❌ | Percentage |
| wallMotion | Wall Motion | string | 300px | ❌ | ✅ | Multi-line |
| valveFunction | Valves | string | 300px | ❌ | ✅ | Multi-line |
...
- echo_reportsId (ObjectId) - Primary key
...
db.echo_reports.createIndex({ patientId: 1, date: -1 })
db.echo_reports.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/echo_reports
- POST /api/medical/echo_reports
- PUT /api/medical/echo_reports/:id
- DELETE /api/medical/echo_reports/:id
- GET /api/medical/echo_reports/export
...
### Backend Tasks
- [ ] Create MongoDB schema for echo_reports
...
## Related Functions
- Previous: [049-getEcgReports]
- Next: [051-getStressTestReports]
