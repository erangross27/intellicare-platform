...
const COLLECTION = 'brain_tumor_molecular_markers';
const COMMA_SPLIT_FIELDS = ['molecularClassification'];
const OBJECT_FIELDS = new Set(['idhStatus', 'mgmtStatus', 'codeletionStatus', 'tertPromoterStatus', 'atrxStatus', 'tp53Status', 'ki67ProliferationIndex', 'egfrStatus', 'cdkn2aStatus', 'brafStatus', 'h3Status', 'ngsPanel', 'treatmentRecommendations', 'clinicalTrialEligibility', 'specimen']);
const NARRATIVE_FIELDS = new Set(['molecularClassification']);
const DATE_FIELDS = new Set(['date']);
const KEY_OVERRIDES = { idhStatus: 'IDH Status', mgmtStatus: 'MGMT Status', tertPromoterStatus: 'TERT Promoter Status', atrxStatus: 'ATRX Status', tp53Status: 'TP53 Status', egfrStatus: 'EGFR Status', cdkn2aStatus: 'CDKN2A Status', brafStatus: 'BRAF Status', h3Status: 'H3 Status', ngsPanel: 'NGS Panel', ki67ProliferationIndex: 'Ki-67 Proliferation Index' };
const LABELS = {
  date: 'Date', tumorType: 'Tumor Type', whoGrade: 'WHO Grade', molecularClassification: 'Molecular Classification',
  idhStatus: 'IDH Status', mgmtStatus: 'MGMT Status', codeletionStatus: 'Codeletion Status',
  tertPromoterStatus: 'TERT Promoter Status', atrxStatus: 'ATRX Status', tp53Status: 'TP53 Status',
  ki67ProliferationIndex: 'Ki-67 Proliferation Index', egfrStatus: 'EGFR Status', cdkn2aStatus: 'CDKN2A Status',
  brafStatus: 'BRAF Status', h3Status: 'H3 Status', ngsPanel: 'NGS Panel',
  treatmentRecommendations: 'Treatment Recommendations', clinicalTrialEligibility: 'Clinical Trial Eligibility',
  specimen: 'Specimen',
};
const SECTIONS = [
  { title: 'Date', fields: ['date'] },
  { title: 'Tumor Overview', fields: ['tumorType', 'whoGrade', 'molecularClassification'] },
  { title: 'IDH Status', fields: ['idhStatus'] },
  { title: 'MGMT Status', fields: ['mgmtStatus'] },
  { title: 'Codeletion Status', fields: ['codeletionStatus'] },
  { title: 'TERT Promoter Status', fields: ['tertPromoterStatus'] },
  { title: 'ATRX Status', fields: ['atrxStatus'] },
  { title: 'TP53 Status', fields: ['tp53Status'] },
  { title: 'Ki-67 Proliferation Index', fields: ['ki67ProliferationIndex'] },
  { title: 'EGFR Status', fields: ['egfrStatus'] },
  { title: 'Other Markers', fields: ['cdkn2aStatus', 'brafStatus', 'h3Status', 'ngsPanel'] },
  { title: 'Treatment Recommendations', fields: ['treatmentRecommendations'] },
  { title: 'Clinical Trial Eligibility', fields: ['clinicalTrialEligibility'] },
  { title: 'Specimen', fields: ['specimen'] },
];
