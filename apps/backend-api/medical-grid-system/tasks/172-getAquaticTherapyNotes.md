# Task 172: getAquaticTherapyNotes Grid Implementation

## Function Details
- **Function Name**: getAquaticTherapyNotes
- **Category**: Therapy
- **Collection**: aquatic_therapy_notes
- **Priority**: LOW
...
- aquatic_therapy_notesId (ObjectId) - Primary key
...
db.aquatic_therapy_notes.createIndex({ patientId: 1, date: -1 })
db.aquatic_therapy_notes.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/aquatic_therapy_notes
- POST /api/medical/aquatic_therapy_notes
- PUT /api/medical/aquatic_therapy_notes/:id
- DELETE /api/medical/aquatic_therapy_notes/:id
- GET /api/medical/aquatic_therapy_notes/export
...
```javascript
{
  ...
  metadata: {
    gridType: "aquatic_therapy_notes",
...
### Backend Tasks
- [ ] Create MongoDB schema for aquatic_therapy_notes
...
## Related Functions
- Previous: [171-getCognitiveRehabilitationNotes]
- Next: [173-getRecreationalTherapyNotes]
