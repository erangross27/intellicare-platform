# Task 040: getSurgicalConsentForms Grid Implementation

## Function Details
- **Function Name**: getSurgicalConsentForms
...
- surgical_consent_formsId (ObjectId) - Primary key
...
### Real-Time Updates
- WebSocket event: `surgical_consent_forms:update`
...
db.surgical_consent_forms.createIndex({ patientId: 1, date: -1 })
db.surgical_consent_forms.createIndex({ status: 1, practiceId: 1 })

db.surgical_consent_forms.createIndex({ lastModifiedAt: -1 })
```
...
### API Endpoints
- GET /api/medical/surgical_consent_forms
- POST /api/medical/surgical_consent_forms
- PUT /api/medical/surgical_consent_forms/:id
- DELETE /api/medical/surgical_consent_forms/:id
- GET /api/medical/surgical_consent_forms/export
...
```javascript
{
  ...
  metadata: {
    gridType: "surgical_consent_forms",
...
### Backend Tasks
- [ ] Create MongoDB schema for surgical_consent_forms
...
## Related Functions
- Previous: [039-getPostOperativeReports]
- Next: [041-getOrthopedicOperativeReports]
