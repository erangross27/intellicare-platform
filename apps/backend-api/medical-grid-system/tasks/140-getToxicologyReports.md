# Task 140: getToxicologyReports Grid Implementation

## Function Details
- **Function Name**: getToxicologyReports
- **Category**: Diagnostic
...
- toxicology_reportsId (ObjectId) - Primary key
...
db.toxicology_reports.createIndex({ patientId: 1, date: -1 })
db.toxicology_reports.createIndex({ status: 1, practiceId: 1 })
db.toxicology_reports.createIndex({ "result.isAbnormal": 1 })
...
### API Endpoints
- GET /api/medical/toxicology_reports
- POST /api/medical/toxicology_reports
- PUT /api/medical/toxicology_reports/:id
- DELETE /api/medical/toxicology_reports/:id
- GET /api/medical/toxicology_reports/export
...
### Backend Tasks
- [ ] Create MongoDB schema for toxicology_reports
...
## Related Functions
- Previous: [139-getBoneMarrowReports]
- Next: [141-getDrugScreeningResults]
