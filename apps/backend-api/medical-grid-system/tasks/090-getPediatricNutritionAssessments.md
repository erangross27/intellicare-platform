# Task 090: getPediatricNutritionAssessments Grid Implementation

## Function Details
- **Function Name**: getPediatricNutritionAssessments
- **Category**: Pediatrics
- **Collection**: pediatric_nutrition_assessments
- **Priority**: MEDIUM
...
- pediatric_nutrition_assessmentsId (ObjectId) - Primary key
...
db.pediatric_nutrition_assessments.createIndex({ patientId: 1, date: -1 })
db.pediatric_nutrition_assessments.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/pediatric_nutrition_assessments
- POST /api/medical/pediatric_nutrition_assessments
- PUT /api/medical/pediatric_nutrition_assessments/:id
- DELETE /api/medical/pediatric_nutrition_assessments/:id
- GET /api/medical/pediatric_nutrition_assessments/export
...
```javascript
{
  ...
  metadata: {
    gridType: "pediatric_nutrition_assessments",
...
### Backend Tasks
- [ ] Create MongoDB schema for pediatric_nutrition_assessments
...
## Related Functions
- Previous: [089-getImmunizationSchedules]
- Next: [091-getPrenatalVisits]
