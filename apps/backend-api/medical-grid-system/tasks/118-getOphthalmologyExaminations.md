# Task 118: getOphthalmologyExaminations Grid Implementation

## Function Details
- **Function Name**: getOphthalmologyExaminations
- **Category**: Specialty
...
- ophthalmology_examinationsId (ObjectId) - Primary key
...
db.ophthalmology_examinations.createIndex({ patientId: 1, date: -1 })
db.ophthalmology_examinations.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/ophthalmology_examinations
- POST /api/medical/ophthalmology_examinations
- PUT /api/medical/ophthalmology_examinations/:id
- DELETE /api/medical/ophthalmology_examinations/:id
- GET /api/medical/ophthalmology_examinations/export
...
```javascript
{
  ...
  metadata: {
    gridType: "ophthalmology_examinations",
...
### Backend Tasks
- [ ] Create MongoDB schema for ophthalmology_examinations
...
## Related Functions
- Previous: [117-getNephrologyConsultations]
- Next: [119-getOrthopedicConsultations]
