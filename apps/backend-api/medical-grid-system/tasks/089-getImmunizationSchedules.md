# Task 089: getImmunizationSchedules Grid Implementation

## Function Details
- **Function Name**: getImmunizationSchedules
- **Category**: Pediatrics
- **Collection**: immunization_schedules
- **Priority**: MEDIUM
...
- immunization_schedulesId (ObjectId) - Primary key
...
db.immunization_schedules.createIndex({ patientId: 1, date: -1 })
db.immunization_schedules.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/immunization_schedules
- POST /api/medical/immunization_schedules
- PUT /api/medical/immunization_schedules/:id
- DELETE /api/medical/immunization_schedules/:id
- GET /api/medical/immunization_schedules/export
...
```javascript
{
  ...
  metadata: {
    gridType: "immunization_schedules",
...
### Backend Tasks
- [ ] Create MongoDB schema for immunization_schedules
...
## Related Functions
- Previous: [088-getSchoolHealthForms]
- Next: [090-getPediatricNutritionAssessments]
