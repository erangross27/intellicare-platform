# Task 011: getMedicalProcedures Grid Implementation

## Function Details
- **Function Name**: getMedicalProcedures
...
- medical_proceduresId (ObjectId) - Primary key
...
db.medical_procedures.createIndex({ patientId: 1, date: -1 })
db.medical_procedures.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/medical_procedures
- POST /api/medical/medical_procedures
- PUT /api/medical/medical_procedures/:id
- DELETE /api/medical/medical_procedures/:id
- GET /api/medical/medical_procedures/export
...
### Backend Tasks
- [ ] Create MongoDB schema for medical_procedures
...
## Related Functions
- Previous: [010-getConsultationNotes]
- Next: [012-getReferrals]
