...
class MFAService {
  ...
  async initialize() {
    ...
    this.serviceToken = await serviceAccountManager.authenticate('mfa');
    return this;
  }
  ...
  // Enable MFA for user
  async enableMFA(user, verificationToken, Models) {
  ...
  async disableMFA(user, verificationToken) {
  ...
  async regenerateBackupCodes(user, verificationToken) {
