# Task 072: getMentalHealthAssessments Grid Implementation

## Function Details
- **Function Name**: getMentalHealthAssessments
- **Category**: Psychiatry
...
- mental_health_assessmentsId (ObjectId) - Primary key
...
db.mental_health_assessments.createIndex({ patientId: 1, date: -1 })
db.mental_health_assessments.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/mental_health_assessments
- POST /api/medical/mental_health_assessments
- PUT /api/medical/mental_health_assessments/:id
- DELETE /api/medical/mental_health_assessments/:id
- GET /api/medical/mental_health_assessments/export
...
```javascript
{
  ...
  metadata: {
    gridType: "mental_health_assessments",
...
### Backend Tasks
- [ ] Create MongoDB schema for mental_health_assessments
...
## Related Functions
- Previous: [071-getPsychiatricDischargeSummaries]
- Next: [073-getTherapySessionNotes]
