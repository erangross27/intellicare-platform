# Task 021: getEmergencyReports Grid Implementation

## Function Details
- **Function Name**: getEmergencyReports
...
- emergency_reportsId (ObjectId) - Primary key
...
### Real-Time Updates
- WebSocket event: `emergency_reports:update`
...
db.emergency_reports.createIndex({ patientId: 1, date: -1 })
db.emergency_reports.createIndex({ status: 1, practiceId: 1 })

db.emergency_reports.createIndex({ lastModifiedAt: -1 })
```
...
### API Endpoints
- GET /api/medical/emergency_reports
- POST /api/medical/emergency_reports
- PUT /api/medical/emergency_reports/:id
- DELETE /api/medical/emergency_reports/:id
- GET /api/medical/emergency_reports/export
...
### Backend Tasks
- [ ] Create MongoDB schema for emergency_reports
...
## Related Functions
- Previous: [020-getMedicalPowerOfAttorney]
- Next: [022-getEmergencyDischargeSummaries]
...
---
Generated: 2025-09-26T19:29:21.599Z
