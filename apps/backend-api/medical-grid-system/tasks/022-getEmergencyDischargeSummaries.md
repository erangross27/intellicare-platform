# Task 022: getEmergencyDischargeSummaries Grid Implementation

## Function Details
- **Function Name**: getEmergencyDischargeSummaries
...
- emergency_discharge_summariesId (ObjectId) - Primary key
...
### Real-Time Updates
- WebSocket event: `emergency_discharge_summaries:update`
...
db.emergency_discharge_summaries.createIndex({ patientId: 1, date: -1 })
db.emergency_discharge_summaries.createIndex({ status: 1, practiceId: 1 })

db.emergency_discharge_summaries.createIndex({ lastModifiedAt: -1 })
```
...
### API Endpoints
- GET /api/medical/emergency_discharge_summaries
- POST /api/medical/emergency_discharge_summaries
- PUT /api/medical/emergency_discharge_summaries/:id
- DELETE /api/medical/emergency_discharge_summaries/:id
- GET /api/medical/emergency_discharge_summaries/export
...
```javascript
{
  ...
  metadata: {
    gridType: "emergency_discharge_summaries",
...
### Backend Tasks
- [ ] Create MongoDB schema for emergency_discharge_summaries
...
## Related Functions
- Previous: [021-getEmergencyReports]
- Next: [023-getHospitalAdmissionNotes]
