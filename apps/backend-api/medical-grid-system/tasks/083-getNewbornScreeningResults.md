# Task 083: getNewbornScreeningResults Grid Implementation

## Function Details
- **Function Name**: getNewbornScreeningResults
- **Category**: Pediatrics
...
| age | Age | string | 100px | ✅ | ✅ | Text |
| weight | Weight | string | 100px | ✅ | ✅ | Text |
| height | Height | string | 100px | ✅ | ✅ | Text |
...
- newborn_screening_resultsId (ObjectId) - Primary key
...
### Real-Time Updates
- WebSocket event: `newborn_screening_results:update`
...
db.newborn_screening_results.createIndex({ patientId: 1, date: -1 })
db.newborn_screening_results.createIndex({ status: 1, practiceId: 1 })

db.newborn_screening_results.createIndex({ lastModifiedAt: -1 })
```
...
### API Endpoints
- GET /api/medical/newborn_screening_results
- POST /api/medical/newborn_screening_results
- PUT /api/medical/newborn_screening_results/:id
- DELETE /api/medical/newborn_screening_results/:id
- GET /api/medical/newborn_screening_results/export
...
```javascript
{
  ...
  metadata: {
    gridType: "newborn_screening_results",
...
### Backend Tasks
- [ ] Create MongoDB schema for newborn_screening_results
...
## Related Functions
- Previous: [082-getWellChildExaminations]
- Next: [084-getApgarScores]
...
---
Generated: 2025-09-26T19:29:22.205Z
