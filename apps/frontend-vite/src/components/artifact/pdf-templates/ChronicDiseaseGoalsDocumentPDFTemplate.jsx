/**
 * ChronicDiseaseGoalsDocumentPDFTemplate.jsx
 * June 2026 — Helvetica — LETTER size — chronic disease goals
...
/* renderDateField: date-formatted value */
...
const SECTION_CONFIGS = [
  {
    ...
    fields: [
      { key: 'goalCategory', label: 'Goal Category', isSentence: true },
      { key: 'targetCondition', label: 'Target Condition', isSentence: true },
      { key: 'goalDescription', label: 'Goal Description', isSentence: true },
      { key: 'priority', label: 'Priority', isSentence: true },
      { key: 'expressedBy', label: 'Expressed By', isSentence: true },
      { key: 'outcomeCode', label: 'Outcome Code', isSentence: true },
    ],
  },
  {
    title: 'Targets & Progress',
    fields: [
      { key: 'targetValue', label: 'Target Value', isSentence: true },
      { key: 'targetMetric', label: 'Target Metric', isSentence: true },
      { key: 'baselineValue', label: 'Baseline Value', isSentence: true },
      { key: 'currentValue', label: 'Current Value', isSentence: true },
      { key: 'achievementPercentage', label: 'Achievement %', isNumber: true },
      { key: 'achievementStatus', label: 'Achievement Status', isSentence: true },
      { key: 'lifecycleStatus', label: 'Lifecycle Status', isSentence: true },
    ],
  },
  {
    title: 'Timeline',
    fields: [
      ...
      { key: 'reviewDate', label: 'Review Date', isDate: true },
      { key: 'nextReviewDate', label: 'Next Review Date', isDate: true },
      { key: 'measurementFrequency', label: 'Measurement Frequency', isSentence: true },
    ],
  },
  {
    title: 'Interventions & Barriers',
    fields: [
      { key: 'interventions', label: 'Interventions', isArray: true },
      { key: 'barriers', label: 'Barriers', isArray: true },
      { key: 'addresses', label: 'Addresses', isArray: true },
    ],
  },
  {
    title: 'Care Team & Engagement',
    fields: [
      { key: 'careTeamMembers', label: 'Care Team Members', isArray: true },
      { key: 'patientEngagement', label: 'Patient Engagement', isSentence: true },
      { key: 'relatedGoals', label: 'Related Goals', isArray: true },
      { key: 'modificationReason', label: 'Modification Reason', isSentence: true },
    ],
  },
];
...
/* ======= COMPONENT ======= */
const ChronicDiseaseGoalsDocumentPDFTemplate = ({ document: data }) => {
      ...
      <Document>
        <Page size="LETTER" style={styles.page}>
          <View style={styles.documentHeader}>
            <Text style={styles.documentTitle}>Chronic Disease Goals</Text>
          </View>
...
export default ChronicDiseaseGoalsDocumentPDFTemplate;
