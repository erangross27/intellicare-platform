# Task 045: getDnrOrders Grid Implementation

## Function Details
- **Function Name**: getDnrOrders
...
- dnr_ordersId (ObjectId) - Primary key
...
### Real-Time Updates
- WebSocket event: `dnr_orders:update`
...
db.dnr_orders.createIndex({ patientId: 1, date: -1 })
db.dnr_orders.createIndex({ status: 1, practiceId: 1 })

db.dnr_orders.createIndex({ lastModifiedAt: -1 })
```
...
### API Endpoints
- GET /api/medical/dnr_orders
- POST /api/medical/dnr_orders
- PUT /api/medical/dnr_orders/:id
- DELETE /api/medical/dnr_orders/:id
- GET /api/medical/dnr_orders/export
...
### Backend Tasks
- [ ] Create MongoDB schema for dnr_orders
...
## Related Functions
- Previous: [044-getTransplantEvaluations]
- Next: [046-getCardiologyConsultations]
