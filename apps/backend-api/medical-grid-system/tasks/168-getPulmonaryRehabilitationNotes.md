# Task 168: getPulmonaryRehabilitationNotes Grid Implementation

## Function Details
- **Function Name**: getPulmonaryRehabilitationNotes
- **Category**: Therapy
...
- pulmonary_rehabilitation_notesId (ObjectId) - Primary key
...
db.pulmonary_rehabilitation_notes.createIndex({ patientId: 1, date: -1 })
db.pulmonary_rehabilitation_notes.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/pulmonary_rehabilitation_notes
- POST /api/medical/pulmonary_rehabilitation_notes
- PUT /api/medical/pulmonary_rehabilitation_notes/:id
- DELETE /api/medical/pulmonary_rehabilitation_notes/:id
- GET /api/medical/pulmonary_rehabilitation_notes/export
...
```javascript
{
  ...
  metadata: {
    gridType: "pulmonary_rehabilitation_notes",
...
### Backend Tasks
- [ ] Create MongoDB schema for pulmonary_rehabilitation_notes
...
## Related Functions
- Previous: [167-getRehabilitationProgressNotes]
- Next: [169-getCardiacRehabilitationNotes]
