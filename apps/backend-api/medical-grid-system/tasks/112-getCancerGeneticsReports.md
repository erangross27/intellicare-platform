# Task 112: getCancerGeneticsReports Grid Implementation

## Function Details
- **Function Name**: getCancerGeneticsReports
- **Category**: Oncology
- **Collection**: cancer_genetics_reports
- **Priority**: HIGH
...
- cancer_genetics_reportsId (ObjectId) - Primary key
...
db.cancer_genetics_reports.createIndex({ patientId: 1, date: -1 })
db.cancer_genetics_reports.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/cancer_genetics_reports
- POST /api/medical/cancer_genetics_reports
- PUT /api/medical/cancer_genetics_reports/:id
- DELETE /api/medical/cancer_genetics_reports/:id
- GET /api/medical/cancer_genetics_reports/export
...
```javascript
{
  ...
  metadata: {
    gridType: "cancer_genetics_reports",
...
### Backend Tasks
- [ ] Create MongoDB schema for cancer_genetics_reports
...
## Related Functions
- Previous: [111-getPalliativeCareNotes]
- Next: [113-getDermatologyConsultations]
