# Task 071: getPsychiatricDischargeSummaries Grid Implementation

## Function Details
- **Function Name**: getPsychiatricDischargeSummaries
- **Category**: Psychiatry
...
- psychiatric_discharge_summariesId (ObjectId) - Primary key
...
db.psychiatric_discharge_summaries.createIndex({ patientId: 1, date: -1 })
db.psychiatric_discharge_summaries.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/psychiatric_discharge_summaries
- POST /api/medical/psychiatric_discharge_summaries
- PUT /api/medical/psychiatric_discharge_summaries/:id
- DELETE /api/medical/psychiatric_discharge_summaries/:id
- GET /api/medical/psychiatric_discharge_summaries/export
...
```javascript
{
  ...
  metadata: {
    gridType: "psychiatric_discharge_summaries",
...
### Backend Tasks
- [ ] Create MongoDB schema for psychiatric_discharge_summaries
...
## Related Functions
- Previous: [070-getPsychiatricProgressNotes]
- Next: [072-getMentalHealthAssessments]
...
---
Generated: 2025-09-26T19:29:22.104Z
