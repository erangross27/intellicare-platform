...
const ALLOWED_FIELDS = ['type', 'bvasScore', 'vdiScore', 'organSystems', 'biopsyResults', 'angiographicFindings', 'findings', 'assessment', 'plan', 'recommendations', 'results', 'notes', 'provider', 'facility', 'status'];
