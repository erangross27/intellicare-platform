# Task 137: getGeneticTestingReports Grid Implementation

## Function Details
- **Function Name**: getGeneticTestingReports
- **Category**: Diagnostic
...
- genetic_testing_reportsId (ObjectId) - Primary key
...
db.genetic_testing_reports.createIndex({ patientId: 1, date: -1 })
db.genetic_testing_reports.createIndex({ status: 1, practiceId: 1 })
db.genetic_testing_reports.createIndex({ "result.isAbnormal": 1 })
...
### API Endpoints
- GET /api/medical/genetic_testing_reports
- POST /api/medical/genetic_testing_reports
- PUT /api/medical/genetic_testing_reports/:id
- DELETE /api/medical/genetic_testing_reports/:id
- GET /api/medical/genetic_testing_reports/export
...
```javascript
{
  ...
  metadata: {
    gridType: "genetic_testing_reports",
...
### Backend Tasks
- [ ] Create MongoDB schema for genetic_testing_reports
...
## Related Functions
- Previous: [136-getAutoimmunePanels]
- Next: [138-getFlowCytometryReports]
