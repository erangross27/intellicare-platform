# Task 047: getCardiologyAdmissionNotes Grid Implementation

## Function Details
- **Function Name**: getCardiologyAdmissionNotes
- **Category**: Cardiology
...
- cardiology_admission_notesId (ObjectId) - Primary key
...
db.cardiology_admission_notes.createIndex({ patientId: 1, date: -1 })
db.cardiology_admission_notes.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/cardiology_admission_notes
- POST /api/medical/cardiology_admission_notes
- PUT /api/medical/cardiology_admission_notes/:id
- DELETE /api/medical/cardiology_admission_notes/:id
- GET /api/medical/cardiology_admission_notes/export
...
```javascript
{
  ...
  metadata: {
    gridType: "cardiology_admission_notes",
...
### Backend Tasks
- [ ] Create MongoDB schema for cardiology_admission_notes
...
## Related Functions
- Previous: [046-getCardiologyConsultations]
- Next: [048-getCardiologyFollowupReports]
