# Task 120: getEntConsultations Grid Implementation

## Function Details
- **Function Name**: getEntConsultations
- **Category**: Specialty
...
- ent_consultationsId (ObjectId) - Primary key
...
db.ent_consultations.createIndex({ patientId: 1, date: -1 })
db.ent_consultations.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/ent_consultations
- POST /api/medical/ent_consultations
- PUT /api/medical/ent_consultations/:id
- DELETE /api/medical/ent_consultations/:id
- GET /api/medical/ent_consultations/export
...
### Backend Tasks
- [ ] Create MongoDB schema for ent_consultations
...
## Related Functions
- Previous: [119-getOrthopedicConsultations]
- Next: [121-getPulmonologyConsultations]
