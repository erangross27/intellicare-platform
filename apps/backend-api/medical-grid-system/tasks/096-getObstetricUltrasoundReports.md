# Task 096: getObstetricUltrasoundReports Grid Implementation

## Function Details
- **Function Name**: getObstetricUltrasoundReports
...
- obstetric_ultrasound_reportsId (ObjectId) - Primary key
...
db.obstetric_ultrasound_reports.createIndex({ patientId: 1, date: -1 })
db.obstetric_ultrasound_reports.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/obstetric_ultrasound_reports
- POST /api/medical/obstetric_ultrasound_reports
- PUT /api/medical/obstetric_ultrasound_reports/:id
- DELETE /api/medical/obstetric_ultrasound_reports/:id
- GET /api/medical/obstetric_ultrasound_reports/export
...
```javascript
{
  ...
  metadata: {
    gridType: "obstetric_ultrasound_reports",
...
### Backend Tasks
- [ ] Create MongoDB schema for obstetric_ultrasound_reports
...
## Related Functions
- Previous: [095-getGynecologyConsultations]
- Next: [097-getAmniocentesisReports]
...
---
Generated: 2025-09-26T19:29:22.406Z
