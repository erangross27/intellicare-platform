# Task 038: getPreOperativeAssessments Grid Implementation

## Function Details
- **Function Name**: getPreOperativeAssessments
...
- pre_operative_assessmentsId (ObjectId) - Primary key
...
db.pre_operative_assessments.createIndex({ patientId: 1, date: -1 })
db.pre_operative_assessments.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/pre_operative_assessments
- POST /api/medical/pre_operative_assessments
- PUT /api/medical/pre_operative_assessments/:id
- DELETE /api/medical/pre_operative_assessments/:id
- GET /api/medical/pre_operative_assessments/export
...
```javascript
{
  ...
  metadata: {
    gridType: "pre_operative_assessments",
...
### Backend Tasks
- [ ] Create MongoDB schema for pre_operative_assessments
...
## Related Functions
- Previous: [037-getAnesthesiaRecords]
- Next: [039-getPostOperativeReports]
