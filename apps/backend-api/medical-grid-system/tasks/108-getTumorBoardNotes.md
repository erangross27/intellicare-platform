# Task 108: getTumorBoardNotes Grid Implementation

## Function Details
- **Function Name**: getTumorBoardNotes
- **Category**: Oncology
...
- tumor_board_notesId (ObjectId) - Primary key
...
db.tumor_board_notes.createIndex({ patientId: 1, date: -1 })
db.tumor_board_notes.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/tumor_board_notes
- POST /api/medical/tumor_board_notes
- PUT /api/medical/tumor_board_notes/:id
- DELETE /api/medical/tumor_board_notes/:id
- GET /api/medical/tumor_board_notes/export
...
### Backend Tasks
- [ ] Create MongoDB schema for tumor_board_notes
...
## Related Functions
- Previous: [107-getRadiationTherapyRecords]
- Next: [109-getTumorMarkerPanels]
