# Task 023: getHospitalAdmissionNotes Grid Implementation

## Function Details
- **Function Name**: getHospitalAdmissionNotes
...
- hospital_admission_notesId (ObjectId) - Primary key
...
### Real-Time Updates
- WebSocket event: `hospital_admission_notes:update`
...
db.hospital_admission_notes.createIndex({ patientId: 1, date: -1 })
db.hospital_admission_notes.createIndex({ status: 1, practiceId: 1 })

db.hospital_admission_notes.createIndex({ lastModifiedAt: -1 })
```
...
### API Endpoints
- GET /api/medical/hospital_admission_notes
- POST /api/medical/hospital_admission_notes
- PUT /api/medical/hospital_admission_notes/:id
- DELETE /api/medical/hospital_admission_notes/:id
- GET /api/medical/hospital_admission_notes/export
...
```javascript
{
  ...
  metadata: {
    gridType: "hospital_admission_notes",
...
### Backend Tasks
- [ ] Create MongoDB schema for hospital_admission_notes
...
## Related Functions
- Previous: [022-getEmergencyDischargeSummaries]
- Next: [024-getHospitalDischargeSummaries]
