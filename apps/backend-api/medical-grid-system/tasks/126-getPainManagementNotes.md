# Task 126: getPainManagementNotes Grid Implementation

## Function Details
- **Function Name**: getPainManagementNotes
- **Category**: Specialty
...
- pain_management_notesId (ObjectId) - Primary key
...
db.pain_management_notes.createIndex({ patientId: 1, date: -1 })
db.pain_management_notes.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/pain_management_notes
- POST /api/medical/pain_management_notes
- PUT /api/medical/pain_management_notes/:id
- DELETE /api/medical/pain_management_notes/:id
- GET /api/medical/pain_management_notes/export
...
```javascript
{
  ...
  metadata: {
    gridType: "pain_management_notes",
...
### Backend Tasks
- [ ] Create MongoDB schema for pain_management_notes
...
## Related Functions
- Previous: [125-getGeriatricAssessments]
- Next: [127-getSportsMedicineConsults]
