# Task 014: getMedicalCertificates Grid Implementation

## Function Details
- **Function Name**: getMedicalCertificates
...
- medical_certificatesId (ObjectId) - Primary key
...
db.medical_certificates.createIndex({ patientId: 1, date: -1 })
db.medical_certificates.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/medical_certificates
- POST /api/medical/medical_certificates
- PUT /api/medical/medical_certificates/:id
- DELETE /api/medical/medical_certificates/:id
- GET /api/medical/medical_certificates/export
...
### Backend Tasks
- [ ] Create MongoDB schema for medical_certificates
...
## Related Functions
- Previous: [013-getDiagnoses]
- Next: [015-getProgressNotes]
