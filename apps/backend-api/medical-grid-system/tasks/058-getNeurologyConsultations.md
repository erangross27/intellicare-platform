# Task 058: getNeurologyConsultations Grid Implementation

## Function Details
- **Function Name**: getNeurologyConsultations
- **Category**: Neurology
...
- neurology_consultationsId (ObjectId) - Primary key
...
db.neurology_consultations.createIndex({ patientId: 1, date: -1 })
db.neurology_consultations.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/neurology_consultations
- POST /api/medical/neurology_consultations
- PUT /api/medical/neurology_consultations/:id
- DELETE /api/medical/neurology_consultations/:id
- GET /api/medical/neurology_consultations/export
...
```javascript
{
  ...
  metadata: {
    gridType: "neurology_consultations",
...
### Backend Tasks
- [ ] Create MongoDB schema for neurology_consultations
...
## Related Functions
- Previous: [057-getElectrophysiologyReports]
- Next: [059-getNeurologyProgressNotes]
