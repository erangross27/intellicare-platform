# Task 163: getPhysicalTherapyEvaluations Grid Implementation

## Function Details
- **Function Name**: getPhysicalTherapyEvaluations
- **Category**: Therapy
...
- physical_therapy_evaluationsId (ObjectId) - Primary key
...
db.physical_therapy_evaluations.createIndex({ patientId: 1, date: -1 })
db.physical_therapy_evaluations.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/physical_therapy_evaluations
- POST /api/medical/physical_therapy_evaluations
- PUT /api/medical/physical_therapy_evaluations/:id
- DELETE /api/medical/physical_therapy_evaluations/:id
- GET /api/medical/physical_therapy_evaluations/export
...
```javascript
{
  ...
  metadata: {
    gridType: "physical_therapy_evaluations",
...
### Backend Tasks
- [ ] Create MongoDB schema for physical_therapy_evaluations
...
## Related Functions
- Previous: [162-getMyelographyReports]
- Next: [164-getPhysicalTherapyNotes]
