# Task 129: getBiopsyReports Grid Implementation

## Function Details
- **Function Name**: getBiopsyReports
- **Category**: Diagnostic
...
- biopsy_reportsId (ObjectId) - Primary key
...
db.biopsy_reports.createIndex({ patientId: 1, date: -1 })
db.biopsy_reports.createIndex({ status: 1, practiceId: 1 })
db.biopsy_reports.createIndex({ "result.isAbnormal": 1 })
...
### API Endpoints
- GET /api/medical/biopsy_reports
- POST /api/medical/biopsy_reports
- PUT /api/medical/biopsy_reports/:id
- DELETE /api/medical/biopsy_reports/:id
- GET /api/medical/biopsy_reports/export
...
### Backend Tasks
- [ ] Create MongoDB schema for biopsy_reports
...
## Related Functions
- Previous: [128-getPathologyReports]
- Next: [130-getCytologyReports]
