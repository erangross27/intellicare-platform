# Task 148: getRadiologyReports Grid Implementation

## Function Details
- **Function Name**: getRadiologyReports
- **Category**: Imaging
...
- radiology_reportsId (ObjectId) - Primary key
...
db.radiology_reports.createIndex({ patientId: 1, date: -1 })
db.radiology_reports.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/radiology_reports
- POST /api/medical/radiology_reports
- PUT /api/medical/radiology_reports/:id
- DELETE /api/medical/radiology_reports/:id
- GET /api/medical/radiology_reports/export
...
### Backend Tasks
- [ ] Create MongoDB schema for radiology_reports
...
## Related Functions
- Previous: [147-getPulmonaryFunctionTests]
- Next: [149-getMriReports]
...
---
Generated: 2025-09-26T19:29:22.912Z
