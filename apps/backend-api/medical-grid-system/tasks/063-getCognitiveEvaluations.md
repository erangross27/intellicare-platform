# Task 063: getCognitiveEvaluations Grid Implementation

## Function Details
- **Function Name**: getCognitiveEvaluations
- **Category**: Neurology
...
- cognitive_evaluationsId (ObjectId) - Primary key
...
db.cognitive_evaluations.createIndex({ patientId: 1, date: -1 })
db.cognitive_evaluations.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/cognitive_evaluations
- POST /api/medical/cognitive_evaluations
- PUT /api/medical/cognitive_evaluations/:id
- DELETE /api/medical/cognitive_evaluations/:id
- GET /api/medical/cognitive_evaluations/export
...
```javascript
{
  ...
  metadata: {
    gridType: "cognitive_evaluations",
...
### Backend Tasks
- [ ] Create MongoDB schema for cognitive_evaluations
...
## Related Functions
- Previous: [062-getNeuropsychologicalAssessments]
- Next: [064-getCognitiveRehabilitationReports]
