# Task 091: getPrenatalVisits Grid Implementation

## Function Details
- **Function Name**: getPrenatalVisits
...
- prenatal_visitsId (ObjectId) - Primary key
...
db.prenatal_visits.createIndex({ patientId: 1, date: -1 })
db.prenatal_visits.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/prenatal_visits
- POST /api/medical/prenatal_visits
- PUT /api/medical/prenatal_visits/:id
- DELETE /api/medical/prenatal_visits/:id
- GET /api/medical/prenatal_visits/export
...
### Backend Tasks
- [ ] Create MongoDB schema for prenatal_visits
...
## Related Functions
- Previous: [090-getPediatricNutritionAssessments]
- Next: [092-getPrenatalTestingReports]
