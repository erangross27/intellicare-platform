# Task 171: getCognitiveRehabilitationNotes Grid Implementation

## Function Details
- **Function Name**: getCognitiveRehabilitationNotes
- **Category**: Therapy
- **Collection**: cognitive_rehabilitation_notes
- **Priority**: MEDIUM
...
- cognitive_rehabilitation_notesId (ObjectId) - Primary key
...
db.cognitive_rehabilitation_notes.createIndex({ patientId: 1, date: -1 })
db.cognitive_rehabilitation_notes.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/cognitive_rehabilitation_notes
- POST /api/medical/cognitive_rehabilitation_notes
- PUT /api/medical/cognitive_rehabilitation_notes/:id
- DELETE /api/medical/cognitive_rehabilitation_notes/:id
- GET /api/medical/cognitive_rehabilitation_notes/export
...
```javascript
{
  ...
  metadata: {
    gridType: "cognitive_rehabilitation_notes",
...
### Backend Tasks
- [ ] Create MongoDB schema for cognitive_rehabilitation_notes
...
## Related Functions
- Previous: [170-getVocationalRehabilitationReports]
- Next: [172-getAquaticTherapyNotes]
