 ...
 * March 2026 — Helvetica — LETTER size — pump download analysis
...
const styles = StyleSheet.create({
  ...
  recordDateRow: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 4, flexWrap: 'wrap', gap: 8 },
  recordDate: { fontSize: 11, color: '#6b7280', fontFamily: 'Helvetica' },
  recordStatus: { fontSize: 11, color: '#6b7280', fontFamily: 'Helvetica' },
  recordMetric: { fontSize: 11, color: '#6b7280', fontFamily: 'Helvetica' },
...
const SECTION_CONFIGS = [
  ...
  },
  {
    title: 'Pump Metrics',
    fields: [
      { key: 'bolusesPerDay', label: 'Boluses Per Day' },
      { key: 'correctionBolusesPerDay', label: 'Correction Boluses Per Day' },
      { key: 'controlIQActivePercent', label: 'Control-IQ Active', isSentence: true },
      { key: 'autoModeExits', label: 'Auto-Mode Exits', isSentence: true },
      { key: 'missedBoluses', label: 'Missed Boluses', isSentence: true },
      { key: 'overrideBehavior', label: 'Override Behavior', isSentence: true },
    ],
  },
  {
    title: 'Findings',
          ...
          <View key={index} style={styles.recordContainer}>
            ...
            <View style={styles.recordHeader} wrap={false}>
              <View style={styles.recordDateRow}>
                ...
                {record.controlIQActivePercent && (
                  <Text style={styles.recordMetric}>Control-IQ: {record.controlIQActivePercent}</Text>
                )}
              </View>
              <Text style={styles.recordTitle}>
                Pump Download Analysis {index + 1}
              </Text>
            </View>
