# Task 170: getVocationalRehabilitationReports Grid Implementation

## Function Details
- **Function Name**: getVocationalRehabilitationReports
- **Category**: Therapy
- **Collection**: vocational_rehabilitation_reports
- **Priority**: LOW
...
- vocational_rehabilitation_reportsId (ObjectId) - Primary key
...
db.vocational_rehabilitation_reports.createIndex({ patientId: 1, date: -1 })
db.vocational_rehabilitation_reports.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/vocational_rehabilitation_reports
- POST /api/medical/vocational_rehabilitation_reports
- PUT /api/medical/vocational_rehabilitation_reports/:id
- DELETE /api/medical/vocational_rehabilitation_reports/:id
- GET /api/medical/vocational_rehabilitation_reports/export
...
```javascript
{
  ...
  metadata: {
    gridType: "vocational_rehabilitation_reports",
...
### Backend Tasks
- [ ] Create MongoDB schema for vocational_rehabilitation_reports
...
## Related Functions
- Previous: [169-getCardiacRehabilitationNotes]
- Next: [171-getCognitiveRehabilitationNotes]
...
---
Generated: 2025-09-26T19:29:23.113Z
