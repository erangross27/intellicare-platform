# Task 123: getUrologyConsultations Grid Implementation

## Function Details
- **Function Name**: getUrologyConsultations
- **Category**: Specialty
...
- urology_consultationsId (ObjectId) - Primary key
...
db.urology_consultations.createIndex({ patientId: 1, date: -1 })
db.urology_consultations.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/urology_consultations
- POST /api/medical/urology_consultations
- PUT /api/medical/urology_consultations/:id
- DELETE /api/medical/urology_consultations/:id
- GET /api/medical/urology_consultations/export
...
```javascript
{
  ...
  metadata: {
    gridType: "urology_consultations",
...
### Backend Tasks
- [ ] Create MongoDB schema for urology_consultations
...
## Related Functions
- Previous: [122-getRheumatologyConsultations]
- Next: [124-getInfectiousDiseaseConsults]
