/**
 * VascularSurgeryAssessmentDocumentPDFTemplate.jsx
 * June 2026 — Helvetica — LETTER size — vascular surgery assessment
...
/* renderArrayField (array of strings or objects) */
...
const SECTION_CONFIGS = [
  {
    title: 'Vascular History',
    fields: [
      { key: 'patientVascularHistory', label: 'Vascular History', isSentence: true },
    ],
  },
  {
    title: 'Arterial Perfusion Measurements',
    fields: [
      { key: 'ankleBrachialIndex', label: 'Ankle-Brachial Index (ABI)' },
      { key: 'toeBrachialIndex', label: 'Toe-Brachial Index (TBI)' },
      { key: 'transcutaneousOxygenPressure', label: 'Transcutaneous Oxygen Pressure (TcPO2, mmHg)' },
      { key: 'carotidStenosisPercentage', label: 'Carotid Stenosis (%)' },
      { key: 'claudicationDistance', label: 'Claudication Distance (m)', hideZero: true },
    ],
  },
  {
    title: 'Pulse Examination',
    fields: [
      { key: 'pulsePalpationFindings', label: 'Pulse Palpation Findings', isSentence: true },
    ],
  },
  {
    title: 'Duplex Ultrasound Findings',
    fields: [
      { key: 'duplexUltrasoundFindings', label: 'Duplex Ultrasound Findings', isSentence: true },
    ],
  },
  {
    title: 'Wound Healing Status',
    fields: [
      { key: 'woundHealingStatus', label: 'Wound Healing Status', isSentence: true },
    ],
  },
  {
    title: 'Aneurysm Assessment',
    fields: [
      { key: 'aneurysmDiameter', label: 'Aneurysm Diameter (cm)', hideZero: true },
  ...
  },
  {
    ...
    fields: [
      { key: 'venousRefluxDuration', label: 'Venous Reflux Duration (s)', hideZero: true },
      { key: 'ceapClassification', label: 'CEAP Classification' },
      { key: 'varicoseVeinDistribution', label: 'Varicose Vein Distribution' },
    ],
  },
  {
    title: 'Classification & Grafts',
    fields: [
      { key: 'rutherfordClassification', label: 'Rutherford Classification' },
      { key: 'graftPatencyStatus', label: 'Graft Patency Status' },
    ],
  },
  {
    title: 'Arterial Calcification',
    fields: [
      { key: 'arterialCalcificationSeverity', label: 'Arterial Calcification Severity', isSentence: true },
    ],
  },
  {
    title: 'Limb Salvage Potential',
    fields: [
      { key: 'limbSalvagePotential', label: 'Limb Salvage Potential', isSentence: true },
    ],
  },
  {
    title: 'Anticoagulation & Symptoms',
    fields: [
      { key: 'anticoagulationRegimen', label: 'Anticoagulation Regimen', isSentence: true },
      { key: 'restPainPresent', label: 'Rest Pain Present' },
    ],
  },
  {
    title: 'Segmental Pressures',
    fields: [
      { key: 'segmentalPressures', label: 'Segmental Pressures', isArray: true },
    ],
  },
  {
    title: 'Prior Endovascular Interventions',
    fields: [
      { key: 'priorEndovascularInterventions', label: 'Prior Endovascular Interventions', isArray: true },
    ],
  },
  {
    title: 'DVT Risk Factors',
    fields: [
      { key: 'dvtRiskFactors', label: 'DVT Risk Factors', isArray: true },
    ],
  },
];
...
/* ======= COMPONENT ======= */
const VascularSurgeryAssessmentDocumentPDFTemplate = ({ document: data }) => {
      ...
      <Document>
        <Page size="LETTER" style={styles.page}>
          <View style={styles.documentHeader}>
            <Text style={styles.documentTitle}>Vascular Surgery Assessment</Text>
          </View>
            ...
            <View key={index} style={styles.recordContainer}>
              ...
              <View style={styles.recordHeader} wrap={false}>
                ...
                <Text style={styles.recordTitle}>
                  {`Vascular Surgery Assessment ${recordNum}`}
                </Text>
              </View>
