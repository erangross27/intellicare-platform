# Task 095: getGynecologyConsultations Grid Implementation

## Function Details
- **Function Name**: getGynecologyConsultations
...
- gynecology_consultationsId (ObjectId) - Primary key
...
db.gynecology_consultations.createIndex({ patientId: 1, date: -1 })
db.gynecology_consultations.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/gynecology_consultations
- POST /api/medical/gynecology_consultations
- PUT /api/medical/gynecology_consultations/:id
- DELETE /api/medical/gynecology_consultations/:id
- GET /api/medical/gynecology_consultations/export
...
```javascript
{
  ...
  metadata: {
    gridType: "gynecology_consultations",
...
### Backend Tasks
- [ ] Create MongoDB schema for gynecology_consultations
...
## Related Functions
- Previous: [094-getPostpartumNotes]
- Next: [096-getObstetricUltrasoundReports]
