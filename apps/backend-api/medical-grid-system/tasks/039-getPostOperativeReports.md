# Task 039: getPostOperativeReports Grid Implementation

## Function Details
- **Function Name**: getPostOperativeReports
...
- post_operative_reportsId (ObjectId) - Primary key
...
db.post_operative_reports.createIndex({ patientId: 1, date: -1 })
db.post_operative_reports.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/post_operative_reports
- POST /api/medical/post_operative_reports
- PUT /api/medical/post_operative_reports/:id
- DELETE /api/medical/post_operative_reports/:id
- GET /api/medical/post_operative_reports/export
...
```javascript
{
  ...
  metadata: {
    gridType: "post_operative_reports",
...
### Backend Tasks
- [ ] Create MongoDB schema for post_operative_reports
...
## Related Functions
- Previous: [038-getPreOperativeAssessments]
- Next: [040-getSurgicalConsentForms]
