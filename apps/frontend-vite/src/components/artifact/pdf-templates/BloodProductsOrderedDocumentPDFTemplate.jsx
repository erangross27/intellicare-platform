/**
 * BloodProductsOrderedDocumentPDFTemplate.jsx
 * June 2026 — Helvetica — LETTER size — blood products ordered
...
const SECTION_CONFIGS = [
  {
    title: 'Product & Blood Group',
    fields: [
      { key: 'bloodProductType', label: 'Blood Product Type', isSentence: true },
      { key: 'aboBloodGroup', label: 'ABO Blood Group', isSentence: true },
      { key: 'rhFactor', label: 'Rh Factor', isSentence: true },
      { key: 'unitsOrdered', label: 'Units Ordered', isNumber: true },
      { key: 'leukocyteReduced', label: 'Leukocyte Reduced', isBoolean: true },
      { key: 'irradiatedProduct', label: 'Irradiated Product', isBoolean: true },
      { key: 'cmvNegative', label: 'CMV Negative', isBoolean: true },
    ],
  },
  {
    title: 'Indication & Urgency',
    fields: [
      { key: 'transfusionIndication', label: 'Transfusion Indication', isSentence: true },
      { key: 'urgencyLevel', label: 'Urgency Level', isSentence: true },
      { key: 'massiveTransfusionProtocol', label: 'Massive Transfusion Protocol', isBoolean: true },
  ...
  },
  {
    title: 'Compatibility',
    fields: [
      { key: 'crossmatchCompatibility', label: 'Crossmatch Compatibility', isSentence: true },
      { key: 'antibodyScreen', label: 'Antibody Screen', isSentence: true },
      { key: 'directAntiglobulinTest', label: 'Direct Antiglobulin Test', isSentence: true },
    ],
  },
  {
    title: 'Hematology',
    fields: [
      ...
      { key: 'hematocritLevel', label: 'Hematocrit (%)', isNumber: true },
      { key: 'plateletCount', label: 'Platelet Count (×10³/µL)', isNumber: true },
      { key: 'targetHemoglobin', label: 'Target Hemoglobin (g/dL)', isNumber: true },
      { key: 'fibrinogenLevel', label: 'Fibrinogen (mg/dL)', isNumber: true },
      { key: 'coagulationProfile', label: 'Coagulation Profile', isSentence: true },
    ],
  },
  {
    title: 'Administration',
    fields: [
      { key: 'premedication', label: 'Premedication', isArray: true },
      { key: 'specialRequirements', label: 'Special Requirements', isArray: true },
      { key: 'patientLocation', label: 'Patient Location', isSentence: true },
    ],
  },
];
...
/* ======= COMPONENT ======= */
const BloodProductsOrderedDocumentPDFTemplate = ({ document: data }) => {
      ...
      <Document>
        <Page size="LETTER" style={styles.page}>
          <View style={styles.documentHeader}>
            <Text style={styles.documentTitle}>Blood Products Ordered</Text>
          </View>
          ...
          <View key={index} style={styles.recordContainer}>
            ...
            <View style={styles.recordHeader} wrap={false}>
              <Text style={styles.recordTitle}>
                {`Blood Products Ordered ${index + 1}`}
              </Text>
            </View>
...
export default BloodProductsOrderedDocumentPDFTemplate;
