# Task 076: getMoodTrackingLogs Grid Implementation

## Function Details
- **Function Name**: getMoodTrackingLogs
- **Category**: Psychiatry
- **Collection**: mood_tracking_logs
- **Priority**: LOW
...
- mood_tracking_logsId (ObjectId) - Primary key
...
db.mood_tracking_logs.createIndex({ patientId: 1, date: -1 })
db.mood_tracking_logs.createIndex({ status: 1, practiceId: 1 })
...
### API Endpoints
- GET /api/medical/mood_tracking_logs
- POST /api/medical/mood_tracking_logs
- PUT /api/medical/mood_tracking_logs/:id
- DELETE /api/medical/mood_tracking_logs/:id
- GET /api/medical/mood_tracking_logs/export
...
### Backend Tasks
- [ ] Create MongoDB schema for mood_tracking_logs
...
## Related Functions
- Previous: [075-getBehavioralAssessments]
- Next: [077-getSubstanceAbuseAssessments]
